// $Header:   D:/databases/VMdb/archives/EN13849/Application Code/IntegrationStep7.c_v   1.6   20 Jul 2011 16:57:50   ASharma6  $
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
This is the seventh integration step. The StateMachine is included.

Filename:    IntegrationStep7.c
...
------------------------------ REVISIONS ---------------------------------
$Log:   D:/databases/VMdb/archives/EN13849/Application Code/IntegrationStep7.c_v  $
 * 
 *    Rev 1.6   20 Jul 2011 16:57:50   ASharma6
 * Modifications for review comments
 * 
 *    Rev 1.5   05 Jul 2011 11:00:06   ASharma6
 * ULS, CM changes
 * 
 *    Rev 1.2   22 Jun 2011 18:10:00   ASharma6
		...
		if(OneMsFlag) // One Ms flag
		{
          ...
          * be part of the build of the final integrated code */
			if(OldLEStatus != LEStatus)
			{
				if(LEStatus == OK)
				{
					printf("LEStatus status - OK\n");
				}
				else
				{
					printf("LEStatus status - FAILED\n");
				}
