// $Header:   D:/databases/VMdb/archives/EN13849/inc/core_cm3.h_v   1.7   20 Jul 2011 16:47:02   ASharma6  $
/****************************************************************************/
/*                                                                          */
/*                                                                          */
...
/*--------------------------- MODULE DESCRIPTION ---------------------------
 ...
 Module name: core_cm3
 File name: core_cm3.h
 -------------------------- TECHNICAL NOTES --------------------------------

 ------------------------------ REVISIONS ---------------------------------
$Log:   D:/databases/VMdb/archives/EN13849/inc/core_cm3.h_v  $
 * 
 *    Rev 1.7   20 Jul 2011 16:47:02   ASharma6
 * Modifications for review comments
 * 
 *    Rev 1.6   05 Jul 2011 10:56:24   ASharma6
 * ULS, CM changes
Revision 1.6  2011/06/28 17:46:35  satya
Updated for review comments

 * 
 *    Rev 1.3   22 Jun 2011 18:14:00   ASharma6
 * LE Fault reset allowed in horn up state
 * Part contact lost made more resilient
 * Cross monitoring detects other processor was reset and resets itself
 * SBeam diagnostics is more resilient
 * 
 *    Rev 1.2   01 Apr 2011 11:27:56   PDwivedi
 * Fixex after review.
 * 
 *    Rev 1.1   25 Mar 2011 09:15:44   ygupta
...
#include <stdint.h>                           /* Include standard types */
 ...
 /*
  * This definition is for Eclipse only. __GNUC__ is a built-in definition
  * for GNU C, but Eclipse does not know it.
  */
#ifndef __GNUC__
#define __GNUC__
#endif
 ...
 */
static __INLINE void NVIC_DeInit(void)
{
    uint8_t tmp;
 ...
 * @return      None
 */
static __INLINE void NVIC_SetVTOR(uint32_t offset)
{
