...
{
#if ESC_32BIT_ACCESS
  ESS_UINT32                        AddressLength; /**< \brief Address and Length*/
...
#define SM_LENGTH_SHIFT         16 /**< \brief Length shift*/
  ...
  ESS_UINT32                        Settings[1]; /**< \brief Register values 0x0804 : 0x0807*/
...
#define SM_SETTING_REPEAT_ACK               0x02000000            /**< \brief Bit1 of register 0x0807*/
  ...
  ESS_UINT16                        PhysicalStartAddress; /**< \brief SyncManager address*/
  ESS_UINT16                        Length; /**< \brief SyncManager length*/

#if ESC_16BIT_ACCESS
    ESS_UINT16                        Settings[2]; /**< \brief Register values 0x0804 : 0x0807*/
...
#else
//ESC_8BIT ACCESS
      ESS_UINT8                         Settings[4]; /**< \brief Register values 0x0804 : 0x0807*/
