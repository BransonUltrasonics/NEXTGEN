...
{
    ESS_UINT8            b[6]; /*"< \brief buffer to store AMS Net ID*/
...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    ESS_UINT16      port; /**< \brief AMS Port*/
}MBX_STRUCT_PACKED_END 
AmsAddr;
...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    ESS_UINT16      cmdId; /**< \brief Command id*/
    ESS_UINT16      stateFlags; /**< \brief State flags*/
    ESS_UINT32      cbData; /**< \brief Count UINT8s for actual command (excl. AmsHead)*/
    ...
    union
    {
        ...
        struct
        {
            ESS_UINT16    fragmentNo; /**< \brief Increasing no*/
            ESS_UINT16    packetNo; /**< \brief Unique no of all fragments in a packet*/
...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    struct frag
    {
        ...
        ESS_UINT16        stateFlags; /**< \brief State flags*/
        ESS_UINT32        cbData; /**< \brief Count UINT8s for actual command (excl. AmsHead)*/
        ESS_UINT32        errCode; /**< \brief Error code*/
        ESS_UINT16        fragmentNo; /**< \brief Increasing no*/
        ESS_UINT16        packetNo; /**< \brief Unique no of all fragments in a packet*/
    } frag;
    ...
    struct org
    {
        ...
        ESS_UINT32        cbData; /**< \brief Count UINT8s for actual command (excl. AmsHead)*/
        ESS_UINT32        errCode; /**< \brief Error code*/
        ESS_UINT32        hUser; /**< \brief User handle*/
    } org;
} MBX_STRUCT_PACKED_END
...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    ESS_UINT32    indexGroup; /**< \brief Index group*/
    ESS_UINT32    indexOffset; /**< \brief Index Offset*/
    ESS_UINT32    cbLength; /**< \brief Length*/
} MBX_STRUCT_PACKED_END
...
{
    AmsHead    head; /**< \brief Datagram header*/
    ESS_UINT32    result; /**< \brief Result*/
    ESS_UINT32    cbLength; /**< \brief Length*/
} MBX_STRUCT_PACKED_END
...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    ESS_UINT32    indexGroup; /**< \brief Index group*/
    ESS_UINT32    indexOffset; /**< \brief Index offset*/
    ESS_UINT32    cbReadLength; /**< \brief Read length*/
    ESS_UINT32    cbWriteLength; /**< \brief Write length*/
} MBX_STRUCT_PACKED_END
...
PROTO    ESS_BOOL            bAoeWaitForNetId; /**< \brief Indicates if AMS Net ID was not set yet*/
PROTO    ESS_BOOL            bAoeRelativeNetIds; /**< \brief AMS Net ID was overwritten*/
PROTO    AmsNetId        sRouterNetId; /**< \brief AMS Net ID of the Router*/
PROTO    ESS_UINT16          u16AmsFragSize; /**< \brief AMS Fragment size*/
...
PROTO   ESS_UINT8 AOE_AmsNetIdsEqual(AmsNetId MBXMEM *pNetId1, AmsNetId MBXMEM *pNetId2);
PROTO   ESS_UINT16 AOE_AmsRes(AmsCmd MBXMEM *pCmd, ESS_UINT16 amsErrCode, ESS_UINT16 dataLen);
PROTO   ESS_UINT8 AOE_ServiceInd(TMBX MBXMEM * pMbx);
