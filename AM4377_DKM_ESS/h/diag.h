...
#define DIAG_CREATE_PARAM_FLAG(type,info)   ((ESS_UINT32)((((ESS_UINT16)(type))<<(DIAG_MSG_PARAM_TYPE_OFFSET)) | ((ESS_UINT16)(info)))) /**< \brief Marco merge "type" and "info" in message header*/


/*Defined Diagnosis Codes*/
/*ECATCHANGE_START(V5.11) DIAG3*/
#define DIAG_CODE_EMCY(Code)        (((ESS_UINT32)(Code))<< 16 | (ESS_UINT16)(0xE800)) /**< \brief Marco to create emergency code*/
 ...
 */
typedef struct {
   ESS_UINT16   ParamFlags; /**< \brief Parameter flags*/
...
typedef struct {
   ESS_UINT16   ParamFlags; /**< \brief Parameter flags*/
   ESS_UINT8    pData[1]; /**< \brief Parameter buffer*/
} TDIAGMSGPARAM;
 ...
 */
typedef struct {
   ESS_UINT32   u32DiagCode; /**< \brief Message code*/
   ESS_UINT16   u16Flags; /**< \brief Message flags*/
   ESS_UINT16   u16TextID; /**< \brief Text ID*/
   ESS_UINT32   TimeStamp[2]; /**< \brief Timestamp*/
 ...
 */
typedef struct {
   ESS_UINT16    u16MessageLength; /**< \brief Message length*/
...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   ESS_UINT8    u8MaximumMessages; /**< \brief Maximum Number of messages*/
   ESS_UINT8    u8NewestMessage; /**< \brief Newest message*/
   ESS_UINT8    u8NewestAckMessage; /**< \brief Newest acknowledged message*/
   ESS_UINT8    u8NewMessage; /**< \brief New Message*/
 ...
 */
OBJCONST ESS_UCHAR OBJMEM aName0x10F3[] = "Diagnosis History\000Maximum Messages\000Newest Message\000Newest Acknowledged Message\000New Message Available\000Flags\000Diagnosis Message\000\377";
#endif
...
PROTO ESS_UINT8 Write0x10F3( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 Read0x10F3( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO void Diag_InitMemory(void);
PROTO void Diag_CreateNewMessage(ESS_UINT32 DiagCode,ESS_UINT8 Type,ESS_UINT16 TextID,ESS_UINT8 NumParam, TDIAGMSGPARAMINFO *pParam);
