...
typedef struct OBJ_STRUCT_PACKED_START {
   OBJCONST ESS_CHAR OBJMEM *pName; /**< \brief Name of the test*/
   ESS_UINT16   Control; /**< \brief Control word of the test*/
   ESS_UINT16   Counter; /**< \brief Test execution counter*/
 ...
 */
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   TestIndex; /**< \brief Test index*/
   ESS_UINT8    TestSubindex; /**< \brief Test Subindex*/
 ...
 */
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
...
typedef struct OBJ_STRUCT_PACKED_START {
    ...
    ESS_UINT8    Byte1; /**< \brief SubIndex15 : ESS_UINT8*/
    ESS_INT8     Byte2; /**< \brief SubIndex16 : ESS_INT8*/
} OBJ_STRUCT_PACKED_END
TOBJ3003;
...
typedef struct OBJ_STRUCT_PACKED_START
{
    ESS_UINT16    subindex0;
    ESS_UINT16    u16_ro;                //SI 1
    ESS_UINT16    u16_rw;                //SI 2
    ESS_UINT16    u16_wo;                //SI 3
    BIT8(u8_rw);                     //SI 4
...
{
    ESS_UINT16    subindex0;
    ESS_UINT16    Value; /**< \brief Buffer to store 5Entries*/
}OBJ_STRUCT_PACKED_END
TOBJ0x3007;
...
OBJCONST ESS_UCHAR OBJMEM aName0x2000[] = "ESM behaviour group 01\000\377";
#endif
...
OBJCONST ESS_UCHAR OBJMEM aName0x2010[] = "Mailbox behaviour group 01\000\377";
#endif
...
OBJCONST ESS_UCHAR OBJMEM aName0x2020[] = "CoE behaviour group 01\000\377";
#endif
...
OBJCONST ESS_UCHAR OBJMEM aName0x2030[] = "FoE behaviour group 01\000\377";
#endif
...
OBJCONST ESS_UCHAR OBJMEM aName0x2FFF[] = "TestControl";
#endif //#ifdef _OBJD_
 ...
 */
#ifdef _OBJD_
ESS_CHAR sEnum0800_Value00[] = "\000\000\000\000Signed presentation"; /**< \brief Enum 0x800 value 0
                                                                   * 
                                                                   * Value = 0x00, Text = Signed presentation */
ESS_CHAR sEnum0800_Value01[] = "\001\000\000\000Unsigned presentation";/**< \brief Enum 0x800 value 1
                                                                   *
                                                                   *Value = 0x01, Text = Unsigned presentation */
/** \brief 0x800 (signed/unsigned) Enum value buffer*/
ESS_CHAR *apEnum0800[2] = { sEnum0800_Value00, sEnum0800_Value01};
...
ESS_CHAR sEnum0801_Value[] = "\000\000\000\000FALSE\001\000\000\000TRUE";

/** \brief 0x801 (Boolean) Enum value buffer*/
ESS_CHAR *apEnum0801[2] = { sEnum0801_Value, (sEnum0801_Value+9)};
...
OBJCONST ESS_UCHAR OBJMEM aName0x3001[] = "Real32 object\000\377";
#endif //#ifdef _OBJD_

/** \brief 0x3001 (Real32 object) object variable*/
PROTO ESS_UINT32   r32Obj
#ifdef _TESTAPPL_
    = 0xBABABABA
#endif
    ;
...
#ifdef _OBJD_
/** \brief 0x3002 (ESS_UINT32 object) entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3002 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READWRITE};

/** \brief 0x3002 (ESS_UINT32 object) object name*/
OBJCONST ESS_UCHAR OBJMEM aName0x3002[] = "ESS_UINT32 object\000\377";
#endif //#ifdef _OBJD_

/** \brief 0x3002 (ESS_UINT32 object) object variable*/
PROTO ESS_UINT32   u32Obj
#ifdef _TESTAPPL_
    = 0xBABABABA
#endif
    ;
...
OBJCONST ESS_UCHAR OBJMEM aName0x3003[] ="ByteAndLessEntryObject\000Boolean(def TRUE)\000Bit1(def 0x00)\000Bit2(def 0x3)\000Bit3(def 0x5)\0001Bit alignment\000Bit4(def 0xA)\0004Bit alignment\000Bit5(def 0x1A)\0003Bit alignment\000Bit6(def 0x2A)\0002Bit align\000Bit7(def 0x6A)\0001Bit align\000Bit8(def 0xFF)\000UnsignedByte(def 0xAA)\000SignedByte(def 0xBB)\000\377";
#endif //#ifdef _OBJD_
...
OBJCONST ESS_UCHAR OBJMEM aName0x3005[] = "Enum Test Object\000Presentation\000Boolean\000Alignment\000\377";
#endif //#ifdef _OBJD_
...
OBJCONST ESS_UCHAR OBJMEM aName0x3006[] = "Huge VAR Object\000\377";
#endif //#ifdef _OBJD_

/** \brief 0x3006 (Huge VAR object) object variable*/
PROTO ESS_UINT8   HugeObj[HUGE_OBJ_BYTE_SIZE];
...
OBJCONST ESS_UCHAR OBJMEM aName0x3007[] = "Bit3 Array Object\000\377";
#endif //#ifdef _OBJD_
...
OBJCONST ESS_UCHAR OBJMEM aName0x3008[] = "Basedatatype Arrays Object\000UintArr\000ByteArr\000BitArr32\000BitArr16\000BitArr8\000\377";
#endif //#ifdef _OBJD_
...
OBJCONST ESS_UCHAR OBJMEM aName0x3009[] = "Huge Array Object\000\377";

/** \brief 0x300A (Huge Array/Record Object) entry descriptions*/
OBJCONST ESS_UCHAR OBJMEM aName0x300A[] = "Huge Record Object\000\377";
#endif //#ifdef _OBJD_
...
OBJCONST ESS_UCHAR OBJMEM aName0x300B[] =
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16 u16SubIndex0;
   ESS_UINT8  String[5];
   ESS_UINT8  u8SubIndex2;
   ESS_UINT8  ByteArray[5];
   ESS_UINT8  u8SubIndex4;
} OBJ_STRUCT_PACKED_END
TOBJ300B;
...
OBJCONST ESS_UCHAR OBJMEM aName0x300C[] = "Max entry size object\000\377";
#endif //#ifdef _OBJD_
#endif //#if !_PIC24
/*ECATCHANGE_END(V5.11) TEST2*/
/** @}*/
...
OBJCONST ESS_UCHAR OBJMEM aName0x300D[] = 
 ...
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1C12[] = "RxPDO assign";
#endif //#ifdef _OBJD_
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1C13[] = "TxPDO assign";
#endif //#ifdef _OBJD_
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1601[] = "RxPDO-Map\000\377";
#endif //#ifdef _OBJD_
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1603[] = "RxPDO-Map\000\377";
#endif //#ifdef _OBJD_
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1A00[] = "TxPDO-Map\000\377";
#endif //#ifdef _OBJD_
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1A02[] = "TxPDO-Map\000\377";
#endif //#ifdef _OBJD_
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1AFF[] = "TxPDO-Map Esm variables\000\377";
#endif //#ifdef _OBJD_
 ...
 *
 * SubIndex0 : 1<br>
 * SubIndex01 : 0xA000.1 value of "nEcatStateTrans" (ESS_UINT16)
 ...
 * SubIndex21 : 0xA000.33 value of "EcatWdValue" (ESS_UINT16)
 * SubIndex22 : 0xA000.34 value of "EcatWdCounter" (ESS_UINT16)
 * SubIndex23 : 0xA000.35 value of "Sync0WdCounter" (ESS_UINT16)
 * SubIndex24 : 0xA000.36 value of "Sync0WdValue" (ESS_UINT16)
 * SubIndex25 : 0xA000.37 value of "Sync1WdCounter" (ESS_UINT16)
 * SubIndex26 : 0xA000.38 value of "Sync1WdValue" (ESS_UINT16)
 * SubIndex27 : 0xA000.39 value of "LatchInputSync0Value" (ESS_UINT16)
 * SubIndex28 : 0x1C32.11 value of "u16SmEventMissedCounter" (ESS_UINT16)
 */
...
OBJCONST ESS_UCHAR OBJMEM aName0x6000[] = "InputCounter";
#endif //#ifdef _OBJD_

#endif //#if COE_SUPPORTED

/** \brief 0x6000 (Input counter object) object variable*/
PROTO ESS_UINT32 InputCounter
#ifdef _TESTAPPL_
= 0x0;
#endif
;
...
OBJCONST ESS_UCHAR OBJMEM aName0x6020[] = "Counter Overrun";
#endif //#ifdef _OBJD_

/** \brief 0x6020 (Counter Overrun) object variable*/
PROTO ESS_UINT16 CounterOverrun
#ifdef _TESTAPPL_
= 0x0
#endif
;
...
OBJCONST ESS_UCHAR OBJMEM aName0x7010[] = "OutputCounter";
#endif //#ifdef _OBJD_

#endif //#if COE_SUPPORTED
/** \brief 0x7010 (Output counter object) object variable*/
PROTO ESS_UINT32 OutputCounter
#ifdef _TESTAPPL_
= 0x0
#endif
;
...
OBJCONST ESS_UCHAR OBJMEM aName0x7030[] = "Output Counter 1";
#endif //#ifdef _OBJD_

/** \brief 0x7030 (output counter object) object variable*/
PROTO ESS_UINT32 OutputCounter1
#ifdef _TESTAPPL_
= 0x0
#endif
;
...
OBJCONST ESS_UCHAR OBJMEM aName0x8000[] = "StackConfiguration\000\377";
#endif //#ifdef _OBJD_
...
PROTO ESS_UINT16 SlaveConfigObjSubindex0
#ifdef _TESTAPPL_
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0xA000[] = {
   {DEFTYPE_UNSIGNED8, 0x8, ACCESS_READ },
   {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ}, /* SubIndex001 "nEcatStateTrans" (ESS_UINT16)*/
   ...
   {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ}, /* SubIndex033 "EcatWdValue" (ESS_UINT16)*/
   {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ}, /* SubIndex034 "EcatWdCounter" (ESS_UINT16)*/
   {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ}, /* SubIndex035 "Sync0WdCounter" (ESS_UINT16)*/
   {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ}, /* SubIndex036 "Sync0WdValue" (ESS_UINT16)*/
   {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ}, /* SubIndex037 "Sync1WdCounter" (ESS_UINT16)*/
   {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ}, /* SubIndex038 "Sync1WdValue" (ESS_UINT16)*/
   {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ}}; /* SubIndex039 "LatchInputSync0Value" (ESS_UINT16)*/

/** \brief 0xA000 (Esm Variables) object and entry names*/
OBJCONST ESS_UCHAR OBJMEM aName0xA000[] = "ESM variables\000nEcatStateTrans\000EsmTimeoutCounter\000i16WaitForPllRunningTimeout\000i16WaitForPllRunningCnt\000u16LocalErrorCode\000bApplEsmPending\000bEcatWaitForAlControlRes\
...
PROTO ESS_UINT16 A000Subindex0
#ifdef _TESTAPPL_
    =39
#endif
    ;
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex0*/
   ESS_UINT32   aEntries[3]; /**< \brief Module profile information buffer
                          * 
 ...
 */
OBJCONST ESS_UCHAR OBJMEM aName0xF010[] = "Module profile list";
#endif
...
PROTO ESS_UINT8 WriteTestObject( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 ReadTestObject( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 WriteObject0x2FFF( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 ReadObject0x2FFF( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 WriteObject0x3009_0x300A( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 ReadObject0x3009_0x300A( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 ReadObject0x8000( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
#if AL_EVENT_ENABLED && DC_SUPPORTED
PROTO ESS_UINT8 ReadObject0xA000( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
#endif  // #if AL_EVENT_ENABLED && DC_SUPPORTED

PROTO ESS_UINT8 WriteObject0x3007( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 ReadObject0x3007( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );

#if SDO_RES_INTERFACE
PROTO ESS_UINT8 WriteObject0x3006( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 ReadObject0x3006( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 WriteObject0x3002( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
PROTO ESS_UINT8 ReadObject0x3002( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
#endif

#if !_PIC24
/*ECATCHANGE_START(V5.11) TEST2*/
PROTO ESS_UINT8 ReadObject0x300C( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
/*ECATCHANGE_END(V5.11) TEST2*/
#endif
...
PROTO ESS_UINT16 APPL_GetDeviceID(void);
#endif
PROTO void APPL_Application(void);

PROTO void   APPL_AckErrorInd(ESS_UINT16 stateTrans);
PROTO ESS_UINT16 APPL_StartMailboxHandler(void);
PROTO ESS_UINT16 APPL_StopMailboxHandler(void);
PROTO ESS_UINT16 APPL_StartInputHandler(ESS_UINT16 *pIntMask);
PROTO ESS_UINT16 APPL_StopInputHandler(void);
PROTO ESS_UINT16 APPL_StartOutputHandler(void);
PROTO ESS_UINT16 APPL_StopOutputHandler(void);

PROTO ESS_UINT16 APPL_GenerateMapping(ESS_UINT16 *pInputSize,ESS_UINT16 *pOutputSize);
PROTO void APPL_InputMapping(ESS_UINT16* pData);
PROTO void APPL_OutputMapping(ESS_UINT16* pData);
...
PROTO ESS_UINT32    EE_GetChecksum(void);
PROTO ESS_UINT8     EE_IsDefaultDataInitialized(void);
PROTO void      EE_StoreDefaultData(void);
PROTO void      EE_LoadDefaultData(void);
PROTO void      EE_ReadWordsFromNonVolatileMemory(ESS_UINT16 HUGE *pDest, ESS_UINT16 srcOffset, ESS_UINT16 n);
PROTO ESS_UINT32    EE_WriteWordsToNonVolatileMemory(ESS_UINT16 destOffset, ESS_UINT16 HUGE * pSrc, ESS_UINT16 n);
#endif


/*ECATCHANGE_START(V5.11) TEST9*/
PROTO ESS_BOOL bUnlockSdoRequest; /**< \brief If test behaviour 0x2020.7 is enabled the SDO response on object 0x3006.0 is written to the out mailbox if this variable is true)*/
/*ECATCHANGE_END(V5.11) TEST9*/
