...
/*ECATCHANGE_START(V5.11) CiA402 1*/
   ESS_UINT32   aEntries[5]; /**< \brief Entry buffer*/
/*ECATCHANGE_END(V5.11) CiA402 1*/
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   ESS_UINT32   aEntries[2]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1601;
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   ESS_UINT16   aEntries[MAX_AXES]; /**< \brief Entry buffer (number of entries depends on the supported axis, each axis requires one entry)*/
} OBJ_STRUCT_PACKED_END
TOBJ1C12;
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   ESS_INT32    i32MinLimit; /**< \brief Minimum limit*/
   ESS_INT32    i32MaxLimit; /**< \brief Maximum limit*/
} OBJ_STRUCT_PACKED_END
TOBJ607D;
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   ESS_UINT8    u8InterpolationPeriod; /**< \brief Interpolation period*/
   ESS_INT8     i8InterpolationIndex; /**< \brief Interpolation index*/
} OBJ_STRUCT_PACKED_END
TOBJ60C2;
/** @}*/
...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   ESS_UINT16   u16Moduleindexdistance; /**< \brief Module Index distance
                                     * 
                                     * Index distance between two modules.<br>
                                     * According to ETG.6010 the object index distance is 0x800*/
   ESS_UINT16   u16Maximumnumberofmodules; /**< \brief Maximum number of modules*/
} OBJ_STRUCT_PACKED_END
TOBJF000;
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex0*/
   ESS_UINT32   aEntries[MAX_AXES];/**< \brief Module profile information buffer
                                  * 
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex0*/
   ESS_UINT32   aEntries[MAX_AXES];/**< \brief Module Ident List buffer
                                  * The number of entries depends on the number of supported axes.
                                  */
} OBJ_STRUCT_PACKED_END
TOBJF030;
...
{
    ESS_UINT16 ObjStatusWord; /**< \brief Status word (0x6041)*/
    ESS_INT32 ObjPositionActualValue; /**< \brief Actual position (0x6064)*/
    ESS_INT32 ObjVelocityActualValue; /**< \brief Actual velocity (0x606C)*/
    ESS_INT16 ObjModesOfOperationDisplay; /**< \brief Current mode of operation (0x6061)*/
}STRUCT_PACKED_END
TCiA402PDO1A00;
...
typedef struct STRUCT_PACKED_START
{
    ESS_UINT16 ObjControlWord; /**< \brief Control word (0x6040)*/
    ESS_INT32 ObjTargetPosition; /**< \brief Target position (0x607A)*/
    ESS_INT32 ObjTargetVelocity; /**< \brief Target velocity (0x60FF)*/
    ESS_INT16 ObjModesOfOperation; /**< \brief Mode of operation (0x6060)*/
}STRUCT_PACKED_END
TCiA402PDO1600;
...
typedef struct OBJ_STRUCT_PACKED_START
{
    ...
    ESS_UINT16 objErrorCode; /**< \brief Error Code (0x603F)*/
    ESS_UINT16 objControlWord; /**< \brief Control Word (0x6040)*/
    ESS_UINT16 objStatusWord; /**< \brief Status Word (0x6041)*/
    ESS_INT16 objQuickStopOptionCode; /**< \brief Quick Stop Option Code (0x605A)*/
    ESS_INT16 objShutdownOptionCode; /**< \brief Shutdown Option Code (0x605B)*/
    ESS_INT16 objDisableOperationOptionCode; /**< \brief Disable Operation Option Code (0x605C)*/
    ESS_INT16 objFaultReactionCode; /**< \brief Fault Reaction Code (0x605E)*/
    ESS_INT16 objModesOfOperation; /**< \brief Modes of Operation (0x6060)*/
    ESS_INT16 objModesOfOperationDisplay; /**< \brief Mode of Operation Display (0x6061)*/
    ESS_INT32 objPositionActualValue; /**< \brief Position Actual Value (0x6064)*/
    ESS_INT32 objVelocityActualValue; /**< \brief Actual Velocity Value (0x606C)*/
    ESS_INT16 objTorqueActualValue; /**< \brief Torque Actual Value (0x6077)*/
    ESS_INT32 objTargetPosition; /**< \brief Target Position (0x607A)*/
    TOBJ607D objSoftwarePositionLimit; /**< \brief Software Position limit (0x607D)*/
    ESS_UINT32 objQuickStopDeclaration; /**< \brief Quick Stop Declaration (0x6085)*/
    TOBJ60C2 objInterpolationTimePeriod; /**< \brief Interpolation Time Period (0x60C2)*/
    ESS_INT32 objTargetVelocity; /**< \brief Target Velocity (0x60FF)*/
    ESS_UINT32 objSupportedDriveModes; /**< \brief Supported Drive Modes (0x6502)*/
}OBJ_STRUCT_PACKED_END
CiA402Objects;
...
typedef struct
{
    ESS_BOOL        bAxisIsActive; /**< \brief Indicates if active is active*/
    ESS_BOOL        bBrakeApplied; /**< \brief Motor break is applied*/
    ESS_BOOL        bLowLevelPowerApplied; /**< \brief Low Level Power applied*/
    ESS_BOOL        bHighLevelPowerApplied; /**< \brief High Level Power applied*/
    ESS_BOOL        bAxisFunctionEnabled; /**< \brief Axis functions enabled*/
    ESS_BOOL        bConfigurationAllowed; /**< \brief Configuration allowed*/

    ESS_UINT16      i16State; /**< \brief Axis state*/
    ESS_UINT16      u16PendingOptionCode; /**< \brief Pending operation code*/
    double      fCurPosition; /**< \brief Current position within control loop*/
    ESS_UINT32      u32CycleTime; /**< \brief Motion controller cycletime in us*/
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */   
OBJCONST ESS_UCHAR OBJMEM aName0x1600[] = "csp/csv RxPDO\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */   
OBJCONST ESS_UCHAR OBJMEM aName0x1601[] = "csp RxPDO\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */      
OBJCONST ESS_UCHAR OBJMEM aName0x1602[] = "csv RxPDO\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */      
OBJCONST ESS_UCHAR OBJMEM aName0x1A00[] = "csp/csv TxPDO\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */      
OBJCONST ESS_UCHAR OBJMEM aName0x1A01[] = "csp TxPDO\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */      
OBJCONST ESS_UCHAR OBJMEM aName0x1A02[] = "csv TxPDO\000\377";
/** @}*/
...
OBJCONST ESS_UCHAR OBJMEM aName0x603F[] = "Error Code";
...
OBJCONST ESS_UCHAR OBJMEM aName0x6040[] = "Control Word";
...
OBJCONST ESS_UCHAR OBJMEM aName0x6041[] = "Status Word";
...
OBJCONST ESS_UCHAR OBJMEM aName0x605A[] = "Quickstop Option Code";
...
OBJCONST ESS_UCHAR OBJMEM aName0x605B[] = "Shutdown Option Code";
...
OBJCONST ESS_UCHAR OBJMEM aName0x605C[] = "Disable Operation Option Code";
...
OBJCONST ESS_UCHAR OBJMEM aName0x605E[] = "Fault Reaction Code";
...
OBJCONST ESS_UCHAR OBJMEM aName0x6060[] = "Modes of Operation";
...
OBJCONST ESS_UCHAR OBJMEM aName0x6061[] = "Modes of Operation Display";
...
OBJCONST ESS_UCHAR OBJMEM aName0x6064[] = "Position Actual Value";
...
OBJCONST ESS_UCHAR OBJMEM aName0x606C[] = "Velocity Actual Value";
...
OBJCONST ESS_UCHAR OBJMEM aName0x6077[] = "Torque Actual Value";
...
OBJCONST ESS_UCHAR OBJMEM aName0x607A[] = "Target Position";
...
OBJCONST ESS_UCHAR OBJMEM aName0x607D[] = "Software Position Limit\000Min position limit\000Max position limit\000\377";
...
OBJCONST ESS_UCHAR OBJMEM aName0x6085[] = "Quickstop Declaration";
...
OBJCONST ESS_UCHAR OBJMEM aName0x60C2[] = "Interpolation Time Period\000Interpolation period \000Interpolation Index\000\377";
...
OBJCONST ESS_UCHAR OBJMEM aName0x60FF[] = "Target Velocity";
...
OBJCONST ESS_UCHAR OBJMEM aName0x6502[] = "Supported Drive Modes";
/** @}*/
...
OBJCONST ESS_UCHAR OBJMEM aName0xF000[] = "Modular device profile\000Module index distance\000Maximum number of modules\000\377";
 ...
 * no entry names defined because the object is an array (for every entry > 0 "SubIndex xxx" is returned)
 */    
OBJCONST ESS_UCHAR OBJMEM aName0xF030[] = "Configured module Ident list";
 ...
 * no entry names defined because the object is an array (for every entry > 0 "SubIndex xxx" is returned)
 */       
OBJCONST ESS_UCHAR OBJMEM aName0xF050[] = "Module detected list";
/** @}*/
#endif
...
PROTO ESS_UINT8 Write0xF030( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
...
0x0,/*(ESS_UINT16) ErrorCode 0x1001*/
0x0,/*(ESS_UINT16) ControlWord 0x6040*/
0x0,/*(ESS_UINT16) StatusWord 0x6041*/
0x2,/*(ESS_INT16) QuickStopOptionCode 0x605A*/
DISABLE_DRIVE,/*(ESS_INT16)ShutdownOptionCode 0x605B*/
SLOW_DOWN_RAMP, /*(ESS_INT16) DisableOperationCode 0x605C*/
QUICKSTOP_RAMP,/*(ESS_INT16) FaultReactionCode 0x605E*/
0x0,/*(ESS_INT16) ModeOfOperation 0x6060*/
0x0,/*(ESS_INT16) Mode Of Operation Display 0x6061*/
0x0,/*(ESS_INT32) Position Actual Value 0x6064*/
0x0,/*(ESS_INT32) Velocity Actual Value 0x606C*/
0x0,/*(ESS_INT16) Torque Actual Value 0x6077*/
0x0,/*(ESS_INT32) Target Position 0x607A*/
{2,0x88CA6C00,0x77359400},/*TOBJ607D Software Position Limit (minLimit: -2000000000 / maxLimit: 2000000000)*/
0x0,/*(ESS_UINT32) QuickStopDeclaration 0x6085*/
{2,1,-3},/*TOBJ60C2 Interpolation Time Period*/
0x0,/*(ESS_INT32) Target Velocity    0x60FF*/
0x0/*(ESS_UINT32) Supported Drive Modes 0x6502*/
}
#endif
;
/** @}*/
...
PROTO void CiA402_LocalError(ESS_UINT16 ErrorCode);
