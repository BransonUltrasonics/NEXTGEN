 ...
 * @{
 */
#define     SDOHEADER_SIZEINDICATOR             ((ESS_UINT8) 0x01) /**< \brief Size Indicator size of data in Data Set Size specified*/
#define     SDOHEADER_TRANSFERTYPE              ((ESS_UINT8) 0x02) /**< \brief Transfer Type<br>1: Expedited<br>0: Normal*/
#define     SDOHEADER_DATASETSIZE               ((ESS_UINT8) 0x0C) /**< \brief Data Set Size (used for Expedited transfer)*/
#define     SDOHEADER_COMPLETEACCESS            ((ESS_UINT8) 0x10) /**< \brief Complete Access indication<br>0: Only specified entry will be transferred<br>1: Whole object (with or without Subindex0) will be transferred)*/ 
#define     SDOHEADER_COMMAND                   ((ESS_UINT8) 0xE0) /**< \brief SDO Command*/
#define     SDOHEADERSHIFT_SIZEINDICATOR        ((ESS_UINT8) 0) /**< \brief Shift for Size Indicator*/
#define     SDOHEADERSHIFT_TRANSFERTYPE         ((ESS_UINT8) 1) /**< \brief Shift for Transfer Type*/
#define     SDOHEADERSHIFT_DATASETSIZE          ((ESS_UINT8) 2) /**< \brief Shift for Data Set Size*/
#define     SDOHEADERSHIFT_INDEXACCESS          ((ESS_UINT8) 4) /**< \brief Shift for Complete Access*/
#define     SDOHEADERSHIFT_COMMAND              ((ESS_UINT8) 5) /**< \brief Shift for SDO Command*/
/** @}*/
 ...
 * @{
 */
#define     SDOSERVICE_INITIATEDOWNLOADREQ      ((ESS_UINT8) (0x01 << (SDOHEADERSHIFT_COMMAND))) /**< \brief SDO download request*/
#define     SDOSERVICE_INITIATEDOWNLOADRES      ((ESS_UINT8) (0x03 << (SDOHEADERSHIFT_COMMAND))) /**< \brief SDO download response*/
#define     SDOSERVICE_DOWNLOADSEGMENTREQ       ((ESS_UINT8) (0x00 << (SDOHEADERSHIFT_COMMAND))) /**< \brief SDO segmented download request*/
#define     SDOSERVICE_DOWNLOADSEGMENTRES       ((ESS_UINT8) (0x01 << (SDOHEADERSHIFT_COMMAND))) /**< \brief SDO segmented download response*/
#define     SDOSERVICE_INITIATEUPLOADREQ        ((ESS_UINT8) (0x02 << (SDOHEADERSHIFT_COMMAND))) /**< \brief SDO upload request*/
#define     SDOSERVICE_INITIATEUPLOADRES        ((ESS_UINT8) (0x02 << (SDOHEADERSHIFT_COMMAND))) /**< \brief SDO upload response*/
#define     SDOSERVICE_UPLOADSEGMENTREQ         ((ESS_UINT8) (0x03 << (SDOHEADERSHIFT_COMMAND))) /**< \brief SDO segmented upload request*/
#define     SDOSERVICE_UPLOADSEGMENTRES         ((ESS_UINT8) (0x00 << (SDOHEADERSHIFT_COMMAND))) /**< \brief SDO segmented upload response*/
#define     SDOSERVICE_ABORTTRANSFER            ((ESS_UINT8) (((ESS_UINT8) 0x04) << (SDOHEADERSHIFT_COMMAND))) /**< \brief SDO abort*/
/** @}*/
...
{
#if MBX_16BIT_ACCESS
    ESS_UINT16 Sdo[2]; /**< \brief 32Bit SDO header buffer*/
...
#else
    ESS_UINT8 Sdo[4]; /**< \brief 32Bit SDO header buffer*/
#if BIG_ENDIAN_16BIT
...
#define     MIN_SEGMENTED_DATA          ((ESS_UINT16) 7) /**< \brief Minimum number of Bytes required for a segmented transfer*/
...
{
#if MBX_16BIT_ACCESS
    ESS_UINT16      SegHeader; /**< \brief 8Bit header buffer and first 8Bit of the Data*/
#define    SEGHEADER_MASK                    ((ESS_UINT16) 0xFF) /**< \brief SDO header mask*/
#define    SEGHEADER_NOMOREFOLLOWS           ((ESS_UINT16) 0x01) /**< \brief More segments follow flag*/
#define    SEGHEADER_SEGDATASIZE             ((ESS_UINT16) 0x0E) /**< \brief Segmented data size*/
#define    SEGHEADER_TOGGLE                  ((ESS_UINT16) 0x10) /**< \brief Toogle flag*/
#define    SEGHEADER_COMMAND                 ((ESS_UINT16) 0xE0) /**< \brief Command identifier*/
#define    SEGHEADERSHIFT_SEGDATASIZE        ((ESS_UINT16) 1) /**< \brief Shift for Segmented data size*/
#define    SEGHEADERSHIFT_TOGGLE             ((ESS_UINT16) 4) /**< \brief Shift for toggle flag*/
#define    SEGHEADERSHIFT_COMMAND            ((ESS_UINT16) 5) /**< \brief Shift for command identifier*/
#define    SEGHDATA_MASK                     ((ESS_UINT16) 0xFF00) /**< \brief Data mask*/
#define    SEGDATASHIFT                      ((ESS_UINT16) 8) /**< \brief Shift for first data Byte*/
    ESS_UINT16      Data[(((MAX_MBX_DATA_SIZE)-(SEGMENT_NORM_HEADER_SIZE) - 1 ) >> 1)];  /**< \brief Data buffer (second and following Bytes, the first byte is located in the header variable)*/
#else
    ESS_UINT8        SegHeader; /**< \brief 8Bit header buffer*/
                #define    SEGHEADER_MASK                    ((ESS_UINT8) 0xFF) /**< \brief SDO header mask*/
                #define    SEGHEADER_NOMOREFOLLOWS           ((ESS_UINT8) 0x01) /**< \brief More segments follow flag*/
                #define    SEGHEADER_SEGDATASIZE             ((ESS_UINT8) 0x0E) /**< \brief Segmented data size*/
                #define    SEGHEADER_TOGGLE                  ((ESS_UINT8) 0x10) /**< \brief Toogle flag*/
                #define    SEGHEADER_COMMAND                 ((ESS_UINT8) 0xE0) /**< \brief Command identifier*/
                #define    SEGHEADERSHIFT_SEGDATASIZE        ((ESS_UINT8) 1) /**< \brief Shift for Segmented data size*/
                #define    SEGHEADERSHIFT_TOGGLE             ((ESS_UINT8) 4) /**< \brief Shift for toggle flag*/
                #define    SEGHEADERSHIFT_COMMAND            ((ESS_UINT8) 5) /**< \brief Shift for command identifier*/
      ESS_UINT8    Data[(MAX_MBX_DATA_SIZE)-(SEGMENT_NORM_HEADER_SIZE)]; /**< \brief Data buffer*/
#endif
}MBX_STRUCT_PACKED_END
TSDOSEGHEADERDATA;
...
typedef struct MBX_STRUCT_PACKED_START
{
  ...
  TCOEHEADER            CoeHeader; /**< \brief CoE header*/
  TINITSDOHEADER        SdoHeader; /**< \brief SDO header*/
  ESS_UINT16                Data[(MAX_EXPEDITED_DATA) >> 1]; /**< \brief Data buffer*/
}MBX_STRUCT_PACKED_END
...
typedef struct MBX_STRUCT_PACKED_START
{
  ...
  TCOEHEADER            CoeHeader; /**< \brief CoE header*/
  TINITSDOHEADER        SdoHeader; /**< \brief SDO header*/
  ESS_UINT16                CompleteSize[2]; /**< \brief Complete object size*/
  ESS_UINT16                Data[(((MAX_MBX_DATA_SIZE)-(DOWNLOAD_NORM_REQ_SIZE)) >> 1)]; /**< \brief Data buffer*/
}MBX_STRUCT_PACKED_END
...
typedef struct MBX_STRUCT_PACKED_START
{
  TMBXHEADER            MbxHeader; /**< \brief Mailbox header*/
  TCOEHEADER            CoeHeader; /**< \brief CoE header*/
  ESS_UINT8                 SegHeader; /**< \brief SDO header*/
}MBX_STRUCT_PACKED_END
...
typedef struct MBX_STRUCT_PACKED_START
{
  ...
  TINITSDOHEADER        SdoHeader; /**< \brief SDO header*/
  ESS_UINT16                CompleteSize[2]; /**< \brief Complete object size*/
  ESS_UINT16                Data[(((MAX_MBX_DATA_SIZE)-(UPLOAD_NORM_RES_SIZE)) >> 1)]; /**< \brief Data buffer*/
}MBX_STRUCT_PACKED_END
...
typedef struct MBX_STRUCT_PACKED_START
{
  ...
  TCOEHEADER            CoeHeader; /**< \brief CoE header*/
  TINITSDOHEADER        SdoHeader; /**< \brief SDO header*/
  ESS_UINT32             AbortCode; /**< \brief SDO abort code*/
}MBX_STRUCT_PACKED_END
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16                ListType; /**< \brief List type variable*/
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16            DataType; /**< \brief Object data type*/
    ESS_UINT16            ObjFlags; /**< \brief Object flags (including object code and max subindex)*/
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16                DataType; /**< \brief Entry data type*/
    ESS_UINT16                BitLength; /**< \brief Entry bit size*/
    ESS_UINT16                ObjAccess; /**< \brief Entry access rights*/
                                     /**<
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16                Index; /**< \brief Index of the parent object*/
    ESS_UINT16                 Info; /**< \brief Info data including the subindex and identifier for the payload data*/
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT32                ErrorCode; /**< \brief SDO Info error code*/
}MBX_STRUCT_PACKED_END
TSDOINFOERROR;
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16 InfoHead; /**< \brief Opcode, Incomplete flag and 8 reserved bits*/
    #if BIG_ENDIAN_FORMAT
        ...
        #define     INFOHEADER_INCOMPLETE_SHIFT     8 /**< \brief Incomplete shift, the incomplete value "SDOINFOSERVICE_INCOMPLETE" is defined as a ESS_UINT8 => shift only one byte*/
    #else
        ...
        #define     INFOHEADER_INCOMPLETE_SHIFT     0 /**< \brief Incomplete shift, the incomplete value "SDOINFOSERVICE_INCOMPLETE" is defined as a ESS_UINT8 => no shift required*/
    #endif

    ESS_UINT16                FragmentsLeft; /**< \brief Number of fragments which will follow*/
    ...
    union MBX_STRUCT_PACKED_START
    {
        ...
        ESS_UINT16          Data[1];/**< \brief Unspecified data*/
    }MBX_STRUCT_PACKED_END
 ...
 *@{
 */
PROTO ESS_UINT8         u8PendingSdo; /**< \brief Identifier for the pending SDO service (see SDO_PENDING_XXX defines)*/
PROTO ESS_BOOL          bStoreCompleteAccess; /**< \brief Indicates if the pending SDO service is an complete access*/
PROTO ESS_UINT8         u8StoreSubindex; /**< \brief Contains the subindex for the pending SDO request*/
PROTO ESS_UINT16        u16StoreIndex; /**< \brief Contains the Index for the pending SDO request*/
PROTO ESS_UINT32        u32StoreDataSize; /**< \brief Complete data size to be handled*/
PROTO ESS_UINT16 MBXMEM *pStoreData; /**< \brief Pointer to the buffer to be handled*/
PROTO ESS_UINT8 (* pSdoPendFunc)( ESS_UINT16 Index, ESS_UINT8 Subindex, ESS_UINT32 Size, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess ); /**< \brief Function pointer for the SDO pending request handler*/
/** @}*/
#endif
 ...
 * @{
 */
PROTO ESS_UINT16 VARMEM * VARMEM                pSdoSegData; /**< \brief Pointer to the buffer handling to full object/entry data*/
PROTO ESS_UINT16          VARMEM                nSdoInfoFragmentsLeft; /**< \brief Number of fragments which need to be transmitted*/
/** @}*/
#endif
...
------
-----------------------------------------------------------------------------------------*/
PROTO    ESS_UINT8 SDOS_SdoInfoInd(TSDOINFORMATION MBXMEM *pSdoInfoInd);
PROTO    ESS_UINT8 SDOS_SdoInd(TINITSDOMBX MBXMEM *pSdoInd);

#if SDO_RES_INTERFACE
PROTO    void  SDOS_SdoRes(ESS_UINT8 abort, ESS_UINT32 objLength, ESS_UINT16 MBXMEM *pData);
#endif
