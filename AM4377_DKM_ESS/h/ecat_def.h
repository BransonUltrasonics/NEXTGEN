...
/** 
PRUESC_HW: Temporary define to support TI ICE/IDK development board (Shall be set if the Slave code shall executed on an AM335X ICE/IDK Evaluation Board<br>
...
#ifndef ECAT_SLAVE_APPL
/*ECAT_SLAVE_APPL: Should be set if the Slave Sample Code runs on an ICE/IDK EVM. */
#define ECAT_SLAVE_APPL                         1
#endif
...
/** 
FALSE: Will be used for variables from type ESS_BOOL */
#ifndef FALSE
#define FALSE                                     0
#endif

/** 
TRUE: Will be used for variables from type ESS_BOOL  */
#ifndef TRUE
#define TRUE                                      1
#endif

/** 
ESS_BOOL: Should be adapted to the boolean type of the microcontroller */
#ifndef ESS_BOOL
#define ESS_BOOL                                      unsigned char
#endif

/** 
ESS_UINT8: Should be adapted to the unsigned8 type of the microcontroller  */
#ifndef ESS_UINT8
#define ESS_UINT8                                     unsigned char
#endif

/** 
ESS_UINT16: Should be adapted to the unsigned16 type of the microcontroller  */
#ifndef ESS_UINT16
#define ESS_UINT16                                    unsigned short
#endif

/** 
ESS_UINT32: Should be adapted to the unsigned32 type of the microcontroller  */
#ifndef ESS_UINT32
#define ESS_UINT32                                    unsigned long
#endif

/** 
ESS_USHORT: Should be adapted to the unsigned16 type of the microcontroller */
#ifndef ESS_USHORT
#define ESS_USHORT                                    unsigned short
#endif

/** 
ESS_INT8: Should be adapted to the integer8 type of the microcontroller */
#ifndef ESS_INT8
#define ESS_INT8                                      char
#endif

/** 
ESS_INT16: Should be adapted to the integer16 type of the microcontroller  */
#ifndef ESS_INT16
#define ESS_INT16                                     short
#endif

/** 
ESS_INT32: Should be adapted to the integer32 type of the microcontroller */
#ifndef ESS_INT32
#define ESS_INT32                                     long
#endif

/** 
ESS_CHAR: Should be adapted to the character type of the microcontroller */
#ifndef ESS_CHAR
#define ESS_CHAR                                      char
#endif

/** 
ESS_UCHAR: Should be adapted to the unsigned character type of the microcontroller */
#ifndef ESS_UCHAR
#define ESS_UCHAR                                     unsigned char
#endif
...
#ifndef MEM_ADDR
#if CONTROLLER_32BIT
#define MEM_ADDR                                  ESS_UINT32
#elif CONTROLLER_16BIT
#define MEM_ADDR                                  ESS_UINT16
#else
#define MEM_ADDR                                  ESS_UINT8
#endif
#endif
...
#ifndef VENDOR_ID
#if SAMPLE_APPLICATION_INTERFACE && PRUESC_HW
...
#elif SAMPLE_APPLICATION_INTERFACE && PRUESC_HW
#define REVISION_NUMBER                           0x00000001
#elif ECAT_SLAVE_APPL
