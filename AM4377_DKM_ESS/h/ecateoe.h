...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16                  Flags1; /**< \brief First 16Bit Flags*/
    ...
    ESS_UINT16                  Flags2; /**< \brief Second 16Bit Flags*/
        #define    EOEINIT_APPENDTIMESTAMP           0x0001 /**< \brief Includes time stamp*/
    ETHERNET_ADDRESS        MacAddr; /**< \brief MAC address buffer*/
    ESS_UINT32                  IpAddr; /**< \brief IP address buffer*/
    ESS_UINT32                  SubnetMask; /**< \brief SubNetMask buffer*/
    ESS_UINT32                  DefaultGateway; /**< \brief default gateway buffer*/
    ESS_UINT32                  DnsServer; /**< \brief DNS server buffer*/
    ESS_CHAR                    DnsName[32]; /**< \brief DNS name buffer*/
}MBX_STRUCT_PACKED_END
ETHERCAT_EOE_INIT;
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16                    Flags; /**< \brief 16Bit Flags*/
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT32                        TimeStamp;  /**< \brief 32 bit time stamp*/
}MBX_STRUCT_PACKED_END
...
PROTO ESS_BOOL                bEoESendFramePending;                  /**< \brief is set while an Ethernet frame is sent
...
PROTO    ESS_UINT8 EOE_ServiceInd(TMBX MBXMEM * pMbx);
PROTO    void     EOE_ContinueInd(TMBX MBXMEM * pMbx);
PROTO    ESS_UINT8 EOE_SendFrameReq(ESS_UINT8 MBXMEM * pFrame, ESS_UINT16 frameSize);
