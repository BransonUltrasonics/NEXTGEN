...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    ESS_UINT16              FrameType; /**< \brief EtherType (in host-order)*/
}MBX_STRUCT_PACKED_END
ETHERNET_FRAME;


#define    ETHERNET_FRAME_LEN        SIZEOF(ETHERNET_FRAME) /**< \brief Ethernet header size*/
#define    ETHERNET_FRAMETYPE_LEN    SIZEOF(ESS_UINT16) /**< \brief Ethernet Type size*/
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16              hwAddrSpace;  /**< \brief Hardware Address Space: 1 = Ethernet*/
    ESS_UINT16              protAddrSpace;  /**< \brief ETHERNET_FRAME_TYPE_IP*/
    ESS_UINT8               lengthHwAddr;  /**< \brief Length of Hardware address (6)*/
    ESS_UINT8               lengthProtAddr;  /**< \brief Length of Port address (4)*/
    ESS_UINT16              opcode;  /**< \brief 1 = request, 2 = reply*/
    ETHERNET_ADDRESS    macSource; /**< \brief Source MAC*/
    ESS_UINT32              ipSource; /**< \brief Source IP*/
    ETHERNET_ADDRESS    macDest; /**< \brief Destination MAC*/
    ESS_UINT32              ipDest; /**< \brief Destination IP*/
}MBX_STRUCT_PACKED_END
ARP_IP_HEADER;
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT8        x;  /**< \brief Version and header length*/
    ESS_UINT8        tos; /**< \brief Type of service*/
    ESS_UINT16       length; /**< \brief Total length*/
    ESS_UINT16       identifier; /**< \brief Identification*/
#define IP_MF 0x2000 /**< \brief More fragments (stored in "fragment")*/
    ESS_UINT16       fragment; /**< \brief Flags and Fragment offset*/
    ESS_UINT8        ttl; /**< \brief Time to live*/
    ESS_UINT8        protocol; /**< \brief following protocol*/
    ESS_UINT16       cksum; /**< \brief Checksum*/
    ESS_UINT32       src; /**< \brief Source IP*/
    ESS_UINT32       dest; /**< \brief Destination IP*/
}MBX_STRUCT_PACKED_END
IP_HEADER;
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16    src_port;  /**< \brief Source port*/
    ESS_UINT16    dest_port; /**< \brief Destination port*/
    ESS_UINT16    length;  /**< \brief Length (including this header)*/
    ESS_UINT16    checksum; /**< \brief Checksum*/
}MBX_STRUCT_PACKED_END
UDP_HEADER;
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT16        portSource; /**< \brief Source port*/
    ESS_UINT16        portDest; /**< \brief Destination port*/
    ESS_UINT32        seqNo; /**< \brief Sequence number*/
    ESS_UINT32        ackNo; /**< \brief Acknowledge number*/
    ESS_UINT16        flags; /**< \brief Flags*/
/*    struct
    {
        ESS_UINT16        dataOffset    : 4;
        ESS_UINT16        reserved        : 6;
        ESS_UINT16        urg            : 1;
        ESS_UINT16        ack            : 1;
        ESS_UINT16        psh            : 1;
        ESS_UINT16        rst            : 1;
    ...
    ESS_UINT16        window; /**< \brief Window*/
    ESS_UINT16        checksum; /**< \brief Checksum*/
    ESS_UINT16        urgentPtr; /**< \brief Urgent*/
    ESS_UINT32        options; /**< \brief Options*/
/*    struct
    {
        ESS_UINT32        options        : 24;
        ESS_UINT32        padding        : 8;
    };*/
...
typedef struct MBX_STRUCT_PACKED_START
{
    ESS_UINT8       type; /**< \brief Type*/
    ESS_UINT8       code; /**< \brief Code*/
    ESS_UINT16      checksum; /**< \brief Checksum*/
    union
    {
        struct
        {
            ESS_UINT8        pointer;  /**< \brief Pointer*/
        } p;
        struct
        {
            ESS_UINT16    id; /**< \brief ID*/
            ESS_UINT16    seqNo; /**< \brief Sequence number*/
        } i;
        ESS_UINT32    gatewayAddr; /**< \brief Gateway address*/
    } u; /**< \brief Data*/
}MBX_STRUCT_PACKED_END
ICMP_HEADER;
...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    union
    {
        ...
        ESS_UINT8               Data[(ETHERNET_MAX_FRAME_LEN)-(ETHERNET_FRAME_LEN)-(IP_HEADER_MINIMUM_LEN)]; /**< \brief payload*/
...
PROTO    void EOEAPPL_ReceiveFrameInd(ESS_UINT8 MBXMEM * pFrame, ESS_UINT16 frameSize);
PROTO    ESS_UINT16 EOEAPPL_CalcCheckSum (ESS_UINT16 MBXMEM *pWord, ESS_UINT16 nLen);
PROTO    ESS_UINT16 EOEAPPL_SettingsInd(ETHERCAT_EOE_INIT MBXMEM *pEoeInit);
/* ECATCHANGE_START(V5.11) EOE1*/
ESS_UINT16 EOEAPPL_GetSettingsInd(ETHERCAT_EOE_INIT MBXMEM *pEoeInit,ESS_UINT16 *pMbxLength);
