...
{
    ESS_UINT16                      Code; /**< \brief Code of the emergency message*/
    ESS_UINT16                      RegData[3]; /**< \brief Emergency data*/
#if BIG_ENDIAN_16BIT
...
{
#if SOE_SUPPORTED
    ESS_UINT16                        SoeHeader[2];/**< \brief SoE Header*/
#endif
...
typedef struct
{
    ESS_UINT16                      FirstInQueue; /**< Index to first queue element*/
    ESS_UINT16                      LastInQueue; /**< Index to last queue element*/
    ESS_UINT16                      PutInQueueFailedCounter;
    ESS_UINT16                      MaxQueueSize; /**< \brief Maximum elements in the queue*/
...
PROTO    ESS_UINT8 EMCY_IsQueueEmpty(void);
PROTO    void EMCY_ContinueInd(TMBX MBXMEM * pMbx);
PROTO    TEMCYMESSAGE EMCYMEM * EMCY_GetEmcyBuffer(void);
PROTO    ESS_UINT8 EMCY_SendEmergency(TEMCYMESSAGE EMCYMEM *pEmcy);
