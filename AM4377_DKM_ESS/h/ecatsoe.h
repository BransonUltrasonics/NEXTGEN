...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    {
        ESS_UINT16 Word; /**< \brief Flags buffer*/
    ...
    ESS_UINT16        IDN_Frag;  /**< \brief IDN fragments 
                              * 
...
typedef struct MBX_STRUCT_PACKED_START
{
  ...
  ESS_UINT8             Data[(MAX_MBX_SIZE) - SOE_HEADER_SIZE]; /**< \brief buffer for SoE data*/
}MBX_STRUCT_PACKED_END
TSOEMBX;
...
PROTO    ESS_UINT8 SOE_ServiceInd(TMBX MBXMEM *pReceiveMbx);
...
PROTO    ESS_UINT16 SOE_NotificationReq(ESS_UINT16 idn, ESS_UINT16 channel, ESS_UINT16 dataState);
