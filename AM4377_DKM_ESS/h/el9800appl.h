...
#if _PIC24
   ESS_UINT32   aEntries[9]; /**< \brief Entry buffer*/
#else
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   ESS_UINT32   aEntries[8]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1A02;
/** @}*/
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   ESS_UINT16   aEntries[1]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1C12;
...
typedef struct OBJ_STRUCT_PACKED_START {
   ESS_UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   ESS_UINT16   aEntries[2]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
TOBJ1C13;
/** @}*/
...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   ESS_INT16   i16Analoginput; /**< \brief (SI17) Analog input value*/
} OBJ_STRUCT_PACKED_END
TOBJ6020;
...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   ALIGN8(SubIndex009) /**< \brief 8Bit Alignment*/
   ESS_INT16   i16Offset; /**< \brief Value offset*/
   ESS_INT32   i32Gain; /**< \brief Value gain*/
   ESS_INT16   i16Limit1; /**< \brief Value limit 1*/
   ESS_INT16   i16Limit2; /**< \brief Value limit 2*/
} OBJ_STRUCT_PACKED_END
TOBJ8020;
/** @}*/
...
-----------------------------------------------*/
ESS_CHAR sEnum0800_Value00[] = "\000\000\000\000Signed presentation"; /**< \brief Value = 0x00, Text = Signed presentation */
ESS_CHAR sEnum0800_Value01[] = "\001\000\000\000Unsigned presentation"; /**< \brief Value = 0x01, Text = Unsigned presentation */
ESS_CHAR *apEnum0800[2] = { sEnum0800_Value00, sEnum0800_Value01};/**< \brief List of Enum (0x800) values*/
 ...
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1601[] = "DO RxPDO-Map\000\377";
#endif //#ifdef _OBJD_
 ...
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1802[] = "TxPDO Parameter\000\000\000\000\000\000Exclude TxPDOs\000TxPDOState\000\000TxPDO Toggle\000\377";
#endif //#ifdef _OBJD_
 ...
 */
PROTO ESS_UINT16 TxPDO1802Subindex0
#ifdef _EVALBOARD_
    = 9
#endif
    ;
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1A00[] = "DI TxPDO-Map\000\377";
#endif //#ifdef _OBJD_
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST ESS_UCHAR OBJMEM aName0x1A02[] = "AI TxPDO-Map\000\377";
#endif //#ifdef _OBJD_
 ...
 */
#if _PIC24
OBJCONST ESS_UCHAR OBJMEM aName0x6000[] = "DI Inputs\000Switch 1\000Switch 2\000Switch 3\000Switch 4\000Switch 5\000Switch 6\000Switch 7\000Switch 8\000\000\377";
#else
OBJCONST ESS_UCHAR OBJMEM aName0x6000[] = "DI Inputs\000Switch 1\000Switch 2\000Switch 3\000Switch 4\000\000\377";
#endif
#endif //#ifdef _OBJD_
 ...
 */
OBJCONST ESS_UCHAR OBJMEM aName0x6020[] = "AI Inputs\000Underrange\000Overrange\000Limit 1\000\000Limit 2\000\000\000\000\000\000\000\000\000\000TxPDO State\000TxPDO Toggle\000Analog input\000\377";
#endif //#ifdef _OBJD_
 ...
 */
#if _PIC24
OBJCONST ESS_UCHAR OBJMEM aName0x7010[] = "DO Outputs\000LED 1\000LED 2\000LED 3\000LED 4\000LED 5\000LED 6\000LED 7\000LED 8\000\000\377";
#else
OBJCONST ESS_UCHAR OBJMEM aName0x7010[] = "DO Outputs\000LED 1\000LED 2\000LED 3\000LED 4\000\000\377";
#endif
#endif //#ifdef _OBJD_
...
OBJCONST ESS_UCHAR OBJMEM aName0x8020[] = "AI Settings\000Enable user scale\000Presentation\000\000\000\000\000Enable limit 1\000Enable limit 2\000\000\000\000\000\000\000\000\000Offset\000Gain\000Limit 1\000Limit 2\000\377";
#endif //#ifdef _OBJD_
...
#ifdef _OBJD_
PROTO ESS_UINT8 ReadObject0x1802( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
