...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   ESS_UINT32   aEntries[PDO_MAPPING_ENTIRES]; /**< \brief Entry buffer*/
...
OBJCONST ESS_UCHAR OBJMEM aName0x6000[] = "Input Data";
#endif //#ifdef _OBJD_
...
OBJCONST ESS_UCHAR OBJMEM aName0x7010[] = "Output Data";
#endif //#ifdef _OBJD_
/* memory pointer is stored in Slave Interface*/


/** \brief Callback function to read the process data objects*/
PROTO ESS_UINT8 ReadProcessDataObject( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );

/** \brief Callback function to write the process data objects*/
PROTO ESS_UINT8 WriteProcessDataObject( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess );
/** @}*/
