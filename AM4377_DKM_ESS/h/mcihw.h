...
#define     HW_GetALEventRegister()             ((((volatile ESS_UINT16 ESCMEM *)pEsc)[((ESC_AL_EVENT_OFFSET)>>1)])) /**< \brief Returns the first 16Bit of the AL Event register (0x220)*/
...
#define     HW_EscReadDWord(DWordValue, Address)    ((DWordValue) = (ESS_UINT32)(((volatile ESS_UINT32 *)pEsc)[(Address>>2)])) /**< \brief 32Bit specific ESC (register and DPRAM) read access.*/
#define     HW_EscReadDWordIsr(DWordValue, Address) ((DWordValue) = (ESS_UINT32)(((volatile ESS_UINT32 *)pEsc)[(Address>>2)])) /**< \brief 32Bit specific ESC (register and DPRAM) read access.<br>Called from ISRs.*/
#if !ESC_32BIT_ACCESS
#define     HW_EscReadWord(WordValue, Address)  ((WordValue) = (((volatile ESS_UINT16 *)pEsc)[((Address)>>1)])) /**< \brief 16Bit specific ESC (register and DPRAM) read access.*/
...
#if !ESC_16BIT_ACCESS
#define     HW_EscReadByte(ByteValue, Address)  ((ByteValue) = (((volatile ESS_UINT8 *)pEsc)[(Address)])) /**< \brief 8Bit specific ESC (register and DPRAM) read access.*/
...
#define     HW_EscWriteDWord(DWordValue, Address)   ((((volatile ESS_UINT32 *)pEsc)[(Address>>2)]) = (DWordValue)) /**< \brief 32Bit specific ESC (register and DPRAM) write access.*/
#define     HW_EscWriteDWordIsr(DWordValue, Address)((((volatile ESS_UINT32 *)pEsc)[(Address>>2)]) = (DWordValue)) /**< \brief 32Bit specific ESC (register and DPRAM) write access.<br>Called from ISRs.*/
#if !ESC_32BIT_ACCESS
#define     HW_EscWriteWord(WordValue, Address) ((((volatile ESS_UINT16 *)pEsc)[((Address)>>1)]) = (WordValue)) /**< \brief 16Bit specific ESC (register and DPRAM) write access.*/
...
#if !ESC_16BIT_ACCESS
#define     HW_EscWriteByte(ByteValue, Address) ((((volatile ESS_UINT8 *)pEsc)[(Address)]) = (ByteValue)) /**< \brief 8Bit specific ESC (register and DPRAM) write access.*/
