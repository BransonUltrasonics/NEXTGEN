...
-----------------------------------------------------------------------------------------*/
    ...
    /* old:    #define    OBJGETNEXTSTR(p)    ( (OBJCONST ESS_CHAR OBJMEM * )( ((ESS_UINT32) p) + OBJSTRLEN( (OBJCONST ESS_CHAR OBJMEM *) p ) + 1 ) ) */
    #define    OBJGETNEXTSTR(p)    ( (OBJCONST ESS_CHAR OBJMEM * )(  &((p)[OBJSTRLEN( (OBJCONST ESS_CHAR OBJMEM *) (p) ) + 1]) ) ) /**< \brief Macro to get next name within the objetc name string*/
#endif
...
#ifndef SWAPWORD
    #define    SWAPWORD(x)                        ((ESS_UINT16)(((((ESS_UINT16)(x))&0xFF)<<8)+((((ESS_UINT16)(x))&0xFF00)>>8))) /**< \brief Macro to swap a WORD*/
#endif

#ifndef SWAPDWORD
    #define    SWAPDWORD(x)                    ((ESS_UINT32)(((((ESS_UINT32)(x))&0xFF)<<24)+((((ESS_UINT32)(x))&0xFF00)<<8)+((((ESS_UINT32)(x))&0xFF0000)>>8)+((((ESS_UINT32)(x))&0xFF000000)>>24))) /**< \brief Macro to swap a DWORD*/
#endif
#else
#ifndef LO_BYTE
...
-    State defines
-----------------------------------------------*/
#define     STATE_INIT                        ((ESS_UINT8) 0x01) /**< \brief State INIT*/
#define     STATE_PREOP                       ((ESS_UINT8) 0x02) /**< \brief State PreOP*/
#define     STATE_BOOT                        ((ESS_UINT8) 0x03) /**< \brief State BOOT*/
#define     STATE_SAFEOP                      ((ESS_UINT8) 0x04) /**< \brief State SafeOP*/
#define     STATE_OP                          ((ESS_UINT8) 0x08) /**< \brief State OP*/

#define     STATE_MASK                        ((ESS_UINT8) 0x0F) /**< \brief State mask*/
#define     STATE_CHANGE                      ((ESS_UINT8) 0x10) /**< \brief State change (Error indication/acknowledge) mask and value*/
#define     STATE_DEVID                       ((ESS_UINT8) 0x20) /**< \brief Request/response Explicit device ID*/

#define     BOOT_2_INIT                       ((ESS_UINT8)((STATE_BOOT) << 4) | (STATE_INIT)) /**< \brief State transition BOOT to INIT*/
#define     BOOT_2_PREOP                      ((ESS_UINT8)((STATE_BOOT) << 4) | (STATE_PREOP)) /**< \brief State transition BOOT to INIT*/
#define     BOOT_2_SAFEOP                     ((ESS_UINT8)((STATE_BOOT) << 4) | (STATE_SAFEOP)) /**< \brief State transition BOOT to INIT*/
#define     BOOT_2_OP                         ((ESS_UINT8)((STATE_BOOT) << 4) | (STATE_OP)) /**< \brief State transition BOOT to INIT*/

#define     INIT_2_BOOT                       ((ESS_UINT8)((STATE_INIT) << 4) | (STATE_BOOT)) /**< \brief State transition INIT to BOOT*/
#define     PREOP_2_BOOT                      ((ESS_UINT8)((STATE_PREOP) << 4) | (STATE_BOOT)) /**< \brief State transition PREOP to BOOT*/
#define     SAFEOP_2_BOOT                     ((ESS_UINT8)((STATE_SAFEOP) << 4) | (STATE_BOOT)) /**< \brief State transition SAFEOP to BOOT*/
#define     OP_2_BOOT                         ((ESS_UINT8)((STATE_OP) << 4) | (STATE_BOOT)) /**< \brief State transition OP to BOOT*/

#define     INIT_2_INIT                       ((ESS_UINT8)((STATE_INIT) << 4) | (STATE_INIT)) /**< \brief State transition INIT to INIT*/
#define     INIT_2_PREOP                      ((ESS_UINT8)((STATE_INIT) << 4) | (STATE_PREOP)) /**< \brief State transition INIT to PREOP*/
#define     INIT_2_SAFEOP                     ((ESS_UINT8)((STATE_INIT) << 4) | (STATE_SAFEOP)) /**< \brief State transition INIT to SAFEOP*/
#define     INIT_2_OP                         ((ESS_UINT8)((STATE_INIT) << 4) | (STATE_OP)) /**< \brief State transition INIT to OP*/

#define     PREOP_2_INIT                      ((ESS_UINT8)((STATE_PREOP) << 4) | (STATE_INIT)) /**< \brief State transition PREOP to INIT*/
#define     PREOP_2_PREOP                     ((ESS_UINT8)((STATE_PREOP) << 4) | (STATE_PREOP)) /**< \brief State transition PREOP to PREOP*/
#define     PREOP_2_SAFEOP                    ((ESS_UINT8)((STATE_PREOP) << 4) | (STATE_SAFEOP)) /**< \brief State transition PREOP to SAFEOP*/
#define     PREOP_2_OP                        ((ESS_UINT8)((STATE_PREOP) << 4) | (STATE_OP)) /**< \brief State transition PREOP to OP*/

#define     SAFEOP_2_INIT                     ((ESS_UINT8)((STATE_SAFEOP) << 4) | (STATE_INIT)) /**< \brief State transition SAFEOP to INIT*/
#define     SAFEOP_2_PREOP                    ((ESS_UINT8)((STATE_SAFEOP) << 4) | (STATE_PREOP)) /**< \brief State transition SAFEOP to PREOP*/
#define     SAFEOP_2_SAFEOP                   ((ESS_UINT8)((STATE_SAFEOP) << 4) | (STATE_SAFEOP)) /**< \brief State transition SAFEOP to SAFEOP*/
#define     SAFEOP_2_OP                       ((ESS_UINT8)((STATE_SAFEOP) << 4) |( STATE_OP)) /**< \brief State transition SAFEOP to OP*/

#define     OP_2_INIT                         ((ESS_UINT8)((STATE_OP) << 4) | (STATE_INIT)) /**< \brief State transition OP to INIT*/
#define     OP_2_PREOP                        ((ESS_UINT8)((STATE_OP) << 4) | (STATE_PREOP)) /**< \brief State transition OP to PREOP*/
#define     OP_2_SAFEOP                       ((ESS_UINT8)((STATE_OP) << 4) | (STATE_SAFEOP)) /**< \brief State transition OP to SAFEOP*/
#define     OP_2_OP                           ((ESS_UINT8)((STATE_OP) << 4) | (STATE_OP)) /**< \brief State transition OP to OP*/
...
-    AL Event masks
-----------------------------------------------*/
#define     AL_CONTROL_EVENT                    ((ESS_UINT16) 0x01) /**< \brief AL Control event*/
#define     SYNC0_EVENT                         ((ESS_UINT16) 0x04) /**< \brief Sync0 event*/
#define     SYNC1_EVENT                         ((ESS_UINT16) 0x08) /**< \brief Sync1 event*/
#define     SM_CHANGE_EVENT                     ((ESS_UINT16) 0x10) /**< \brief SyncManager changed event*/
#define     EEPROM_CMD_PENDING                  ((ESS_UINT16) 0x20) /**< \brief EEPROM command pending*/
#define     MAILBOX_WRITE_EVENT                 ((ESS_UINT16) 0x0100) /**< \brief MBoxOut write event*/
#define     MAILBOX_READ_EVENT                  ((ESS_UINT16) 0x0200) /**< \brief MBoxIn read event*/
#define     PROCESS_OUTPUT_EVENT                ((ESS_UINT16) 0x0400) /**< \brief Output process data write event*/
#define     PROCESS_INPUT_EVENT                 ((ESS_UINT16) 0x0800) /**< \brief Input process data read event*/
...
PROTO    ESS_BOOL                           bBootMode; /**< \brief Indicates in slave is in BOOT mode*/
#endif
PROTO    ESS_BOOL                           bEcatOutputUpdateRunning;  /**< \brief Indicates the OP state, will be set in StartOutputHandler
                                                                                and reset in StopOutputHandler*/

PROTO    ESS_BOOL                            bEcatInputUpdateRunning;  /**< \brief Indicates the SAFEOP or OP state, will be set in StartInputHandler 
                                                                                and reset in Stop InputHandler*/

#if MAX_PD_OUTPUT_SIZE > 0
PROTO    ESS_BOOL                           bEcatFirstOutputsReceived; /**< \brief Indicates if outputs were received (SM2-event)
                                                                                or inputs were read (SM3-event, if the output size is 0),
                                                                                has to be set by the application and reset in StopOutputHandler*/

PROTO    ESS_BOOL                           bWdTrigger; /**< \brief Indicates that the SM2 WD trigger bit (0x814 bit6) is set.*/
#endif

PROTO    ESS_BOOL                           bDcSyncActive; /**< \brief Indicates that the Distributed Clocks synchronization is active,*/

PROTO    ESS_INT16                          EsmTimeoutCounter; /**< \brief Counter used to detect an ESM timeout.
...
#if DC_SUPPORTED
PROTO ESS_BOOL                              bDcRunning; /**< \brief Indicates if Sync0 events are received*/

PROTO ESS_UINT16                            u16SmSync0Counter; /**< /brief Incremented by one on every Sync0 event and reset to 0 on every SM event. It is used to check the SM/Sync0 sequence */
PROTO ESS_UINT16                            u16SmSync0Value; /**< /brief Allowed Sync0 events within one SM cycle. If 0 the Sequence check is disabled */

PROTO ESS_BOOL                              bSmSyncSequenceValid; /**< \brief Set to true if SM/Sync0 sequence is valid*/

PROTO ESS_INT16                             i16WaitForPllRunningTimeout; /**< \brief The time bPllRunnig shall be true while state change from SafeOp to Op*/

PROTO ESS_INT16                             i16WaitForPllRunningCnt; /**< \brief Incremented with every valid Sync-SyncManger cycle */

PROTO ESS_UINT16                            Sync0WdCounter; /**< \brief Sync0 watchdog counter*/
PROTO ESS_UINT16                            Sync0WdValue; /**< \brief Sync0 watchdog value*/

PROTO ESS_UINT16                            Sync1WdCounter; /**< \brief Sync1 watchdog counter*/
PROTO ESS_UINT16                            Sync1WdValue; /**< \brief Sync1 watchdog value*/

PROTO ESS_UINT16                            LatchInputSync0Value; /**< \brief Sync0 event on which the inputs shall be latched and copied to the ESC buffer. If the inputs shall be latched base don Sync1 the value is set to 0.*/
PROTO ESS_UINT16                            LatchInputSync0Counter; /**< \brief Sync0 counter used to get the Sync0 event to latch the Inputs. */

#if !COE_SUPPORTED || (MAX_PD_OUTPUT_SIZE == 0)
PROTO ESS_UINT16    u16SmEventMissedCounter;  /**< \brief Required for Sync0/SM sequence watchdog (if COE_SUPPORTED the value is stored in the object 0x1C32)*/
#endif

#endif


PROTO ESS_BOOL                              bEscIntEnabled; /**< \brief Indicates that the ESC interrupt is enabled (SM2/3 or SYNC0/1-event),
                                                                     will be set in StartInputHandler and reset in StopInputHandler*/

PROTO ESS_BOOL                              b3BufferMode; /**< \brief Indicates that inputs and outputs are running in 3-Buffer-Mode*/

PROTO ESS_BOOL                              bLocalErrorFlag; /**< \brief Contains the information if the application has a local error*/
PROTO ESS_UINT16                            u16LocalErrorCode; /**< \brief Reason for local error*/
PROTO ESS_BOOL                              bApplEsmPending; /**< \brief Indicates if the local application ESM function need to be called from Al_ConntrolRes (is true if NOERR_INWORK is returned by generic ESM function)*/
PROTO ESS_BOOL                              bEcatWaitForAlControlRes; /**< \brief Contains the information that the state machine waits for an acknowledge
                                                                             for the last AL_ControlInd from the application/generic stack*/

PROTO ESS_UINT16                            nEcatStateTrans; /**< \brief Current state transition*/

#if UC_SET_ECAT_LED || ESC_SUPPORT_ECAT_LED
PROTO ESS_UINT8                             u8EcatErrorLed; /**< \brief Current value of the run LED*/

PROTO ESS_UINT8                             u8EcatRunLed; /**< \brief Current value of the error LED*/
#endif
/*ECATCHANGE_START(V5.11) ECAT4*/

PROTO ESS_UINT16                            nPdInputSize; /**< \brief Contains the input size (SM3 size)/SM2 if no outputs are supported, has to be written by the application*/

PROTO ESS_UINT16                            nPdOutputSize; /**< \brief Contains the output size (SM2 size), has to be written by the application*/
/*ECATCHANGE_END(V5.11) ECAT4*/

PROTO ESS_UINT8                             nMaxSyncMan; /**< \brief Contains the maximum number of Sync Manager channels, will be initialized in ECAT_Main*/

PROTO ESS_UINT16                            nMaxEscAddress; /**< \brief Max supported address by the ESC (register(0x1000) + size of the supported DPRAM in Byte)*/

PROTO ESS_UINT8                             nAlStatus; /**< \brief Contains the actual AL Status, will be written in AL_ControlInd*/

#if EXPLICIT_DEVICE_ID
PROTO ESS_BOOL                              bExplicitDevIdRequested; /**< \brief Indicates if 0x0120.5 is set*/
#endif

PROTO ESS_UINT16                            EcatWdValue; /**< \brief Contains the value of the watchdog in 100us, will be written in StartInputHandler. 
...
PROTO ESS_UINT16                            EcatWdCounter; /**< \brief Counter for the watchdog, will be reset in StartInputHandler and from
                                                                    the application when outputs were received (SM2-event) or inputs were read
                                                                    (SM3-event, if the output size is 0)*/
#endif
#if MAX_PD_OUTPUT_SIZE > 0
PROTO    ESS_UINT16                         nEscAddrOutputData; /**< \brief Contains the SM address for the output process data*/
#endif
#if MAX_PD_INPUT_SIZE > 0
PROTO    ESS_UINT16                         nEscAddrInputData; /**< \brief Contains the SM address for the input process data*/
#endif
...
PROTO void EnableSyncManChannel(ESS_UINT8 channel);
PROTO void DisableSyncManChannel(ESS_UINT8 channel);
PROTO TSYNCMAN ESCMEM *GetSyncMan(ESS_UINT8 channel);
/*ECATCHANGE_END(V5.11) HW1*/
PROTO void SetALStatus(ESS_UINT8 alStatus, ESS_UINT16 alStatusCode);
PROTO void AL_ControlInd(ESS_UINT8 alControl, ESS_UINT16 alStatusCode);
#if !ESC_SM_WD_SUPPORTED
#if MAX_PD_OUTPUT_SIZE > 0
