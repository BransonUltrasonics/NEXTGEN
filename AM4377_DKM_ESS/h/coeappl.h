...
PROTO ESS_UINT16 COE_ObjDictionaryInit(void);
PROTO ESS_UINT16 COE_AddObjectToDic(TOBJECT OBJMEM * pNewObjEntry);
PROTO void COE_RemoveDicEntry(ESS_UINT16 index);
