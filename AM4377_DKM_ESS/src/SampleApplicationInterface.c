...
ESS_UINT8 HardwareOpened = 0;
ESS_UINT16 nInputSize = 4;
ESS_UINT16 nOutputSize = 4;
...
*////////////////////////////////////////////////////////////////////////////////////////
ESS_UINT8 ReadProcessDataObject( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess )
{
...
*////////////////////////////////////////////////////////////////////////////////////////
ESS_UINT8 WriteProcessDataObject( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess )
{
    if(index == 0x7010)
    {
        if(subindex > 0)
...
pECAT_SLAVE_INTERFACE Ecat_Open(unsigned short InputSize, unsigned short OutputSize)
{
    ...
    {
        ESS_UINT16 tmpPdCnt = nPdInputSize;
        ESS_UINT32 EntryValue = 0x60000000;
        counter = 0;
    ...
    {
        ESS_UINT16 tmpPdCnt = nPdOutputSize;
        ESS_UINT32 EntryValue = 0x70100000;
        counter = 0;
