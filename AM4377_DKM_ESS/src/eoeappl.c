...
const    ESS_UINT8    BroadcastEthernetAddress[6]={0xff,0xff,0xff,0xff,0xff,0xff};

ESS_UINT8 aIpAdd[4];
ESS_UINT8 aMacAdd[6];

#if STATIC_ETHERNET_BUFFER
ESS_UINT8 			aEthernetSendBuffer[ETHERNET_MAX_FRAME_LEN];
#endif
...
ESS_UINT16 EOEAPPL_CalcCheckSum (ESS_UINT16 MBXMEM *pWord, ESS_UINT16 nLen)
{
    ESS_UINT32 crc;
    ESS_UINT32 CrcLo;
    ESS_UINT32 CrcHi;
...
void EOEAPPL_ReceiveFrameInd(ESS_UINT8 MBXMEM * pFrame, ESS_UINT16 frameSize)
{
    ...
    case ETHERNET_FRAME_TYPE_ARP1_SW:
        {
            ...
            if ( ( MBXMEMCMP(BroadcastEthernetAddress, pSendFrame->Destination.b, 4) == 0 )
                ...
                &&( pArpIp->lengthProtAddr == SIZEOF(ESS_UINT32) )
                ...
                )
            {
                ...
                EOE_SendFrameReq((ESS_UINT8 MBXMEM *) pSendFrame, ARP_IP_HEADER_LEN + ETHERNET_FRAME_LEN);
            }
        }
        break;
    case ETHERNET_FRAME_TYPE_IP_SW:
        {
                ...
                )
            {
                ...
                pIPHeader->Ip.cksum = SWAPWORD(EOEAPPL_CalcCheckSum((ESS_UINT16 MBXMEM *) &pIPHeader->Ip, IP_HEADER_MINIMUM_LEN));
                // calculate icmp checksum
                pIPHeader->IpData.Icmp.checksum = 0;
                /* type cast because of warning was added */
                pIPHeader->IpData.Icmp.checksum = SWAPWORD(EOEAPPL_CalcCheckSum((ESS_UINT16 MBXMEM *) &pIPHeader->IpData.Icmp, (ESS_UINT16) (length - 20)));
                /* type cast because of warning was added */
                EOE_SendFrameReq((ESS_UINT8 MBXMEM *) pIPHeader, (ESS_UINT16) (ETHERNET_FRAME_LEN + length));
            }
            else
            {
...
ESS_UINT16 EOEAPPL_GetSettingsInd(ETHERCAT_EOE_INIT MBXMEM *pEoeInit,ESS_UINT16 *pMbxLength)
{
    ...
    *pMbxLength += 6;
    ...
    // set IP Address
    ((ESS_UINT8 MBXMEM *) &pEoeInit->IpAddr)[3] = aIpAdd[0];
    ((ESS_UINT8 MBXMEM *) &pEoeInit->IpAddr)[2] = aIpAdd[1];
    ((ESS_UINT8 MBXMEM *) &pEoeInit->IpAddr)[1] = aIpAdd[2];
    ((ESS_UINT8 MBXMEM *) &pEoeInit->IpAddr)[0] = aIpAdd[3];
...
ESS_UINT16 EOEAPPL_SettingsInd(ETHERCAT_EOE_INIT MBXMEM *pEoeInit)
{
    ESS_UINT16 result = 0;
    ...
    {
        // set IP Address
        aIpAdd[0] = ((ESS_UINT8 MBXMEM *) &pEoeInit->IpAddr)[3];
        aIpAdd[1] = ((ESS_UINT8 MBXMEM *) &pEoeInit->IpAddr)[2];
        aIpAdd[2] = ((ESS_UINT8 MBXMEM *) &pEoeInit->IpAddr)[1];
        aIpAdd[3] = ((ESS_UINT8 MBXMEM *) &pEoeInit->IpAddr)[0];
    }
