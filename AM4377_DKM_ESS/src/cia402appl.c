...
*////////////////////////////////////////////////////////////////////////////////////////
ESS_UINT16 CiA402_Init(void)
{
    ESS_UINT16 result = 0;
    ESS_UINT16 AxisCnt = 0;
    ESS_UINT16 j = 0;
    ESS_UINT32 ObjectOffset = 0x800;
    ESS_UINT8 PDOOffset = 0x10;
        ...
        *************************************/
        ...
        while(pDiCEntry->Index != 0xFFFF)
        {
            ...
            if(pDiCEntry->Index >= 0x1400 && pDiCEntry->Index <= 0x1BFF)    //PDO region
                ...
                pDiCEntry->Index += AxisCnt* (ESS_UINT16)ObjectOffset;
...
void CiA402_StateMachine(void)
{
    ...
    ESS_UINT16 StatusWord = 0;
    ESS_UINT16 ControlWord6040 = 0;
    ESS_UINT16 counter = 0;
...
*////////////////////////////////////////////////////////////////////////////////////////
void CiA402_LocalError(ESS_UINT16 ErrorCode)
{
    ESS_UINT16 counter = 0;
    for(counter = 0; counter < MAX_AXES; counter++)
    {
...
void CiA402_DummyMotionControl(TCiA402Axis *pCiA402Axis)
{
    ...
    pCiA402Axis->Objects.objPositionActualValue = (ESS_INT32)(pCiA402Axis->fCurPosition);
...
*////////////////////////////////////////////////////////////////////////////////////////
ESS_BOOL CiA402_TransitionAction(ESS_INT16 Characteristic,TCiA402Axis *pCiA402Axis)
{
...
void CiA402_Application(TCiA402Axis *pCiA402Axis)
{
    ...
    case 0x605A:
        ...
        {
            ESS_UINT16 ramp = pCiA402Axis->Objects.objQuickStopOptionCode;
...
ESS_UINT8 Write0xF030( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess )
{

    ESS_UINT16 i = subindex;
    ESS_UINT16 maxSubindex = sConfiguredModuleIdentList.u16SubIndex0;
    ...
    ESS_UINT8 lastSubindex = subindex;
#endif
    ...
    if ( bCompleteAccess )
    {
        if ( subindex == 0 )
        {
            ...
            maxSubindex = (ESS_UINT8) pData[0];
        }

        /* we write until the maximum subindex */
        lastSubindex = (ESS_UINT8)maxSubindex;
    }
    else
#endif
    ...
    else
    {
...
#endif
        {
            ...
            {
                ESS_UINT32 CurValue = sConfiguredModuleIdentList.aEntries[(i-1)];
                ESS_UINT16 MBXMEM *pVarPtr = (ESS_UINT16 MBXMEM *) &sConfiguredModuleIdentList.aEntries[(i-1)];
                ...
                if((sConfiguredModuleIdentList.aEntries[(i-1)] != (ESS_UINT32)CSV_CSP_MODULE_ID)
                && (sConfiguredModuleIdentList.aEntries[(i-1)] != (ESS_UINT32)CSP_MODULE_ID)
                && (sConfiguredModuleIdentList.aEntries[(i-1)] != (ESS_UINT32)CSV_MODULE_ID)
    ...
    for(PDOAssignEntryCnt = 0; PDOAssignEntryCnt < sRxPDOassign.u16SubIndex0; PDOAssignEntryCnt++)
    {
        switch ((sRxPDOassign.aEntries[PDOAssignEntryCnt] & 0x000F))    //mask Axis type (supported modes)
        {
            case 0:
                ...
                {
                    OutputSize +=(ESS_UINT16)(LocalAxes[PDOAssignEntryCnt].Objects.sRxPDOMap0.aEntries[u16cnt] & 0xFF);
                }
                break;
            case 1:
                ...
                {
                    OutputSize +=(ESS_UINT16)(LocalAxes[PDOAssignEntryCnt].Objects.sRxPDOMap1.aEntries[u16cnt] & 0xFF);
                }
                break;
            case 2:
                    /*drive mode supported    csv(cyclic sync velocity) : bit 8*/
                ...
                {
                    OutputSize += (ESS_UINT16)(LocalAxes[PDOAssignEntryCnt].Objects.sRxPDOMap2.aEntries[u16cnt] & 0xFF);;
                }
                break;
        }
    }
    ...
    if(result == 0)
    {
        ...
        for(PDOAssignEntryCnt = 0; PDOAssignEntryCnt < sTxPDOassign.u16SubIndex0; PDOAssignEntryCnt++)
        {
            ...
            case 0: /*csp/csv*/
                ...
                {
                    InputSize +=(ESS_UINT16)(LocalAxes[PDOAssignEntryCnt].Objects.sTxPDOMap0.aEntries[u16cnt] & 0xFF);
                }
                break;
            case 1: /*csp*/
                for(u16cnt =0 ; u16cnt < LocalAxes[PDOAssignEntryCnt].Objects.sTxPDOMap1.u16SubIndex0;u16cnt++)
                {
                    InputSize +=(ESS_UINT16)(LocalAxes[PDOAssignEntryCnt].Objects.sTxPDOMap1.aEntries[u16cnt] & 0xFF);
                }
                break;
            case 2: /*csv*/
                for(u16cnt =0 ; u16cnt < LocalAxes[PDOAssignEntryCnt].Objects.sTxPDOMap2.u16SubIndex0;u16cnt++)
                {
                    InputSize +=(ESS_UINT16)(LocalAxes[PDOAssignEntryCnt].Objects.sTxPDOMap2.aEntries[u16cnt] & 0xFF);
                }
                break;
            }
        }
...
{
    ESS_UINT16 j = 0;
    ESS_UINT8 *pTmpData = (ESS_UINT8 *)pData;
    ESS_UINT8 AxisIndex;
