...
ESS_UINT8 SDOResult = 0; /**< \brief used to access object via SDO response stack (every first object access will be set to pending)*/
#endif

ESS_UINT32 CurrentActiveTest = 0; /**< \brief Contains the current active test. This value is used if the tests are activated via the user RAM area of the ESC (0xF80:0xF83), see SSC application note for further details.*/
...
void Diag_DumpStateRequest(ESS_UINT8 From, ESS_UINT8 To) 
{
...
/* ECATCHANGE_START(V5.11) DIAG4*/
    ...
    aParam[1].ParamFlags = (DIAG_MSG_PARAM_TYPE_DATA << DIAG_MSG_PARAM_TYPE_OFFSET) | (ESS_UINT16) DEFTYPE_UNSIGNED8;
...
{
    ESS_UINT16 RegOffset = 0;
    ESS_UINT16 MaskArrCnt = 0;
    ESS_UINT8 RdData = 0;
    ESS_UINT8 NewData = 0;
    ESS_UINT8 RdMask = 0xFF;
...
ESS_UINT16 APPL_Init(void) 
{
    ESS_UINT16 result = 0;

#if COE_SUPPORTED
    ESS_UINT32 InitValue = 0;
    ESS_UINT32 cnt = 0;
    ...
    {
        HugeObj[cnt] = (ESS_UINT8) (cnt & 0xFF);
    }
...
ESS_UINT16 APPL_StopMailboxHandler(void) 
{
    ...
    {
        ESS_UINT8 ResetVal = 0;
        Write0x10F3(0x10F3,3,1,(ESS_UINT16 MBXMEM * )&ResetVal,FALSE);
    }
#endif
...
void APPL_InputMapping(ESS_UINT16* pData) 
{
    ...
    for (cnt = 0; cnt < sTxPDOassign.u16SubIndex0; cnt++) 
    {
        switch (sTxPDOassign.aEntries[cnt]) 
        {
            ...
            case 0x1AFF:
            {
                *pTmpData = SWAPWORD(nEcatStateTrans); /*0xA000.2, ESS_UINT16*/
                pTmpData++;
...
/*ECATCHANGE_END(V5.11) ECAT4*/
                ...
                *pTmpData = SWAPWORD(EcatWdValue); /*0xA000.33, ESS_UINT16*/
                pTmpData++;
#if !ESC_SM_WD_SUPPORTED
                *pTmpData = SWAPWORD(EcatWdCounter); /*0xA000.34, ESS_UINT16*/
#else
                *pTmpData = 0; /*EcatWdCounter; 0xA000.34 not available*/
#endif
                pTmpData++;

                *pTmpData = SWAPWORD(Sync0WdCounter); /*0xA000.35, ESS_UINT16*/
                pTmpData++;

                *pTmpData = SWAPWORD(Sync0WdValue); /*0xA000.36, ESS_UINT16*/
                pTmpData++;

                *pTmpData = SWAPWORD(Sync1WdCounter); /*0xA000.37, ESS_UINT16*/
                pTmpData++;

                *pTmpData = SWAPWORD(Sync1WdValue); /*0xA000.38 ESS_UINT16*/
                pTmpData++;

                *pTmpData = SWAPWORD(LatchInputSync0Value); /*0xA000.39, ESS_UINT16*/
                pTmpData++;
...
void APPL_Application(void) 
{
    ...
    ActiveMask = (ESS_UINT16) (SWITCH_8 << 6) | (SWITCH_7 << 5) | (SWITCH_6 << 4) | (SWITCH_5 << 3) | (SWITCH_4 << 2) | (SWITCH_3 << 1) | (SWITCH_2);
    if (SWITCH_1)
#else
...
/* ECATCHANGE_ENDT(V5.10.1) DIAG4*/
        DiagParameter.ParamFlags = (ESS_UINT16) DEFTYPE_UNSIGNED32;
    ...
    if(sObj300D_S2S.DstSlv != 0)
    {
        if((sObj300D_S2S.Command != sObj300D_S2S.Status) && (sObj300D_S2S.Command == 0x1))
        {
            ...
            if (pMbx)
            {
                ...
                pMbx->CoeHeader |= ((ESS_UINT16)COESERVICE_SDOREQUEST) << COEHEADER_COESERVICESHIFT;
...
ESS_UINT16 APPL_GetDeviceID(void) 
{
    ESS_UINT16 Value = 0x0005;
    return Value;
}
#endif
...
ESS_UINT8 WriteObject0x2FFF(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    OBJCONST TOBJECT OBJMEM * pObject = NULL;
    TTESTOBJ OBJMEM * pTestObject = NULL;
    ESS_UINT32 NewTest = 0;
    ESS_UINT16 NewTestIndex = 0;
    ESS_UINT8 NewTestSubIndex = 0;
    ...
    NewTestIndex = (ESS_UINT16) (NewTest >> 16);
    NewTestSubIndex = (ESS_UINT8) ((NewTest >> 8) & 0xFF);
...
ESS_UINT8 ReadObject0x2FFF(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    ESS_UINT16 *pTmpData = pData;
    ...
    if (subindex > 0) 
    {
        *pTmpData = ((ESS_UINT16) sTestControlObj.aEntries[(subindex - 1)].TestSubindex) << 8;
        pTmpData++;
...
ESS_UINT8 WriteObject0x3007(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    ESS_UINT8 result = 0;
    ...
    else
    {
        if (subindex > 0) 
        {
            ESS_UINT16 TmpVal = SWAPWORD(*pData) << ((subindex - 1) * 3);

            ESS_UINT16 Mask = 0x3 << ((subindex - 1) * 3); //get BitMask for corresponding subindex
...
ESS_UINT8 ReadObject0x3007(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    ESS_UINT8 result = 0;
    ...
    else
    {
        if (subindex > 0) 
        {
            ESS_UINT16 TmpVal = SWAPWORD(sObj3007.Value) >> ((subindex - 1) * 3);
...
ESS_UINT8 ReadObject0x8000(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    /*Complete Access is not supported for Test objects*/
    if (bCompleteAccess)
        return ABORTIDX_UNSUPPORTED_ACCESS;
    ...
    if (subindex > 0) 
    {
        *pData = (ESS_UINT8) aSlaveConfig[(subindex - 1)].bValue;
    }
    else
    {
...
ESS_UINT8 ReadObject0xA000(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) {
    ...
    *pData = 0;
    ...
    switch (subindex) {
        case 0:
            *pData = A000Subindex0;
            break;
        case 1: /* nEcatStateTrans (ESS_UINT16)*/
...
/*ECATCHANGE_END(V5.11) ECAT4*/
        ...
        case 21: /* bSmSyncSequenceValid*/
            *pData = bSmSyncSequenceValid;
            break;
        case 33: /* EcatWdValue (ESS_UINT16)*/
            *pData = EcatWdValue;
            break;
        case 34: /* EcatWdCounter (ESS_UINT16)*/
#if !ESC_SM_WD_SUPPORTED
            *pData = EcatWdCounter;
#else
            *pData = 0;
#endif
            break;
        case 35: /* Sync0WdCounter (ESS_UINT16)*/
            *pData = Sync0WdCounter;
            break;
        case 36: /* Sync0WdValue (ESS_UINT16)*/
            *pData = Sync0WdValue;
            break;
        case 37: /* Sync1WdCounter (ESS_UINT16)*/
            *pData = Sync1WdCounter;
            break;
        case 38: /* Sync1WdValue (ESS_UINT16)*/
            *pData = Sync1WdValue;
            break;
        case 39: /* LatchInputSync0Value (ESS_UINT16)*/
...
ESS_UINT8 WriteTestObject(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    OBJCONST TOBJECT OBJMEM * pObject = NULL;
    TTESTOBJ OBJMEM * pTestObject = NULL;
    ESS_UINT16 Value = 0x0000;
...
ESS_UINT8 ReadTestObject(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    OBJCONST TOBJECT OBJMEM * pObject = NULL;
    TTESTOBJ OBJMEM * pTestObject = NULL;
    ESS_UINT16 Value = 0x0000;
...
ESS_UINT8 WriteObject0x3006(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    /*ECATCHANGE_START(V5.11) TEST9*/
...
ESS_UINT8 ReadObject0x3006(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
/*ECATCHANGE_START(V5.11) TEST9*/
    if (SDOResult == ABORTIDX_WORKING) 
    {
...
ESS_UINT8 WriteObject0x3002(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    if (SDOResult == ABORTIDX_WORKING) 
    {
...
/*ECATCHANGE_START(V5.11) TEST8*/
        ...
        aParam[0].ParamFlags = (DIAG_MSG_PARAM_TYPE_DATA << DIAG_MSG_PARAM_TYPE_OFFSET) | (ESS_UINT16)DEFTYPE_UNSIGNED32;
/* ECATCHANGE_START(V5.11) DIAG4*/
...
ESS_UINT8 ReadObject0x3002(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    if (SDOResult == ABORTIDX_WORKING) 
    {
        if (SIZEOF(u32Obj) < dataSize)
...
ESS_UINT8 WriteObject0x3009_0x300A(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
...
ESS_UINT8 ReadObject0x3009_0x300A(ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess) 
{
    if (subindex == 0) 
    {
 ...
 *////////////////////////////////////////////////////////////////////////////////////////
ESS_UINT8 ReadObject0x300C( ESS_UINT16 index, ESS_UINT8 subindex, ESS_UINT32 dataSize, ESS_UINT16 MBXMEM * pData, ESS_UINT8 bCompleteAccess )
{
...
void HandleTestControlViaUserRAM()
{
    ...
    {
        index = (ESS_UINT16)((CurrentActiveTest & 0x0000FFFF));
        SubIdx = (ESS_UINT8)((CurrentActiveTest & 0x00FF0000) >> 16);
        ...
        index = (ESS_UINT16)((RegValue & 0x0000FFFF));
        SubIdx = (ESS_UINT8)((RegValue & 0x00FF0000) >> 16);
...
#endif
{
    ...
    void DumpMemoryLeaks(void)
    {
        ...
        {
            ESS_UINT16 cnt = 0;
            ESS_UINT16 MaxSi = SIZEOF(aSlaveConfig)/SIZEOF(TSLV_CONFIG);
            ESS_UINT8 Result = 0;
            ...
            {
                ESS_BOOL DefaultBehaviour = TRUE;
...
ESS_UINT32 EE_GetChecksum(void) 
{
    return 0;
}

ESS_UINT8 EE_IsDefaultDataInitialized(void) 
{
    return 0;
}
...
void EE_ReadWordsFromNonVolatileMemory(ESS_UINT16 HUGE *pDest, ESS_UINT16 srcOffset, ESS_UINT16 n) 
{}

ESS_UINT32 EE_WriteWordsToNonVolatileMemory(ESS_UINT16 destOffset, ESS_UINT16 HUGE * pSrc, ESS_UINT16 n) 
{
    return 0;
}
#endif
