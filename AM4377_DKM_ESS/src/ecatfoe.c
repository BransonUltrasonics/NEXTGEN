...
ESS_UINT8 FOE_ServiceInd(TFOEMBX MBXMEM * pFoeInd)
{
    /* initialize the result of the service checking */
    ESS_UINT16 nextState = ECAT_FOE_ERRCODE_ILLEGAL;
    /* dataSize contains the size of the file data */
    ESS_UINT16 dataSize = SWAPWORD(pFoeInd->MbxHeader.Length) - FOE_HEADER_SIZE;
    ...
    case ECAT_FOE_OPCODE_RRQ:
        ...
        {
            ESS_UINT32 u32Password = SWAPDWORD(pFoeInd->FoeHeader.Cmd.Password);
#if BIG_ENDIAN_16BIT
...
/* ECATCHANGE_END(V5.11) FOE1*/
    ...
    case ECAT_FOE_OPCODE_DATA:
        ...
        {
            ESS_UINT32 u32CmdPacketNo = SWAPDWORD(pFoeInd->FoeHeader.Cmd.PacketNo);
#if BIG_ENDIAN_16BIT
...
/* ECATCHANGE_END(V5.11) FOE1*/  
    ...
    case ECAT_FOE_OPCODE_ERR:
        ...
        if ( u16FileAccessState != FOE_READY )
        {
            ESS_UINT32 u32CmdErrorCode = SWAPDWORD(pFoeInd->FoeHeader.Cmd.ErrorCode);
#if BIG_ENDIAN_16BIT
    ...
    if ( nextState <= FOE_MAXDATA )
    {
        ...
        ESS_UINT32 d = SWAPDWORD(u32PacketNo);
...
/* ECATCHANGE_END(V5.11) FOE1*/
    ...
    {
        ESS_UINT32 d = SWAPDWORD(nextState);
        ESS_UINT8 b = 0;
        ...
        while (b < 32)
        {
            ESS_UINT16 data = ((ESS_UINT16 MBXMEM *) pFoeInd->Data)[(b >> 1)];
