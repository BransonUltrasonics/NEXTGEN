...
#include <PcEcAppl.h>
extern PcRealtimeData *ptrsRealTimeData;
...
{
	sRealTimeData.MasterState				= 0x0 ;
	sRealTimeData.Amplitude_1 			    = 0x0 ;
	sRealTimeData.MasterEvents 				= 0x0 ;
	sRealTimeData.Frequency_1 				= 0x0 ;
}
...
void APPL_InputMapping(Uint16* pData)
{
    ...
    PcRealtimeData sRealTimeData;
 
    sRealTimeData.Amplitude_2 = ptrsRealTimeData->Amplitude_2;
    sRealTimeData.Phase 	  = ptrsRealTimeData->Phase;
    sRealTimeData.Power 	  = ptrsRealTimeData->Power;
    sRealTimeData.Frequency   = ptrsRealTimeData->Frequency;
    sRealTimeData.Current 	  = ptrsRealTimeData->Current;
    sRealTimeData.PCStatus 	  = ptrsRealTimeData->PCStatus;
    sRealTimeData.PCstate 	  = ptrsRealTimeData->PCstate;
   ...
   for (j = 0; j < sTxPDOassign.u16SubIndex0; j++)
   {
      ...
      case 0x1A04:
    	  ...
    	  memcpy((Uint8*)pTmpData , (Uint8*)&sRealTimeData.Amplitude_2 , sizeof(Uint16) );
    	  pTmpData += sizeof(Uint16) ;
    	  memcpy((Uint8*)pTmpData , (Uint8*)&sRealTimeData.Phase , sizeof(Uint16) );
    	  pTmpData += sizeof(Uint16) ;
    	  memcpy((Uint8*)pTmpData , (Uint8*)&sRealTimeData.Power , sizeof(Uint16) );
    	  pTmpData += sizeof(Uint16) ;
    	  memcpy((Uint8*)pTmpData , (Uint8*)&sRealTimeData.Frequency , sizeof(Uint32));
          pTmpData += sizeof(Uint32) ;
    	  memcpy((Uint8*)pTmpData , (Uint8*)&sRealTimeData.Current , sizeof(Uint16) );
    	  pTmpData += sizeof(Uint16) ;
    
    	  *pTmpData++ 				= sRealTimeData.PCStatus ;
    	  *pTmpData++ 				= sRealTimeData.PCstate ;
   ...
   for (j = 0; j < sRxPDOassign.u16SubIndex0; j++)
	{
		...
		case 0x1603:
			memcpy((Uint8*)&ptrsRealTimeData->MasterState, (Uint8*)pTmpData , sizeof(Uint16));
			pTmpData += sizeof(Uint16);
			memcpy((Uint8*)&ptrsRealTimeData->Amplitude_1 , (Uint8*)pTmpData , sizeof(Uint16));
			pTmpData += sizeof(Uint16) ;
			memcpy((Uint8*)&ptrsRealTimeData->MasterEvents, (Uint8*)pTmpData , sizeof(Uint16));
			pTmpData += sizeof(Uint16);
			memcpy((Uint8*)&ptrsRealTimeData->Frequency_1, (Uint8*)pTmpData , sizeof(UINT32));
			break;
		}
	}
}
