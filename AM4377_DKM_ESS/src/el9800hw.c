...
static void GetInterruptRegister(void)
{
    ...
    SPI1_BUF = (ESS_UINT8) (((0x0000 & 0x1F) << 3) | ESC_RD);
    /* write to SPI1_BUF register starts the SPI access */
...
*////////////////////////////////////////////////////////////////////////////////////////
static void AddressingEsc( ESS_UINT16 Address, ESS_UINT8 Command )
{
    UBYTETOWORD tmp;
    VARVOLATILE ESS_UINT8 dummy;
...
#else
static void ISR_AddressingEsc( ESS_UINT16 Address, ESS_UINT8 Command )
{
    VARVOLATILE ESS_UINT8 dummy;
    UBYTETOWORD tmp;
    tmp.Word = ( Address << 3 ) | Command;
...
*////////////////////////////////////////////////////////////////////////////////////////
ESS_UINT16 HW_GetALEventRegister(void)
{
...
#endif
ESS_UINT16 HW_GetALEventRegister_Isr(void)
{
...
*////////////////////////////////////////////////////////////////////////////////////////
void HW_SetLed(ESS_UINT8 RunLed,ESS_UINT8 ErrLed)
{
#if _PIC24
...
*////////////////////////////////////////////////////////////////////////////////////////
void HW_EscRead( MEM_ADDR *pData, ESS_UINT16 Address, ESS_UINT16 Len )
{
...
#pragma interrupt_level 1
#endif
void HW_EscReadIsr( MEM_ADDR *pData, ESS_UINT16 Address, ESS_UINT16 Len )
{
    ESS_UINT16 i = Len;
    ESS_UINT8 data = 0;
...
*////////////////////////////////////////////////////////////////////////////////////////
void HW_EscWrite( MEM_ADDR *pData, ESS_UINT16 Address, ESS_UINT16 Len )
{
    ESS_UINT16 i = Len;
    VARVOLATILE ESS_UINT8 dummy;
...
#pragma interrupt_level 1
#endif
void HW_EscWriteIsr( MEM_ADDR *pData, ESS_UINT16 Address, ESS_UINT16 Len )
{
    ESS_UINT16 i = Len;
    VARVOLATILE ESS_UINT16 dummy;
    ESS_UINT8 *pTmpData = (ESS_UINT8 *)pData;
...
*////////////////////////////////////////////////////////////////////////////////////////
ESS_UINT16 HW_EepromReload (void)
{
    return 0;
}
#endif
