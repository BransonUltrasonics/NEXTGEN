...
ObjectFile libzlib.a::compress.o {
	...
	IMPORTS deflateInit_ deflate deflateEnd
	DECLARES 
	USES 
}
Module compress.o {
...
ObjectFile libzlib.a::deflate.o {
	...
	IMPORTS crc32 adler32 _tr_init memset zcalloc zcfree __udiv32 z_errmsg memcpy _tr_flush_bits _length_code _dist_code _tr_flush_block __urem32 _tr_align _tr_stored_block
	DECLARES 
	USES 
}
Module deflate.o {
...
ObjectFile libzlib.a::gzlib.o {
	...
	IMPORTS free strlen malloc snprintf open lseek
	DECLARES 
	USES 
}
Module gzlib.o {
...
ObjectFile libzlib.a::gzread.o {
	...
	IMPORTS read __errno strerror gz_error malloc free inflateInit2_ inflateReset memcpy inflate memchr inflateEnd close
	DECLARES 
	USES 
}
Module gzread.o {
...
ObjectFile libzlib.a::gzwrite.o {
	...
	IMPORTS malloc deflateInit2_ free gz_error write __errno strerror deflate deflateReset memset memcpy strlen vsnprintf deflateParams deflateEnd close
	DECLARES 
	USES 
}
Module gzwrite.o {
...
ObjectFile libzlib.a::infback.o {
	...
	IMPORTS zcalloc zcfree memcpy inflate_table inflate_fast
	DECLARES 
	USES 
}
Module infback.o {
...
ObjectFile libzlib.a::inflate.o {
	...
	IMPORTS zcalloc zcfree memcpy crc32 __urem32 adler32 inflate_table inflate_fast
	DECLARES 
	USES 
}
Module inflate.o {
...
ObjectFile libzlib.a::uncompr.o {
	...
	EXPORTS uncompress
	IMPORTS inflateInit_ inflate inflateEnd
	DECLARES 
	USES 
}
Module uncompr.o {
