...
ObjectFile libtcfsvservice.a::sv_upload_file.o {
	...
	IMPORTS wvFileUploadPathClose strcmp tcf_json_read_boolean tcf_json_read_string wvFileUploadPathCreate wvUploadStart loc_free loc_alloc tcf_json_read_struct is_valid_wv_log pthread_create
	DECLARES 
	USES 
}
...
ObjectFile libtcfsvservice.a::tipc_events.o {
	...
	EXPORTS newTipcEvt
	IMPORTS _wvTipcConfigure _wvTipcInit write_stream tcf_json_write_string tcf_json_write_boolean tcf_json_write_long strcmp tcf_json_read_boolean tcf_json_read_long tcf_json_read_struct loc_alloc
	DECLARES 
	USES 
}
...
ObjectFile libtcfsvservice.a::usb_events.o {
	...
	IMPORTS write_stream tcf_json_write_string tcf_json_write_boolean tcf_json_write_uint64 strcmp tcf_json_read_boolean tcf_json_read_uint64 tcf_json_read_struct loc_alloc wvUsbInst _usb2WvFilter _usbPeriphWvFilter
	DECLARES 
	USES 
}
Module usb_events.o {
...
ObjectFile libtcfsvservice.a::logging_events.o {
	...
	IMPORTS loc_alloc loc_free write_stringz tcf_json_write_uint64 write_stream
	DECLARES 
	USES 
}
...
ObjectFile libtcfsvservice.a::um_postmortem.o {
	...
	IMPORTS wvCurrentLogListGet wvLogListDelete memPartDelete memPartCreate write_json_config wvPartitionSet wvLogListCreate __udiv32 buffer_overflow_handler rBuffCreate wvLogCountGet wvMaximumLogs wvLogCreate rBuffLibInit tcf_set_errno strcmp tcf_json_read_uint64 tcf_json_read_boolean write_stream tcf_json_write_string tcf_json_write_boolean tcf_json_write_uint64 tcf_json_read_struct _edrPmArena _pmDefaultArena sysMemTop sysPhysMemTop read_json_config loc_alloc
	DECLARES 
	USES 
}
...
ObjectFile libtcfsvservice.a::net_events.o {
	...
	EXPORTS newNetEvt
	IMPORTS pWvNetEvtMap _wvNetDConfigure write_stream tcf_json_write_string tcf_json_write_boolean tcf_json_write_long strcmp tcf_json_read_boolean tcf_json_read_long tcf_json_read_struct loc_alloc
	DECLARES 
	USES 
}
Module net_events.o {
...
ObjectFile libtcfsvservice.a::rtp_events.o {
	...
	EXPORTS newRtpEvt
	IMPORTS write_stream tcf_json_write_string wvObjInst tcf_json_write_boolean _wvObjStacktrace write_objects strcmp tcf_json_read_uint64 tcf_json_read_boolean tcf_json_read_struct tcf_json_read_array loc_alloc
	DECLARES 
	USES 
}
Module rtp_events.o {
...
ObjectFile libtcfsvservice.a::sv_objinfo.o {
	...
	IMPORTS objClassIdGet objVerify objNamePtrGet write_stream tcf_json_write_string tcf_json_write_uint64 objEach
	DECLARES 
	USES 
}
Module sv_objinfo.o {
...
ObjectFile libtcfsvservice.a::logging.o {
	...
	IMPORTS write_stream tcf_json_write_string tcf_json_write_long tcf_json_write_uint64 wvLogCountGet wvLogFirstGet wvLogNextGet find_upload_mode wvLogListValidate wvCurrentLogListGet wvCurrentLogListSet strcmp tcf_json_read_long tcf_json_read_uint64 tcf_json_read_struct wvLogDelete wvLogListDelete tcf_json_read_array tcf_json_test_char write_stringz tcf_write_errno last_upload_mode_id wvEvtLogStart wvCurrentLogGet tcf_set_errno logging_started evtAction tcf_json_write_boolean wvEvtLogStop logging_stopped
	DECLARES 
	USES 
}
Module logging.o {
...
ObjectFile libtcfsvservice.a::lib_events.o {
	...
	IMPORTS _wvCallStackSetLevel write_stream tcf_json_write_string tcf_json_write_boolean strcmp tcf_json_read_boolean tcf_json_read_struct loc_alloc _sigEnabled wvSigInst _evtEnabled wvEventInst _salEnabled wvSalInst _edrEnabled wvEdrInst _mscEnabled wvMemScopeInst wvPowerInst
	DECLARES 
	USES 
}
Module lib_events.o {
...
ObjectFile libtcfsvservice.a::sv_events.o {
	...
	IMPORTS strcmp loc_alloc loc_free write_stream tcf_json_write_string tcf_json_write_boolean memset tcf_json_read_string tcf_json_read_array tcf_json_test_char enable_usb_event newTaskLibEvt newSempLibEvt newMsgQLibEvt newWdLibEvt newMemLibEvt newIoLibEvt newIsrLibEvt newSigEvt newEvtEvt newRtpEvt newSalEvt newEDREvt newSdLibEvt newUsbHostEvt newUsbPeriEvt newNetEvt newTipcEvt newMscEvt newPmnEvt
	DECLARES 
	USES 
}
Module sv_events.o {
...
ObjectFile libtcfsvservice.a::sysviewer.o {
	...
	IMPORTS tcf_json_test_char write_stringz tcf_write_errno write_stream tcf_json_write_string tcf_json_write_long register_events init_upload_modes tcf_add_command_handler command_list_logs command_delete_logs command_start_logging command_stop_logging command_attach_logging command_is_logging command_get_buf_stat command_get_config command_set_config command_store_config ini_uploadmode_services ini_upload_services activate_logging
	DECLARES 
	USES 
}
Module sysviewer.o {
...
ObjectFile libtcfsvservice.a::buf_stat.o {
	...
	IMPORTS write_stream tcf_json_write_string tcf_json_write_uint64 tcf_json_write_int64 tcf_json_read_uint64 tcf_json_test_char is_valid_wv_log write_stringz tcf_write_errno
	DECLARES 
	USES 
}
Module buf_stat.o {
...
ObjectFile libtcfsvservice.a::sv_symbol.o {
	...
	IMPORTS _func_symFind sysSymTbl
	DECLARES 
	USES 
}
Module sv_symbol.o {
...
ObjectFile libtcfsvservice.a::wol_events.o {
	...
	IMPORTS _wvObjStacktrace wvObjInst write_stream tcf_json_write_string tcf_json_write_boolean strcmp tcf_json_read_boolean tcf_json_read_struct loc_alloc
	DECLARES 
	USES 
}
Module wol_events.o {
...
ObjectFile libtcfsvservice.a::stack_trace.o {
	...
	IMPORTS loc_alloc loc_free tcf_json_read_uint64 strcmp tcf_json_read_string tcf_json_read_int64 tcf_json_read_boolean tcf_json_read_array _wvCallStackDepthSet _wvCallStackSetLevel _wvCallStackSetEvent _wvTaskCallStackClear _wvCallStackFilterSet _wvTaskCallStackSet wvEvtClassGet tcf_json_read_struct tcf_json_test_char write_stream tcf_json_write_string tcf_json_write_int64 tcf_json_write_boolean tcf_json_write_uint64
	DECLARES 
	USES 
}
