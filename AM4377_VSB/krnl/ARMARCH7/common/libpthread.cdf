...
ObjectFile libpthread.a::_pthreadLib.o {
	...
	EXPORTS _pthreadLibInit _pthreadCreate _pthreadSemOwnerGet _pthreadSemStateGet
	IMPORTS taskDeleteHookAdd _func_logMsg pthread_testandset_canceltype _func_pthread_testandset_canceltype roundRobinOn calloc semBCreate semMCreate semDelete free strcpy strlen __urem32 __udiv32 strncpy taskIdSelf taskPriorityGet sigprocmask taskOpen taskActivate taskDelete semClassId objVerify intLock intUnlock
	DECLARES 
	USES 
}
...
ObjectFile libpthread.a::schedPxLib.o {
	...
	IMPORTS taskPrioritySet __errno taskPriorityGet roundRobinOn taskIdVerify taskDelay sysClkRateGet roundRobinSlice __udiv32
	DECLARES 
	USES 
}
Module schedPxLib.o {
...
ObjectFile libpthread.a::_schedPxLib.o {
	...
	IMPORTS roundRobinSlice roundRobinOn
	DECLARES 
	USES 
}
...
ObjectFile libpthread.a::schedPxScLib.o {
	...
	IMPORTS scMemValidate __errno _schedPxKernelIsTimeSlicing taskIdCurrent taskClassId objHandleAndClassToObjId objVerify kernelId errnoSet objCoreRelease _func_taskPxAttrCreate _func_taskPxAttrSet _func_taskPxAttrGet
	DECLARES 
	USES 
}
