...
--------------------
08feb17,g_x  use VXB_HANDLE_IO type for IO/MEM register access (V7PRO-3522)
13aug16,y_y  add VXB_ARCH_IO_UNMAP(), VXB_ARCH_MEM_UNMAP(). (V7PRO-3220)
...
#define VXB_ARCH_IO_HANDLE VXB_HANDLE_IO

#define VXB_ARCH_MEM_MAP(paddr, len) \
    ((VIRT_ADDR)pmapGlobalMap (paddr, len, VXB_REG_MAP_MMU_ATTR))
#define VXB_ARCH_MEM_HANDLE VXB_HANDLE_IO
