...
set(VXWORKS_VSB_DIR C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB CACHE PATH "The VxWorks VSB_DIR [Read-Only]")
...
set(CC_ARCH_SPEC "-tARMCORTEXA9MV:rtp7")
set(VSB_CONFIG_FILE C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/h/config/vsbConfig.h)
set(LIBPATH "")
set(LIBS "")
...
set(CMAKE_REQUIRED_FLAGS "${CC_ARCH_SPEC} -mrtp -LC:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/lib/common -D_VSB_CONFIG_FILE=\\\"C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/h/config/vsbConfig.h\\\"")
...
set(WIND_C_FLAGS_RELEASE " -XO")
set(WIND_C_FLAGS "${CC_ARCH_SPEC} -Y I,+C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/h/public/c++03:C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/h/public:${WIND_HOME}/compilers/diab-5.9.6.1/WIN32/bin/../../include/diab -Xansi -WDVSB_DIR=C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB  -W:c++:.CPP  -Xfp-fast  -XO -Xforce-declarations -ei5387,5388,5849,1824    -D_VX_CPU=_VX_ARMARCH7 -D_VX_TOOL_FAMILY=diab -D_VX_TOOL=diab -DARMEL -DARMEL     ")
...
set(WIND_CXX_FLAGS_RELEASE " -XO")
set(WIND_CXX_FLAGS "${CC_ARCH_SPEC} -Y I,+C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/h/public/c++03:C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/h/public:${WIND_HOME}/compilers/diab-5.9.6.1/WIN32/bin/../../include/diab -Xansi -WDVSB_DIR=C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB  -W:c++:.CPP  -Xfp-fast  -XO -Xforce-declarations -ei5387,5388,5849,1824    -D_VX_CPU=_VX_ARMARCH7 -D_VX_TOOL_FAMILY=diab -D_VX_TOOL=diab -DARMEL -DARMEL     ")
...
set(CMAKE_CXX_COMPILER ${WIND_HOME}/compilers/diab-5.9.6.1/WIN32/bin/dplus${CMAKE_HOST_EXECUTABLE_EXTENSION})
# GNU and Intel are auto-discovered, but Diab needs manual specification
if("${TOOL}" STREQUAL "diab")
...
set(CMAKE_ASM_FLAGS_RELEASE_INIT " -XO")
...
set(CMAKE_ASM_FLAGS_INIT "${CC_ARCH_SPEC} -Y I,+C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/h/public/c++03:C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/h/public:${WIND_HOME}/compilers/diab-5.9.6.1/WIN32/bin/../../include/diab -Xansi -WDVSB_DIR=C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB  -W:c++:.CPP  -Xfp-fast  -XO    -D_VX_CPU=_VX_ARMARCH7 -D_VX_TOOL_FAMILY=diab -D_VX_TOOL=diab -DARMEL -DARMEL  -Xpreprocess-assembly -Xcpp-no-space   -c   -DARMEL -Wa,-Xalign-power2")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT "${CC_ARCH_SPEC} -Y I,+C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/h/public/c++03:C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/h/public:${WIND_HOME}/compilers/diab-5.9.6.1/WIN32/bin/../../include/diab -Xansi -WDVSB_DIR=C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB  -W:c++:.CPP  -Xfp-fast  -XO -Xforce-declarations -ei5387,5388,5849,1824    -D_VX_CPU=_VX_ARMARCH7 -D_VX_TOOL_FAMILY=diab -D_VX_TOOL=diab -DARMEL -DARMEL      -Wl,-Bt=0x80000000   ")
# Need to define this here due to -Wl,--start-group. Removed CMAKE_C_LINK_FLAGS to avoid duplication
set(CMAKE_C_LINK_EXECUTABLE
    "${CMAKE_CXX_COMPILER} <FLAGS> <LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES> -L${VSB_DIR}/usr/lib/common  ${LIBS} ${ADDED_LIBS} ")
...
foreach(lang C CXX ASM)
    ...
    set(CMAKE_SHARED_LIBRARY_CREATE_${lang}_FLAGS "-Xpic -Xshared -Xdynamic")
