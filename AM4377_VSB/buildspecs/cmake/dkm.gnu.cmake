...
set(WIND_C_FLAGS_RELEASE "-O2")
set(WIND_C_FLAGS "-t7 -mfpu=vfp -mfloat-abi=softfp -ansi  -fno-zero-initialized-in-bss  -O2 -fno-builtin -Wall      -DCPU=_VX_ARMARCH7 -DTOOL_FAMILY=gnu -DTOOL=gnu -D_WRS_KERNEL -DARMEL -DINET -DARM_USE_VFP  -D_WRS_LIB_BUILD       ")
...
set(WIND_CXX_FLAGS_RELEASE "-O2")
set(WIND_CXX_FLAGS "-t7 -mfpu=vfp -mfloat-abi=softfp -ansi  -fno-zero-initialized-in-bss  -O2 -fno-builtin -Wall      -DCPU=_VX_ARMARCH7 -DTOOL_FAMILY=gnu -DTOOL=gnu -D_WRS_KERNEL -DARMEL -DINET -DARM_USE_VFP  -D_WRS_LIB_BUILD     ")
...
set(CMAKE_CXX_COMPILER ${WIND_HOME}/compilers/gnu-4.8.1.9/x86-win32/bin/ccarm${CMAKE_HOST_EXECUTABLE_EXTENSION})
...
set(CMAKE_ASM_FLAGS_INIT "-t7 -mfpu=vfp -mfloat-abi=softfp -ansi  -fno-zero-initialized-in-bss  -O2 -fno-builtin     -DCPU=_VX_ARMARCH7 -DTOOL_FAMILY=gnu -DTOOL=gnu -D_WRS_KERNEL -DARMEL -DINET -DARM_USE_VFP  -D_WRS_LIB_BUILD  -xassembler-with-cpp     ")
...
set(PARTIAL_LINK_FLAGS_DKM "-t7 -mfpu=vfp -mfloat-abi=softfp ")
set(PARTIAL_LINK_TOOL "${WIND_HOME}/compilers/gnu-4.8.1.9/x86-win32/bin/ccarm -r -nostdlib -Wl,-X -Wl,-EL")
...
set(LINK_FLAGS_DKM_TOOL "-T ${WIND_BUILD_TOOL}/gnu_4_8_1_8/krnl/ldscripts/link.OUT")
...
if("${CMAKE_HOST_SYSTEM_NAME}" MATCHES "Windows" AND "${WIND_CMAKE_MAKE_PROGRAM}" MATCHES "ninja")
  ...
  set(CMAKE_C_LINK_EXECUTABLE
	"${PARTIAL_LINK_TOOL} ${PARTIAL_LINK_FLAGS_DKM} -o <TARGET>.partial.o <OBJECTS> && sh -c \" ${WIND_NM} ${WIND_NM_FLAGS} <TARGET>.partial.o | tclsh ${WIND_BASE}/host/resource/hutils/tcl/munch.tcl -c arm -tags C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/krnl/tags/dkm.tags > <TARGET>.ctdt.c \" && ${CMAKE_C_COMPILER} ${LINK_FLAGS_DKM_${VXWORKS_BUILD_TYPE}} ${CC_ARCH_SPEC} -fdollars-in-identifiers -Wall  ${ADDED_CFLAGS} ${ADDED_INCLUDES} ${DEFINES} -o <TARGET>.ctdt.o -c <TARGET>.ctdt.c && ${WIND_HOME}/compilers/gnu-4.8.1.9/x86-win32/bin/ccarm ${CC_ARCH_SPEC} ${LINK_FLAGS_DKM_TOOL} -o <TARGET> <TARGET>.partial.o <TARGET>.ctdt.o <LINK_LIBRARIES> ${LIBPATH} ${LIBS} ${ADDED_LIBPATH} ${ADDED_LIBS}")
else()
  set(CMAKE_C_LINK_EXECUTABLE
	"sh -c '${PARTIAL_LINK_TOOL} ${PARTIAL_LINK_FLAGS_DKM} -o <TARGET>.partial.o <OBJECTS> && ${WIND_NM} ${WIND_NM_FLAGS} <TARGET>.partial.o | tclsh ${WIND_BASE}/host/resource/hutils/tcl/munch.tcl -c arm -tags C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/krnl/tags/dkm.tags > <TARGET>.ctdt.c && ${CMAKE_C_COMPILER} ${LINK_FLAGS_DKM_${VXWORKS_BUILD_TYPE}} ${CC_ARCH_SPEC} -fdollars-in-identifiers -Wall  ${ADDED_CFLAGS} ${ADDED_INCLUDES} ${DEFINES} -o <TARGET>.ctdt.o -c <TARGET>.ctdt.c && ${WIND_HOME}/compilers/gnu-4.8.1.9/x86-win32/bin/ccarm ${CC_ARCH_SPEC} ${LINK_FLAGS_DKM_TOOL} -o <TARGET> <TARGET>.partial.o <TARGET>.ctdt.o <LINK_LIBRARIES> ${LIBPATH} ${LIBS} ${ADDED_LIBPATH} ${ADDED_LIBS}'")
endif()
...
set(CMAKE_FIND_ROOT_PATH C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/krnl)
...
if(NOT _IN_TC)
  ...
  if("${PROJECT_TYPE}" MATCHES "RTP")
    if(NOT IS_DIRECTORY C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/root/${TOOL_FAMILY}/bin)
      message(FATAL_ERROR "VSB seems not to be built for RTPs: missing C:/ScriptGSX2_4/GSX2_4Stream/AM4377_VSB/usr/root/${TOOL_FAMILY}/bin")
    endif()
