...
--------------------
01h,16mar16,kjn  Added support for using jobQueueLib in user-space.
01g,20jan14,rjq  move JOBQUEUE to OS service
01f,10nov10,dlk  Move extern "C" after last header file include. WIND00240828.
01e,11oct07,dlk  Added _func_netDaemonIxToQId and _func_netDaemonQIdToIx
                 declarations.
01d,22jun06,dlk  Add jobQueueUtilInit() prototype.
01c,25aug05,dlk  Add section tags.
01b,13jul05,dlk  Added member_to_object() and QJOB_IS_BUSY() definitions.
                 Added 'extern' on prototypes, and jobQueueTask() prototype.
01a,14may05,dlk  Written.
*/
