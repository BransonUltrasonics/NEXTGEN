/* vxbTiAm335xSpi.h - Freescale AM335x SPI hardware defintions */
...
#ifndef __INCvxbTiAm335xSpih
#define __INCvxbTiAm335xSpih
...
/* MCSPI_HL_SYSCONFIG */
#define MCSPI_NO_IDLE        (BIT(2))  

/* MCSPI_SYSCONFIG */

#define  SPI_RESET			(BIT(1))
#define  MCSPI_AUTOIDLE        (BIT(0))
...
#define MCSPI_MODULCTRL_ST		(BIT(3))
...
#define MCSPI_CH0CONF_DPE1	 	(BIT(17))
#define MCSPI_CH0CONF_IS	 	(BIT(18))
...
#define MCSPI_TRM_RXTX			(0 << MCSPI_CHOCONF_TRM_SHIFT)
#define MCSPI_TRM_RX			(1 << MCSPI_CHOCONF_TRM_SHIFT)
#define MCSPI_TRM_TX			(2 << MCSPI_CHOCONF_TRM_SHIFT)
...
#define SPI_MAX_CS_NUM             4   //port0, port1 and port2 have 4 slaves
#define SPI_MAX_CS_NUM_2           2   //Port3 and port4 only have 2 slaves
