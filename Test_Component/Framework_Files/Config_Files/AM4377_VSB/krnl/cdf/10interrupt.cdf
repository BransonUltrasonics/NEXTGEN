...
Folder FOLDER_SUB_INTERRUPT {
    NAME            Interrupt support subsystem
    SYNOPSIS        Includes the interrupt support subsystem.
    _CHILDREN       FOLDER_SUBSYSTEM
}      

Component INCLUDE_ISR_HANDLER_INIT {
    NAME            VxBus ISR handler module initialization
    SYNOPSIS        This component supports VxBus ISR handler module \
                    initialization.
...
Parameter VXB_MAX_INTR_VEC {
    NAME            Maximum number of interrupt vector table slots
...
Parameter VXB_MAX_INTR_CHAIN {
    NAME            Maximum number of interrupt chaining entries
    SYNOPSIS        This parameter specifies the maximum number of interrupt \
                    chaining entries.
    TYPE            UINT32
    DEFAULT         256
...
Parameter VXB_MAX_INTR_DEFER {
    NAME            Maximum number of interrupt operation deferral entries
    SYNOPSIS        This parameter specifies the maximum number of interrupt \
