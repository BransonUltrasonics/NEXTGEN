...
Folder FOLDER_BUSLIB_PCI {                    
    NAME            PCI bus support 
    SYNOPSIS        PCI bus support components
    _CHILDREN       FOLDER_BUSLIB
}  

Component INCLUDE_PCI_BUS {
    NAME            VxBus PCI subsystem library
    SYNOPSIS        The VxBus PCI subsystem library component provides \
                    platform-independent bus scan and helper routines used by \
                    PCI host controller drivers and individual function drivers.
    MODULES         vxbPci.o
...
Component INCLUDE_PCI_MSI {
    NAME            VxBus PCI MSI/MSI-X interrupt library
    SYNOPSIS        The VxBus PCI MSI/MSI-X library provides support routines \
...
Component INCLUDE_PCI_AUTOCONF {
    NAME            VxBus PCI auto-configuration library
    SYNOPSIS        The VxBus PCI auto-configuration library allows VxBus to \
...
Component INCLUDE_PCIE_AER {
    NAME            VxBus PCI Express advanced error reporting capability
