...
ObjectFile libstacktrace.a::context_memtest.o {
	...
	IMPORTS vxAtomicInc memory_map_init vxAtomicDec vmLibInfo memPoolEndAdrs intContext vxMemProbe taskTcb vxAtomicGet ST_debug_level logMsg taskClassId objVerify _func_rtpIdVerify vxIntStackEnd vxIntStackBase map_region_find sysMemDescGet kernelId
	DECLARES 
	USES 
}
...
ObjectFile libstacktrace.a::arm_os.o {
	NAME Object file arm_os.o from archive libstacktrace.a
	EXPORTS ArchContextCreate ST_TraceFunctionEntry RtiTools_ContextTopDiscover ST_CheckOSFrames ST_GetIntContextTop
	IMPORTS taskTcb vxTaskEntry intEnt intExit vxIntStackBase
	DECLARES 
	USES 
}
Module arm_os.o {
	OBJECT += libstacktrace.a::arm_os.o
}
ObjectFile libstacktrace.a::arm_crawl.o {
	NAME Object file arm_crawl.o from archive libstacktrace.a
	EXPORTS ST_FrameCrawl
	IMPORTS __div32 stCtxMemValidate ST_debug_level logMsg
	DECLARES 
	USES 
}
Module arm_crawl.o {
	OBJECT += libstacktrace.a::arm_crawl.o
}
ObjectFile libstacktrace.a::memory_map_vx.o {
	...
	IMPORTS spinLockIsrTake spinLockIsrGive free printf malloc kernelIdGet logMsg
	DECLARES 
	USES 
}
...
ObjectFile libstacktrace.a::memory_map_shd_vx.o {
	...
	IMPORTS sdCreateHookAdd _func_ST_sdCreateHookAdd sdCreateHookDelete _func_ST_sdCreateHookDelete sdDeleteHookAdd _func_ST_sdDeleteHookAdd sdDeleteHookDelete _func_ST_sdDeleteHookDelete
	DECLARES 
	USES 
}
...
Library libstacktrace.a {
	MODULES libstacktrace.a::context_memtest.o libstacktrace.a::context.o libstacktrace.a::context_region.o libstacktrace.a::arm_os.o libstacktrace.a::arm_crawl.o libstacktrace.a::memory_map_vx.o libstacktrace.a::memory_map_module_vx.o libstacktrace.a::memory_map_shd_vx.o
}
