...
ObjectFile libcoreutil.a::hookLib.o {
	...
	IMPORTS taskIdCurrent taskLock taskUnlock errnoSet
	DECLARES 
	USES 
}
Module hookLib.o {
...
ObjectFile libcoreutil.a::hookTblLib.o {
	...
	IMPORTS qFifoClassId qFifoInit semMInitialize intCnt __errno taskIdCurrent semMTake semMGive errnoSet vxAtomicCas kernelState windPendQPut windExit windPendQFlush workQAdd1 vxAtomicOr vxAtomic32Inc vxAtomicAnd vxAtomic32Dec
	DECLARES 
	USES 
}
Module hookTblLib.o {
