...
ObjectFile libruntime_analysis_topdemo.a::cafe_top_demo.o {
	...
	IMPORTS open lseek write sysClkRateGet __div32 taskDelay read vxAtomicGet close remove printf vxAtomicSet taskCpuAffinitySet tickGet tree_a vxCpuConfiguredGet snprintf taskCreate taskActivate taskSpawn malloc tick64Get free taskSuspend memset memPartCreate memPartOptionsGet memPartOptionsSet memPartAlloc memPartInfoGet memPartFree memPartDelete memSysPartId __udiv32 wdInitialize wdStart taskClassId objVerify rand __rem32 taskPrioritySet intCpuLock intCpuUnlock taskIdSelf vxCpuEnabledGet
...
ObjectFile libruntime_analysis_topdemo.a::topDemoLib.o {
	...
	IMPORTS cafe_demo_load_test_start cafe_demo_load_test_stop cafe_demo_cache_bad cafe_demo_cache_good cafe_demo_multi_stop cafe_demo_multi_start cafe_demo_intlock_start cafe_demo_intlock_stop cafe_demo_idletask_start cafe_demo_idletask_stop cafe_demo_task_mover_start cafe_demo_task_mover_stop
	DECLARES 
	USES 
}
Module topDemoLib.o {
