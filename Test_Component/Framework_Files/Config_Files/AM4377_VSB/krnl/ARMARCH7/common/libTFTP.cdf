...
ObjectFile libTFTP.a::iptftpc.o {
	...
	IMPORTS ipcom_fopen ipcom_syslog ipcom_socket_usr iptftp_bind_zero iptftp_send_loop iptftp_send_err ipcom_fclose ipcom_socketclose_usr iptftp_receive_loop malloc memset ipcom_sysvar_get_as_int ipcom_getaddrinfo memcpy strlen strcpy iptftp_strip_path ipcom_times __udiv32 __urem32 printf ipcom_freeaddrinfo free
	DECLARES 
	USES 
}
Module iptftpc.o {
...
ObjectFile libTFTP.a::iptftpc_cmd_tftp.o {
	...
	IMPORTS ipcom_getopt_clear_r ipcom_getopt_r printf atoi strcmp iptftp_client_get iptftp_client_put
	DECLARES 
	USES 
}
...
ObjectFile libTFTP.a::iptftp_common.o {
	...
	IMPORTS __rem32 strlen strcpy ipcom_fread ipcom_feof ipcom_fwrite strrchr memset memcpy ipcom_if_indextoname ipcom_getifaddrs strcmp ipcom_sendmsg_usr ipcom_sendto_usr ipcom_errno_get ipcom_syslog malloc free ipcom_recvmsg_usr __div32 ipcom_sysvar_get_as_int time ipcom_socketselect_usr printf ipcom_setsockopt_usr ipcom_bind_usr
	DECLARES 
	USES 
}
