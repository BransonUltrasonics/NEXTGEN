...
ObjectFile libbdmTffsDrv.a::amdmtd.o {
	...
	IMPORTS flAddLongToFarPointer flMap flMsecCounter flWriteProtected memcmp __urem32 flSetWindowBusWidth flSetWindowSpeed flSetWindowSize flSocketNoOf flIntelIdentify flIntelSize
	DECLARES 
	USES 
}
Module amdmtd.o {
...
ObjectFile libbdmTffsDrv.a::i28f008.o {
	...
	IMPORTS flMsecCounter flWriteProtected flNeedVpp flDelayLoop flDontNeedVpp memcmp flSetWindowBusWidth flSetWindowSpeed flSetWindowSize flIntelIdentify flFitInSocketWindow flIntelSize
	DECLARES 
	USES 
}
Module i28f008.o {
...
ObjectFile libbdmTffsDrv.a::i28f016.o {
	...
	IMPORTS flMap flMsecCounter flWriteProtected flNeedVpp __udiv32 bcopyWords flDontNeedVpp tffscmpWords flSetWindowBusWidth flSetWindowSpeed flSetWindowSize flIntelIdentify flIntelSize
	DECLARES 
	USES 
}
Module i28f016.o {
...
ObjectFile libbdmTffsDrv.a::cfiamd.o {
	...
	IMPORTS flMap __udiv32 flMsecCounter flWriteProtected memcmp flSetWindowBusWidth flSetWindowSpeed flSetWindowSize flSocketNoOf
	DECLARES 
	USES 
}
Module cfiamd.o {
...
ObjectFile libbdmTffsDrv.a::cfiscs.o {
	...
	IMPORTS flMap __udiv32 flMsecCounter flWriteProtected flNeedVpp memcpy flDontNeedVpp memcmp bcopyWords bcopyLongs tffscmpWords flSetWindowBusWidth flSetWindowSpeed flSetWindowSize flSocketNoOf
	DECLARES 
	USES 
}
Module cfiscs.o {
...
ObjectFile libbdmTffsDrv.a::amd29LvMtd.o {
	...
	IMPORTS printf cacheLib sysClkRateGet flMsecCounter taskDelay flWriteProtected malloc memcpy free
	DECLARES 
	USES 
}
Module amd29LvMtd.o {
...
ObjectFile libbdmTffsDrv.a::vxbFlashStub.o {
	...
	IMPORTS noOfDrives vxbFlashChipFind __udiv32 malloc free flSocketOf tickGet sysClkRateGet printf tffsRawio strncmp __ctype bzero strlen strncpy strchr vxbFlashPrivGet flSetWindowSize tffsDevFormat flMap flSocketNoOf mountFTL formatFTL
	DECLARES 
	USES 
}
