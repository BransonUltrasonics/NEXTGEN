...
ObjectFile libBRIDGE.a::bridge.o {
	...
	IMPORTS calloc lstInit semMCreate free semDelete taskSpawn semTake semGive muxUnbind taskDelay lstDelete netMblkClChainFree lstFirst muxIoctl lstNext taskDelete strcmp endFindByName muxDevUnload ipDetach ip6Detach malloc muxTkBind bzero bcopy muxTkDrvCheck lstAdd tickGet muxSend muxTkSend printf endFlagsGet mirrorSendStatus taskIdSelf taskName strncmp netJobQueueId jobQueueStdPost _pNetDpool netTupleGet netMblkChainDup muxTxRestart sysClkRateGet BridgeAgingTime mirrorEndRunningState strcpy strncpy
...
ObjectFile libBRIDGE.a::mirrorEnd.o {
	...
	IMPORTS bcopy bzero mirrorEnetAddrGet endObjInit mib2Init bridgeNextPhyDevEndGet printf endFindByName endObjFlagSet endFlagsGet bridgePortList lstFirst strcmp muxIoctl endFlagsSet netJobQueueId muxLinkUpNotify jobQueueStdPost lstNext endFlagsClr muxLinkDownNotify endObjectUnload bcmp netMblkClChainFree endRcvRtnCall mib2ErrorAdd etherMultiAdd etherMultiDel etherMultiGet endEtherAddressForm endEtherPacketDataGet endEtherPacketAddrGet
	DECLARES 
	USES 
}
Module mirrorEnd.o {
