...
ObjectFile libSNTP.a::ipsntp.o {
	...
	EXPORTS ipsntp_client_fraction_to_nsec ipsntp_server_nsec_to_fraction ipsntp_check_leap_second ipsntp_add_leapsecond ipsntp_register_server_time_hook ipsntp_set_reference ipsntp_set_precision ipsntp_wait_time ipsntp_query_time ipsntp_create ipsntp_start ipsntp_version
	IMPORTS __div32 ipcom_tmo_cancel ipcom_tmo_request ipsntp_clock_gettime ipsntp_clock_settime __udiv32 memset ipcom_sendto_usr memcpy ipcom_setsockopt_usr ipcom_syslog ipcom_if_indextoname strncpy ipcom_socketioctl_usr ipcom_errno_get printf ipcom_sendmsg_usr memcmp ip_in6addr_any malloc free ipcom_recvmsg_usr ipcom_socket_usr ipcom_socketclose_usr strcmp ipcom_if_nametoindex ipcom_sysvar_get strlen ipcom_inet_pton ipcom_bind_usr strchr isdigit atoi ipcom_sysvar_get_as_int ipsntp_leapsecond_timer_settime __urem32 ipcom_fopen fgets strncmp strrchr strtok_r strtoul ipcom_fclose ipcom_ipd_init ipsntp_leapsecond_timer_init __rem32 ipcom_socketselect_usr ipcom_ipd_input ipsntp_leapsecond_timer_destroy ipcom_ipd_exit ipcom_proc_init ipcom_proc_exit ipcom_getaddrinfo ipcom_freeaddrinfo ipcom_proc_attr_init ipcom_priority_map ipcom_proc_acreate_v1
	DECLARES ipsntp
	USES 
}
Module ipsntp.o {
...
ObjectFile libSNTP.a::ipsntp_cmd_sntp.o {
	...
	IMPORTS printf ipcom_getopt_clear ipcom_getopt_data ipcom_getopt ipsntp_version strlen strcpy atoi ipsntp_wait_time ipsntp_query_time ctime ipsntp_clock_settime
	DECLARES 
	USES 
}
...
ObjectFile libSNTP.a::ipsntp_time.o {
	...
	IMPORTS clock_gettime clock_settime timer_create ipsntp_check_leap_second timer_connect timer_delete ipsntp_add_leapsecond timer_settime
	DECLARES 
	USES 
}
