...
ObjectFile librpc.a::auth_none.o {
	...
	IMPORTS taskIdCurrent _null_auth xdrmem_create xdr_opaque_auth
	DECLARES 
	USES 
}
Module auth_none.o {
...
ObjectFile librpc.a::clnt_generic.o {
	...
	IMPORTS hostGetByName inet_addr bzero strcmp clntudp_create clnttcp_create taskIdCurrent
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::clnt_perror.o {
	...
	IMPORTS taskIdCurrent memSysPartId memPartAlloc sprintf strlen strcpy printErr strcat
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::clnt_raw.o {
	...
	IMPORTS taskIdCurrent memSysPartId memPartAlloc printErr bzero memPartFree xdrmem_create xdr_callhdr perror authnone_create svc_getreq _null_auth xdr_replymsg _seterr_reply xdr_opaque_auth
	DECLARES 
	USES 
}
Module clnt_raw.o {
...
ObjectFile librpc.a::clnt_simple.o {
	...
	IMPORTS taskIdCurrent strcmp close hostGetByName clntudp_create strncpy
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::clnt_udp.o {
	...
	IMPORTS taskIdSelf memSysPartId memPartAlloc printErr pmap_getport tickGet xdrmem_create xdr_callhdr socket taskIdCurrent rpcErrnoGet setsockopt close bindresvport ioctl authnone_create memPartFree sysClkRateGet sendto taskDelay _null_auth bzero select recvfrom __udiv32 xdr_replymsg _seterr_reply xdr_opaque_auth
	DECLARES 
	USES 
}
Module clnt_udp.o {
...
ObjectFile librpc.a::pmap_getport.o {
	...
	IMPORTS clntudp_bufcreate xdr_u_short xdr_pmap taskIdCurrent
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::svc.o {
	...
	IMPORTS taskIdCurrent memSysPartId memPartAlloc pmap_set memPartFree pmap_unset pmapUnset panic bzero _authenticate select rpcErrnoGet perror
	DECLARES 
	USES 
}
Module svc.o {
...
ObjectFile librpc.a::svc_raw.o {
	...
	IMPORTS taskIdCurrent memSysPartId memPartAlloc printErr bzero memPartFree xdrmem_create xdr_callmsg xdr_replymsg
	DECLARES 
	USES 
}
Module svc_raw.o {
...
ObjectFile librpc.a::svc_simple.o {
	...
	IMPORTS taskIdCurrent printErr svcudp_create pmap_unset svc_register memSysPartId memPartAlloc panic xdr_void svc_sendreply memPartFree taskSuspend bzero svcerr_decode
	DECLARES 
	USES 
}
Module svc_simple.o {
...
ObjectFile librpc.a::svc_tcp.o {
	...
	IMPORTS socket perror bzero bindresvport bind getsockname listen close memSysPartId memPartAlloc memPartFree printErr _null_auth xprt_register xdrrec_create accept rpcErrnoGet xprt_unregister taskIdCurrent memcpy select errnoGet read write xdrrec_eof xdrrec_skiprecord xdr_callmsg xdr_replymsg xdrrec_endofrecord abort
	DECLARES 
	USES 
}
Module svc_tcp.o {
...
ObjectFile librpc.a::rpcLib.o {
	...
	IMPORTS portmapd taskSpawn clnt_genericInclude clnt_rawInclude clnt_simpleInclude pmap_getmapsInclude svc_rawInclude svc_simpleInclude xdr_floatInclude taskDeleteHookAdd taskIdCurrent memSysPartId memPartAlloc bzero close svc_unregisterall memPartFree errnoSet errnoGet
	DECLARES portmapdId
	USES 
}
Module rpcLib.o {
