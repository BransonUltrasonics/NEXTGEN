...
ObjectFile libc_wr.a::longjmp.o {
	...
	IMPORTS taskIdCurrent kernelId _func_rtpSigprocmask taskSuspend __rta_longjmp _func_sigprocmask _sigCtxRtnValSet _sigCtxLoad
	DECLARES 
	USES 
}
Module longjmp.o {
...
ObjectFile libc_wr.a::fdopen.o {
	...
	EXPORTS fdopen
	IMPORTS iosFdMap __sflags stdioFpCreate
	DECLARES 
	USES 
}
Module fdopen.o {
...
ObjectFile libc_wr.a::fgets.o {
	...
	EXPORTS fgets
	IMPORTS __srefill memchr bcopy
	DECLARES 
	USES 
}
Module fgets.o {
...
ObjectFile libc_wr.a::fopen.o {
	...
	EXPORTS fopen
	IMPORTS __sflags stdioFpCreate open stdioFpDestroy __sseek
	DECLARES 
	USES 
}
Module fopen.o {
...
ObjectFile libc_wr.a::fread.o {
	...
	EXPORTS fread
	IMPORTS bcopy __srefill __udiv32
	DECLARES 
	USES 
}
Module fread.o {
...
ObjectFile libc_wr.a::fvwrite.o {
	...
	EXPORTS __sfvwrite
	IMPORTS __swsetup __swrite bcopy fflush __udiv32 memchr
	DECLARES 
	USES 
}
Module fvwrite.o {
...
ObjectFile libc_wr.a::perror.o {
	...
	EXPORTS perror
	IMPORTS __stderr fprintf __errno strerror
	DECLARES 
	USES 
}
Module perror.o {
...
ObjectFile libc_wr.a::puts.o {
	...
	EXPORTS puts
	IMPORTS strlen __stdout __sfvwrite
	DECLARES 
	USES 
}
Module puts.o {
...
ObjectFile libc_wr.a::stdio.o {
	...
	IMPORTS read lseek write close
	DECLARES 
	USES 
}
Module stdio.o {
...
ObjectFile libc_wr.a::vfprintf.o {
	...
	EXPORTS vfprintf
	IMPORTS __swsetup handleInit fioFormatV fflush handleTerminate __swbuf
	DECLARES 
	USES 
}
Module vfprintf.o {
...
ObjectFile libc_wr.a::scanf.o {
	...
	EXPORTS scanf
	IMPORTS __stdin fgetc fioScanV ungetc
	DECLARES 
	USES 
}
Module scanf.o {
...
ObjectFile libc_wr.a::fclose.o {
	...
	EXPORTS fclose
	IMPORTS __errno __sflush __sclose free stdioFpDestroy
	DECLARES 
	USES 
}
Module fclose.o {
...
ObjectFile libc_wr.a::freopen.o {
	...
	EXPORTS freopen
	IMPORTS __sflags fclose __sflush __sclose open __errno free stdioFpDestroy
	DECLARES 
	USES 
}
Module freopen.o {
...
ObjectFile libc_wr.a::fseek.o {
	...
	EXPORTS fseek
	IMPORTS __sseek __errno __smakebuf ioctl free __srefill __sflush
	DECLARES 
	USES 
}
Module fseek.o {
...
ObjectFile libc_wr.a::refill.o {
	...
	EXPORTS __srefill
	IMPORTS __sflush __errno free __smakebuf __sread
	DECLARES 
	USES 
}
Module refill.o {
...
ObjectFile libc_wr.a::stdioLib.o {
	...
	IMPORTS fclose _func_fclose malloc taskIdCurrent handleInit handleTerminate free _func_taskDeleteHookAdd taskCreateHookInit taskDeleteHookAdd
	DECLARES 
	USES 
}
Module stdioLib.o {
...
ObjectFile libc_wr.a::stdioShow.o {
	...
	IMPORTS handleShowConnect printf
	DECLARES 
	USES 
}
Module stdioShow.o {
...
ObjectFile libc_wr.a::ungetc.o {
	...
	EXPORTS ungetc
	IMPORTS malloc realloc bcopy __sflush
	DECLARES 
	USES 
}
Module ungetc.o {
...
ObjectFile libc_wr.a::strtol.o {
	...
	EXPORTS strtol
	IMPORTS __errno __ctype __udiv32
	DECLARES 
	USES 
}
Module strtol.o {
...
ObjectFile libc_wr.a::strtoul.o {
	...
	EXPORTS strtoul
	IMPORTS __ctype __udiv32 __errno
	DECLARES 
	USES 
}
Module strtoul.o {
...
ObjectFile libc_wr.a::strtoll.o {
	...
	EXPORTS strtoll
	IMPORTS __ctype __urem64 __udiv64 __mul64 errnoSet
	DECLARES 
	USES 
}
Module strtoll.o {
...
ObjectFile libc_wr.a::strtoull.o {
	...
	EXPORTS strtoull
	IMPORTS __ctype __udiv64 __urem64 __mul64 errnoSet
	DECLARES 
	USES 
}
Module strtoull.o {
...
ObjectFile libc_wr.a::strerror.o {
	...
	IMPORTS _func_symFindSymbol statSymTbl _func_symNameGet _func_symValueGet strlcpy snprintf
	DECLARES 
	USES 
}
Module strerror.o {
...
ObjectFile libc_wr.a::ctime.o {
	...
	IMPORTS localtime asctime_r _vxworks_asctime_r
	DECLARES 
	USES 
}
Module ctime.o {
...
ObjectFile libc_wr.a::gmtime.o {
	...
	IMPORTS __div32 __rem32 __udiv32 __urem32 ldiv_r
	DECLARES 
	USES 
}
Module gmtime.o {
...
ObjectFile libc_wr.a::localtime.o {
	...
	IMPORTS __loctime __getZoneInfo atoi __getTime __getDstInfoSub
	DECLARES 
	USES 
}
Module localtime.o {
...
ObjectFile libc_wr.a::mktime.o {
	...
	EXPORTS mktime
	IMPORTS __div32 __julday __rem32 __daysSinceEpoch __loctime __getDstInfoSub __getZoneInfo atoi
	DECLARES 
	USES 
}
Module mktime.o {
...
ObjectFile libc_wr.a::strftime.o {
	...
	IMPORTS __rem32 __div32 getenv_s strpbrk strncpy strcmp strlen memcpy abs __loctime strtok_r bzero atoi
	DECLARES 
	USES 
}
Module strftime.o {
