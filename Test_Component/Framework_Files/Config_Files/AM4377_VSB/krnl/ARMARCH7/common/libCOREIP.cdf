...
ObjectFile libCOREIP.a::vxmux_cmd_vxslab.o {
	...
	IMPORTS printf getoptInit getopt_r vxmux_slab_memory_pool_list vxmux_memory_pool_garbage_collect vxAtomicGet vxmux_slab_get_size shellCmdTopicAdd shellCmdAdd
	DECLARES 
	USES 
}
...
ObjectFile libCOREIP.a::vxmux_mux_mblk.o {
	...
	IMPORTS ipcom_pkt_free ipcom_pkt_stack_malloc vxAtomicInc netMblkClChainFree ipcom_pkt_stack_free vxmux_null_pool ipcom_pkt_malloc ipnet_vlan_set_tag ipcom_pkt_get_info_safe netMblkClFree
...
ObjectFile libCOREIP.a::vxmux_null_buf.o {
	...
	IMPORTS errnoSet bzero malloc memalign memset strcpy netPoolCreate ipcom_port free ipcom_null_pool_create
...
ObjectFile libCOREIP.a::vxmux_slab.o {
	...
	IMPORTS free vxAtomicAdd vxAtomicSub malloc logMsg taskSuspend vxAtomicGet vxAtomicCas bzero __udiv32 strlen calloc strcpy vxAtomicSet memset
