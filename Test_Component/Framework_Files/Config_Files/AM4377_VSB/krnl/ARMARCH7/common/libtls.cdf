...
ObjectFile libtls.a::tlsLib.o {
	...
	IMPORTS __udiv32 memset __tlsTaskCreateHook taskCreateHookAdd __tlsTaskDeleteHook taskDeleteHookAdd _func_logMsg __tlsLockIsInitialized __tlsLockSem semMInit semTake realloc malloc semGive free taskIdSelf tlsTaskModuleAdd
	DECLARES 
	USES 
}
Module tlsLib.o {
...
ObjectFile libtls.a::tlsLookupLib.o {
	...
	IMPORTS free semTake semGive __tlsMaxModule realloc memset semMInit __ppTlsModule memalign memcpy taskIdSelf _sigCtxSave edrErrorInjectStub taskIdCurrent edrKernelFatalPolicyHandler taskStackAllot __pStaticModTlsDesc
