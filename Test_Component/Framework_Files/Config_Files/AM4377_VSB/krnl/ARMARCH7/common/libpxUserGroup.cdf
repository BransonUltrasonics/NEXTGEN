...
ObjectFile libpxUserGroup.a::pxUserGroupLib.o {
	...
	IMPORTS taskIdCurrent kernelId semTake semGive __errno
	DECLARES 
	USES 
}
...
ObjectFile libpxUserGroup.a::getlogin.o {
	...
	IMPORTS taskIdCurrent taskCredentialsGet taskCredentialsSet
	DECLARES 
	USES 
}
Module getlogin.o {
...
ObjectFile libpxUserGroup.a::pxUserGroupScLib.o {
	...
	IMPORTS taskIdCurrent semTake semGive __errno scMemValidate getlogin_r
	DECLARES 
	USES 
}
