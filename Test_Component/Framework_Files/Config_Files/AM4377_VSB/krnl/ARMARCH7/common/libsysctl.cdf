...
ObjectFile libsysctl.a::kern_mib.o {
	...
	IMPORTS sysctl__children sysctl_add_oid_internal kernSysctlInit
...
ObjectFile libsysctl.a::kern_sysctl.o {
	...
	IMPORTS strcmp printf errnoSet memSysPartId memPartAlloc bzero strlen bcopy memPartFree vxAtomic32Inc semMInit __errno snprintf edrErrorInjectStub taskIdCurrent edrKernelFatalPolicyHandler sysctl_node pSysctlCtxList kern_node semTake semGive vxAtomic32Dec malloc free strlcpy
	DECLARES sysctl__children
	USES 
}
...
ObjectFile libsysctl.a::sysctl.o {
	...
	IMPORTS __stderr fprintf strlen sysctl memcpy printf errnoGet bcopy strcpy memSysPartId memPartAlloc __stdout fwrite memPartFree _netSysctlCli __swbuf snprintf strchr __ctype strtol strtoul sscanf logMsg setbuf getoptInit getopt_r strncmp strcat bzero getOptServ
	DECLARES 
	USES 
}
Module sysctl.o {
...
ObjectFile libsysctl.a::sysctlScLib.o {
	...
	IMPORTS scMemValidate errnoSet sysctl
	DECLARES 
	USES 
}
...
ObjectFile libsysctl.a::rtpSysctl.o {
	...
	IMPORTS tickGet sysctl_handle_int sysClkRateGet sysProcNumGet tick64Get syscallGroupTbl syscallGroupName strlen sysctl_handle_string vxCpuConfiguredGet vxCpuEnabledGet semRWLibMaxReaders errnoGet kern_node pSysctlCtxList sysctl_add_oid_internal vxWorksVersionMinor vxWorksVersionMaint vxWorksVersionMajor snprintf strncpy kernelVersion creationDate sysModel bsp_node sysBspRev
