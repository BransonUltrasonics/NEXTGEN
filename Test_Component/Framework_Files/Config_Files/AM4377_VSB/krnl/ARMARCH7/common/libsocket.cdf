...
ObjectFile libsocket.a::sockLib.o {
	...
	IMPORTS iosDrvInstall errnoSet iosFdNew iosFdDrvValue
...
ObjectFile libsocket.a::sockScLib.o {
	...
	IMPORTS pSockIoctlMemVal pUnixIoctlMemVal socketDevHdr iosDrvIoctlMemValSet sockLibMap iosFdNew errnoSet scMemValidate iosFdDrvValue taskIdCurrent kernelId
	DECLARES 
	USES 
}
Module sockScLib.o {
