...
ObjectFile libpxmem.a::devMemFsLib.o {
	...
	IMPORTS __errno pathconf errnoSet strlen malloc iosDrvInstall iosDevAdd semMInit tick64Get sysClkRateGet __udiv64 strncpy sysctl_handle_string vm_node pSysctlCtxList sysctl_add_oid_internal iosDrvRemove free strncmp strcpy strcat strcmp semMTake taskIdCurrent kernelId semMGive strlcpy mmanMODelete bzero
	DECLARES 
	USES 
}
...
ObjectFile libpxmem.a::devMemLib.o {
	...
	IMPORTS devMemFsLibInit vmPageSizeGet __urem32 __errno devMemFullNameGet open ioctl close unlink
	DECLARES 
	USES 
}
Module devMemLib.o {
...
ObjectFile libpxmem.a::mmanFdLib.o {
	...
	IMPORTS _func_fdMap _func_fdUnmap _func_fdMsync fsmUnmountHookAdd _func_ftruncMmanHook _func_signalMmanHook vmPageSizeGet poolCreate mmanFileMutex semMInit ioctl read bfill taskIdCurrent kernelId __udiv32 pgMgrPageAllocAt adrSpacePageAlloc __errno vmTranslate cacheLib mmanRangeInsert pgMgrPageFree adrSpacePageFree vmStateSet mmBlkPool poolItemReturn vmPgUnMap mprotect mmRngPool poolItemGet vmMap mmanBlockSplit fcntl vmPgMap bcopy vmPageUnmap mmanRtpLock semTake semGive mmanPrivateMap globalRtpMemFill mmanProtectionSet write iosRtpFdUnmap2 globalRAMPgPoolId pgPoolPhysFree
...
ObjectFile libpxmem.a::mmanLib.o {
	...
	IMPORTS poolCreate vmPageSizeGet kernelId poolItemReturn vmStateSet __udiv32 pgMgrPageFree poolItemGet taskIdCurrent _func_rtpVerifiedLock semTake __errno semGive vmIsSRWXURWXSupported pgMgrPageAllocAt errnoSet globalRtpMemFill bfill taskPriorityGet taskSpawn vmTranslate
...
ObjectFile libpxmem.a::mmanShow.o {
	...
	IMPORTS strlen strcpy objNamePtrGet iosFdEntryIoctl kernelId rtpNameTruncate printf mmanFileMutex semTake mmanFileList ioctl vmAttrStringGet sprintf semGive open close
	DECLARES 
	USES 
}
Module mmanShow.o {
...
ObjectFile libpxmem.a::shmFsLib.o {
	...
	IMPORTS errnoSet __errno pathconf strlen malloc iosDrvInstall iosDevAdd semMInit tick64Get sysClkRateGet __udiv64 strcpy sysctl_handle_string vm_node pSysctlCtxList sysctl_add_oid_internal iosDrvRemove free strcmp semMTake semMGive mmanMODelete bzero
	DECLARES 
	USES 
}
Module shmFsLib.o {
...
ObjectFile libpxmem.a::shmLib.o {
	...
	IMPORTS semMInit semTake shmVolNameGet semGive strlen strncmp errnoSet strncpy strcat open unlink errnoGet
	DECLARES 
	USES 
}
Module shmLib.o {
...
ObjectFile libpxmem.a::mmanScLib.o {
	...
	IMPORTS mmap64 munmap mprotect scMemValidate taskIdCurrent kernelId scMemPrivValidate cacheFlush cacheInvalidate cacheClear cacheTextUpdate msync vmTranslate __errno
	DECLARES 
	USES 
}
Module mmanScLib.o {
...
ObjectFile libpxmem.a::shmScLib.o {
	...
	IMPORTS scMemValidate errnoSet shmVolNameGet
	DECLARES 
	USES 
}
Module shmScLib.o {
...
ObjectFile libpxmem.a::mmanRtpShow.o {
	...
	IMPORTS printf vmContextHeaderPrint vmContextRangeShow _func_fdMap mmanFileMutex semTake objNamePtrGet iosFdEntryIoctl strcat semGive
	DECLARES 
	USES 
}
