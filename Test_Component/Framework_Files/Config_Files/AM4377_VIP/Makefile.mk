...
# GENERATED: Thu Mar 07 19:23:24 EST 2019
...
PRJ_FILE       = AM4377_VIP.wpj
PRJ_FULL_PATH  = C:/Users/builder5/Desktop/Paul/MyWorkspaces/NextGen/Integration/AM4377_VIP
PRJ_TYPE       = vxWorks
PRJ_OBJS       = usrAppInit.o usrRtpAppInit.o prjConfig.o linkSyms.o loadInvokeApps.o
USER_OBJS      = 
PRJ_MAKEFILE   = $(PRJ_DIR)/Makefile.mk
BOOT_OBJS      =  $(BOOT_EXTRA)
BUILD_SPEC     = default
BSP_DIR        = C:/Users/builder5/Desktop/Paul/MyWorkspaces/NextGen/Integration/AM4377_VIP/ti_sitara_ctxa9_branson_1_0_0_0
VSB_DIR        = C:/Users/builder5/Desktop/Paul/MyWorkspaces/NextGen/Integration/AM4377_VSB
OPT            = -inet6
...
DATA_SEG_ALIGN = 1
LOCAL_MEM_PHYS_ADRS = 80000000
KERNEL_LOAD_ADRS = 80100000

## component-configuration info

COMPONENTS = BRANSON_DRV_AM437x_QSPI \
	BRANSON_DRV_CORE_END_FDT_TI_PRUSS \
	BRANSON_DRV_EHRPWM \
	BRANSON_DRV_END_FDT_TI_PRUSS \
...
loadInvokeApps.o:  $(PRJ_DIR)/loadInvokeApps.c 
	$(RM) loadInvokeApps.o
	$(CC) $(CFLAGS) $(CC_SDA_FLAGS) $(CFLAGS_OPTIONS_ALL) -c $(PRJ_DIR)/loadInvokeApps.c
endif
