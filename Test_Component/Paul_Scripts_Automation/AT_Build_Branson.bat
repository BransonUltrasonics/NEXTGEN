...
REM SET EMAIL_TO_ALL=Paul.Fitzmaurice@Emerson.com,girish.sadashivappa@sasken.com,ritesh.raj@sasken.com,rajkumar.k@sasken.com,shruthi.chandrasekhar@sasken.com,raghavendra.boya@sasken.com
...
SET STREAM_NAME=Next Gen Branson Dev Stream
