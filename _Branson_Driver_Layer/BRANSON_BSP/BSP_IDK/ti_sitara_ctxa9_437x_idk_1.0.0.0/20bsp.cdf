...
Component DRV_END_FDT_TI_PRU_ESC {
	REQUIRES DRV_END_FDT_TI_PRUSS	\
			DRV_END_FDT_TI_PRU_ESC	\
			DRV_CORE_END_FDT_TI_PRUSS	\
			DRV_INTC_END_FDT_TI_PRUSS	\
			DRV_MDIO_END_FDT_TI_PRUSS	\
			INCLUDE_PRUDRV
...
Selection BOARD_SELECTION {
    ...
    COUNT       1-1
    CHILDREN    INCLUDE_TI_AM437X_IDK_EVM
    DEFAULTS    INCLUDE_TI_AM437X_IDK_EVM
    _CHILDREN   FOLDER_BSP_CONFIG
}

Component INCLUDE_TI_AM437X_IDK_EVM {
    NAME        TI AM437x IDK EVM
    SYNOPSIS    TI AM437x IDK EVM support.
}
...
Parameter DTS_FILE {
    ...
    DEFAULT     (INCLUDE_TI_AM437X_IDK_EVM)::(am437x-idk-evm.dts)
}
