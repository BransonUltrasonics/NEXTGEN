...
Selection BOARD_SELECTION {
    ...
    COUNT       1-1
    CHILDREN    INCLUDE_TI_AM4377_LBC
    DEFAULTS    INCLUDE_TI_AM4377_LBC
    _CHILDREN   FOLDER_BSP_CONFIG
}

Component INCLUDE_TI_AM4377_LBC {
    NAME        TI AM4377 LBC
    SYNOPSIS    TI AM4377 LBC support.
}
...
Parameter DTS_FILE {
    ...
    DEFAULT     (INCLUDE_TI_AM4377_LBC)::(am4377-lbc.dts)
}
