...
/*****************************************************************************
*
* pwmssRegister - register routine to VxBus pwmss subsystem.
*
...
/*******************************************************************************
*
* vxbPwmssEnable - enable the Pwmss module
*
...
STATUS vxbPwmssEnable
	...
	return pwmsshandle[pwmss].pPwmssFunc->ehrpwmClkConfigEnable(pwmsshandle[pwmss].pPwmssInst,module);
	
    }

/*******************************************************************************
*
* vxbPwmssDisable - disable the Pwmss module
*
* This routine enable ehrpwm module in pwm subsystem
*
* RETURNS: OK, or ERROR.
...
STATUS vxbPwmssDisable
	...
	return pwmsshandle[pwmss].pPwmssFunc->ehrpwmClkConfigDisable(pwmsshandle[pwmss].pPwmssInst,module);
