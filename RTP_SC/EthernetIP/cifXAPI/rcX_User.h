...
***************************************************************************************
  ...
  $Id: rcX_User.h 6971 2015-07-13 08:51:16Z Robert $:
  ...
  Changes:
    Date        Description
    -----------------------------------------------------------------------------------
    2017-10-13  FL, fixed build error
    2015-07-07  Added RCX_HW_DEV_CLASS_GW_NETTAP_151
    2015-05-18  Added RCX_COMM_CLASS_SCADA
                Added RCX_PROT_CLASS_ATVISE, RCX_PROT_CLASS_MQTT, RCX_PROT_CLASS_OPCUA
...
#define RCX_HW_DEV_CLASS_GW_NETTAP_151                      0x0039
...
#define RCX_COMM_CLASS_SCADA                                0x0018
...
#define RCX_PROT_CLASS_ATVISE                               0x0029
#define RCX_PROT_CLASS_MQTT                                 0x002A
#define RCX_PROT_CLASS_OPCUA                                0x002B
