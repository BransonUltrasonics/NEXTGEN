/* vxbOmap3Timer.c - TI OMAP35xx processor timer library */

/*
 * Copyright (c) 2008-2011, 2013-2016 Wind River Systems, Inc.
 *
...
--------------------
04mar16,dee  add include to fix implicit declaration references
03nov15,yjw  added support for AM5XXX (US64521)
03jul14,swu  added support for AM4xxx.(US40646)
04nov13,c_t  add workaround for CPSW on 335x
25oct13,c_t  enable source clk in driver.
16sep13,cfm  update for VXB GEN2
08mar13,c_l  remove build warnings (WIND00406706)
25oct11,rec  WIND313562 - omap35xxOneShotEnable rollover bug
11oct11,rec  WIND00308647 - omap35xxOneShotDisable misses rollover
13jul11,clx  add dm81xx timer support
08mar11,bsk  fix compiler warnings
28feb11,rec  WIND00257399 - fix pointer dereference.
             WIND00257405 - invalid return value
22feb11,bsk  fix format and spell errors for doc gen
06oct10,rec  add tickless-idle
29oct09,j_b  fix omap35xxTimerCountGet to account for initial load value
             (WIND00188725)
02mar09,m_h  cleanup
25nov08,m_h  support for more than one timer
08jul08,m_h  created
*/
...
VXB_DRV_DEF (vxbOfOmap3TimerDrv)
