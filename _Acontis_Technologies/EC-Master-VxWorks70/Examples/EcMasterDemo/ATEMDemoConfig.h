...
#define REALTIME_PRIORITY_OFFSET    8
    
#define TIMER_THREAD_PRIO           ((EC_T_DWORD)(0 + REALTIME_PRIORITY_OFFSET))   /* EtherCAT master timer task (tEcTimingTask) */
#define JOBS_THREAD_PRIO            ((EC_T_DWORD)(1 + REALTIME_PRIORITY_OFFSET))   /* EtherCAT master job thread priority (tEcJobTask) */
#define RECV_THREAD_PRIO            ((EC_T_DWORD)(2 + REALTIME_PRIORITY_OFFSET))   /* EtherCAT master packet receive thread priority (tLOsaL_IST) */
#define LOG_THREAD_PRIO             ((EC_T_DWORD)(5 + REALTIME_PRIORITY_OFFSET))   /* EtherCAT message logging thread priority (tAtEmLog) */
#define MAIN_THREAD_PRIO            ((EC_T_DWORD)(4 + REALTIME_PRIORITY_OFFSET))   /* Main thread */
#define DEMO_PARAMETERS             "-v 2 -fslfec 1 1 imxceetul2 -perf"
