...
#define RASSPOCCFGINITDEFAULT \
    ...
    /*  call class, min. access,            ordinal,                        index ,                                                      subindex,           cse=0 */ \
        ...
        0x00000001, rasal_freeaccess,       ord_emIoControl,                EC_IOCTL_SET_ADJUST_CYCFRAMES_AFTER_SLAVES_STATE_CHANGE,     PARAMETER_IGNORE,   0x00000000, /* emIoControl(EC_IOCTL_SET_ADJUST_CYCFRAMES_AFTER_SLAVES_STATE_CHANGE), free access */ \
