...
/* Routines for SCG_USER0 */

#define SCN_AuxClkConnect 		 SYSCALL_NUMBER (SCG_USER0, 0)
#define SCN_AuxClkEnable 		 SYSCALL_NUMBER (SCG_USER0, 1)
#define SCN_AuxClkDisable 		 SYSCALL_NUMBER (SCG_USER0, 2)
#define SCN_AuxClkRateGet 		 SYSCALL_NUMBER (SCG_USER0, 3)
#define SCN_AuxClkRateSet 		 SYSCALL_NUMBER (SCG_USER0, 4)
#define SCN_GpioAlloc 		 SYSCALL_NUMBER (SCG_USER0, 5)
#define SCN_GpioGetValue 		 SYSCALL_NUMBER (SCG_USER0, 6)
#define SCN_GpioSetValue 		 SYSCALL_NUMBER (SCG_USER0, 7)
#define SCN_GpioSetDir 		 SYSCALL_NUMBER (SCG_USER0, 8)
#define SCN_SetRTC 		 SYSCALL_NUMBER (SCG_USER0, 9)
#define SCN_GetRTC 		 SYSCALL_NUMBER (SCG_USER0, 10)
#define SCN_EhrPwmRegisterISR 		 SYSCALL_NUMBER (SCG_USER0, 11)
#define SCN_EhrPwmSetAQSFRC 		 SYSCALL_NUMBER (SCG_USER0, 12)
#define SCN_EhrPwmSetTbClk 		 SYSCALL_NUMBER (SCG_USER0, 13)
#define SCN_EhrPwmSetTbAQConfA 		 SYSCALL_NUMBER (SCG_USER0, 14)
#define SCN_EhrPwmSetTbAQConfB 		 SYSCALL_NUMBER (SCG_USER0, 15)
#define SCN_EhrPwmSetTbPWMCfg 		 SYSCALL_NUMBER (SCG_USER0, 16)
#define SCN_EqepSetMaxCount 		 SYSCALL_NUMBER (SCG_USER0, 17)
#define SCN_EqepGetPosCount 		 SYSCALL_NUMBER (SCG_USER0, 18)
#define SCN_McSpiTrans 		 SYSCALL_NUMBER (SCG_USER0, 19)
#define SCN_MsDelay 		 SYSCALL_NUMBER (SCG_USER0, 20)
#define SCN_GpioGetDir 		 SYSCALL_NUMBER (SCG_USER0, 21)
#define SCN_GpioFree 		 SYSCALL_NUMBER (SCG_USER0, 22)
#define SCN_logCRIT 		 SYSCALL_NUMBER (SCG_USER0, 23)
#define SCN_logERR 		 SYSCALL_NUMBER (SCG_USER0, 24)
#define SCN_logWARN 		 SYSCALL_NUMBER (SCG_USER0, 25)
#define SCN_logDBG 		 SYSCALL_NUMBER (SCG_USER0, 26)
#define SCN_Am5728EhrPwmRegisterISR 		 SYSCALL_NUMBER (SCG_USER0, 27)
#define SCN_Am5728EhrPwmSetAQSFRC 		 SYSCALL_NUMBER (SCG_USER0, 28)
#define SCN_Am5728EhrPwmSetTbClk 		 SYSCALL_NUMBER (SCG_USER0, 29)
#define SCN_Am5728EhrPwmSetTbAQConfA 		 SYSCALL_NUMBER (SCG_USER0, 30)
#define SCN_Am5728EhrPwmSetTbAQConfB 		 SYSCALL_NUMBER (SCG_USER0, 31)
#define SCN_Am5728EhrPwmSetTbPWMCfg 		 SYSCALL_NUMBER (SCG_USER0, 32)
#define SCN_RunTimeFeature 		 SYSCALL_NUMBER (SCG_USER0, 33)
#define SCN_IPConfiguration 		 SYSCALL_NUMBER (SCG_USER0, 34)
#define SCN_QSPIFlashErase 		 SYSCALL_NUMBER (SCG_USER0, 35)
#define SCN_QSPIFlashWrite 		 SYSCALL_NUMBER (SCG_USER0, 36)
#define SCN_QSPIFlashRead 		 SYSCALL_NUMBER (SCG_USER0, 37)
#define SCN_QspiLibBlockErase 		 SYSCALL_NUMBER (SCG_USER0, 38)
#define SCN_QspiLibWrite 		 SYSCALL_NUMBER (SCG_USER0, 39)
#define SCN_QspiLibRead 		 SYSCALL_NUMBER (SCG_USER0, 40)
#define SCN_QspiLibInit 		 SYSCALL_NUMBER (SCG_USER0, 41)
#define SCN_QspiLibPrintId 		 SYSCALL_NUMBER (SCG_USER0, 42)
#define SCN_SioPollInput 		 SYSCALL_NUMBER (SCG_USER0, 43)
#define SCN_SioPollOutput 		 SYSCALL_NUMBER (SCG_USER0, 44)
#define SCN_GpioIntConnect 		 SYSCALL_NUMBER (SCG_USER0, 45)
#define SCN_GpioIntEnable 		 SYSCALL_NUMBER (SCG_USER0, 46)
#define SCN_GpioIntConfig 		 SYSCALL_NUMBER (SCG_USER0, 47)
#define SCN_Gpio24VLowShutdown 		 SYSCALL_NUMBER (SCG_USER0, 48)
#define SCN_PcGpio15VLow 		 SYSCALL_NUMBER (SCG_USER0, 49)
#define SCN_PcGpio5VLow 		 SYSCALL_NUMBER (SCG_USER0, 50)
#define SCN_TimeStamp 		 SYSCALL_NUMBER (SCG_USER0, 51)
#define SCN_EmmcExtCsdDecode 		 SYSCALL_NUMBER (SCG_USER0, 52)
#define SCN_GetRTClowPwr 		 SYSCALL_NUMBER (SCG_USER0, 53)
