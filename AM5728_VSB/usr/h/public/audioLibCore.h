...
--------------------
24apr16,dee  add new value for enum AUDIO_IO_CTRL
...
typedef enum audioIoCtrl
    {
    AUDIO_FIONREAD = FIONREAD,      /* using the ioLib value for read */
    AUDIO_FIONFREE = FIONFREE,      /* using the ioLib value for free */
