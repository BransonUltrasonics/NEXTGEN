...
/*
 * Copyright (c) 2003-2010, 2013-2016 Wind River Systems, Inc.
 *
...
Component INCLUDE_DATA_NO_EXEC {
        ...
        SYNOPSIS        Including this component will result in only the \
                        ...
                        e.g. pages containing the .data ELF section, task \
...
Component INCLUDE_ADR_SPACE_DIRECT_MAP {
        ...
        SYNOPSIS        Support API's for the Direct Map Region  
        _CHILDREN       FOLDER_NOT_VISIBLE
...
Component INCLUDE_PMAP_LIB {
        ...
        SYNOPSIS        provides the functionality to map or unmap physical \
                        addresss to the kernel/RTP context.
        _CHILDREN       FOLDER_OS
...
Component INCLUDE_ADR_SPACE_SHOW {
        ...
        SYNOPSIS        This component includes the adrSpaceShow() show function for \
				...
				the address space usage at time of the call.
...
Component INCLUDE_TASK_STACK_NO_EXEC {
	...
	SYNOPSIS	Exception and execution stacks for RTP and kernel \
			tasks will be marked non-executable.
	_CHILDREN	FOLDER_KERNEL_HARDENING
