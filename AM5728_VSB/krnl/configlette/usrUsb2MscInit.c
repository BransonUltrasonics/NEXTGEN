...
/*
 * Copyright (c) 2008-2014,2016 Wind River Systems, Inc.
 *
...
--------------------
13may16,mdg  correct naming of first partition of multiple partition disk
05nov14,j_x  extern tUsb2Msc task size to 8192 (V7CON-195)
16Jul13,wyy  Disable USB2_MSC_TEST_CODE_ENABLE to decrease footprint
             (WIND00425875)
06may13,s_z  Remove compiler warning (WIND00356717)
25apr13,wyy  Clean diab compiler warning
02aug12,ljg  Correct commandTimeout (WIND00366753)
19jul12,w_x  Add performance testing routines (WIND00188662)
06jul11,ghs  USB sticks coverage expansion (WIND00183500)
17mar11,j_x  Add multiple inclusion guard symbol (WIND00247788)
07jan11,ghs  Clean up compile warnings (WIND00247082)
08dec10,ghs  Initialize USB GEN2 helper before MSC driver initialize
             (WIND00245236)
24jun10,m_y  Release all the resources allocated before in error handler
             (WIND00183499)
06jun10,ghs  Reduce some default display logs(WIND00210988)
...
24apr09,w_x  Coding convention changes and more configuration options
29oct08,w_x  Written
*/
...
#else
#define USB2_MSC_SERVICE_TASK_STACK_SIZE    8192
#endif
#endif
