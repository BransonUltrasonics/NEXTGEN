...
/*
 * Copyright (c) 1999-2001, 2006, 2009-2010 Wind River Systems, Inc.
 *
...
--------------------
01l,18may10,w_x  USB transition to vxbDmaBufLib supporting 64 bit (WIND00193267)
01l,29apr10,pad  Moved extern C statement after include statements.
01k,13jan10,ghs  vxWorks 6.9 LP64 adapting
01j,11sep09,ghs  Remove warning message
01i,10jan06,ami  Support for vendor specific class drivers added (SPR #113619)
...
#include "usbHandleLib.h"       /* handle utility funcs */
#include "usb.h"                /* Basic USB definitions */
#include "usbHst.h"             /* Basic USB definitions */
#include "usbHcd.h"         /* USB HCD interface definitions */
...
typedef UINT32 USBD_NODE_ID, *pUSBD_NODE_ID;
...
STATUS usbdDynamicAttachRegister
    ...
    BOOL   vendorSpecific,              /* class/vendor specific device */
...
STATUS usbdPipeSetup
    (
    USBD_CLIENT_HANDLE          clientHandle,       /* Client handle */
    USBD_PIPE_HANDLE            pipeHandle,         /* Pipe handle */
    pUSB_TRANSFER_SETUP_INFO    pSetup              /* Transfer setup info */
    );
STATUS usbdTransfer
    (
    USBD_CLIENT_HANDLE clientHandle,    /* Client handle */
...
/* we do not use it any more in USB 2.x */
#if 0
...
STATUS usbdHcdAttach
    (
    HCD_EXEC_FUNC hcdExecFunc,          /* Ptr to HCDs primary entry point */
