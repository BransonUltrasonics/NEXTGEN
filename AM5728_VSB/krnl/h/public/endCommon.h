...
/* Copyright 2005-2006, 2008-2011, 2014-2016 Wind River Systems, Inc. */
...
typedef struct ieee1588_timer_isr_func
    {
    void                (*pIsrFunc)(_Vx_usr_arg_t);
    _Vx_usr_arg_t       arg;
    } IEEE1588_TIMER_ISR_FUNC;
...
typedef struct ieee1588_timer_exp_sync
    {
    struct timespec * startTs;
    unsigned int interval;
    } IEEE1588_TIMER_EXP_SYNC;
...
typedef struct qbvCycleCfg
    {
     unsigned int *    cycleLen;
     QBV_TIME_SLOT *   tsHead;
...
/* Enable 1588 timer with interrupt interval with any usec < 1 sec */
#define EIOCS1588TIMENABLE  _IOW('e', 65, UINT32)

/* Disable 1588 timer */
#define EIOCS1588TIMDISABLE _IOW('e', 66, NULL)

/* Get 1588 timer func */
#define EIOCG1588TIMFUNC    _IOR('e', 67, struct vxbTimerFunctionality **)

/* Get 1588 timer instance */
#define EIOCG1588TIMINST    _IOR('e', 68, ULONG *)

/* Set 1588 timer Isr func */
#define EIOCS1588TIMISR     _IOW('e', 69, struct ieee1588_timer_isr_func *)
...
/* Get 1588 time stamp sync interval */
#define EIOCS1588TSTXOFFSETCONFIG _IOW('e', 73, UINT32)

/* Set 1588 time stamp sync delay */
#define EIOCG1588SYSTIMEINTERVAL _IOW('e', 74, UINT32)

/* set 1588 time stamp sync interval */
#define EIOCG1588SYSTIMEDELAY _IOW('e', 75, UINT32)

/* Set 1588 time stamp Tx 1588 OFFSET configuration */
#define EIOCS1588SYSTIMEINTERVAL _IOW('e', 76, UINT32)

/* IEEE 802.1Qav/Qbv support */

/* Create QBV cycle timer */
#define EIOCQBVCREATECYCLE _IOW('e', 77, struct qbvCycleCfg *)

/* Get the QBV cycle start timer */
#define EIOCGQBVCYCLESTART _IOR('e', 78, struct timespec *)

/* Enable 1588 timer to expire at a future time and not a time interval */
#define EIOCS1588TIMEXPENABLE  _IOW('e', 79, struct ieee1588_timer_exp_sync *)

/* Set 1588 timer use the Software-Defined Pin to emit pulse */
#define EIOCS1588SDPCONFIG _IOW('e', 80, UINT32)
