/* @(#) pSOSystem: apps/inetutil/sys_conf.h (&U&) 1.2 00/01/27 15:24:03 */
...
#define SC_RBUG_PORT          (1 + SERIAL_DRVRNUM(0))
...
/*                                                                     */
/***********************************************************************/
#define SD_LAN1                NO          /* Enable the LAN interface */
#define SD_LAN1_IP             0x00000000       /* target IP */
...
/*                                                                     */
/***********************************************************************/
#define SD_DEF_GTWY_IP 0x00000000
...
#define SC_DEVMAX            44         /* Maximum device number       */
...
/*---------------------------------------------------------------------*/
#define TD_BRKOPC      0xe6000010/* Instruction break opcode (INT 3)   */
#define TD_BRKOPC_16   0xde00   /* Thumb undefined inst                */
...
/*                                                                     */
/*---------------------------------------------------------------------*/
#define LD_MAX_LOAD      0      /* Max. # of active loads              */
#define LD_ELF_MODULE    YES    /* ELF object-load-module              */
#define LD_SREC_MODULE   YES    /* SREC object-load-module             */
