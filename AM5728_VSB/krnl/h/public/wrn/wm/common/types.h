...
-------------------
01b,08jun10,y_t  update for LP64
...
typedef unsigned int   bits32_t; /* 32 bits */
#endif
...
typedef signed int     sbits32_t; /* signed 32 bits */
#endif
...
typedef unsigned char ldb_int8_t;        /* 8  bits */
#endif
#ifndef __TYPES_HAVE_ldb_int16_t_
typedef unsigned short ldb_int16_t;       /* 16 bits */
#endif
#ifndef __TYPES_HAVE_ldb_int32_t_
typedef unsigned int ldb_int32_t;      /* 32 bits */
#endif
