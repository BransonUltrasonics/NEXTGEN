...
BUSTYPE_DECL(vxbeMmcBus);
#define VXB_BUSID_SDMMC     BUSTYPE_ID(vxbeMmcBus)/* Nexus class device */
...
#define EMMC_CARD_NAME          "eMmcStorage"
#define SD_CARD_NAME			"undefined"
/*
...
#define EXT_CSD_DEVICE_PRE_EOL_INFO    	     267 /* RO */
...
#define EXT_CSD_MAX_ENH_SIZE_MULT1      158  /* RO */
#define EXT_CSD_MAX_ENH_SIZE_MULT2      159  /* RO */
...
#define MMC_PARTITION_ENH_USR_SET       0x01    /* Set Enhanced attribute in User Data Area */
#define MMC_PARTITION_COMPLITION_SET    0x01    /* Set Partition Completion  */
...
#define MMC_ERASE_GRP_ENABLE            0x00000001
...
typedef struct vxbDecodeExtCSD_t
    {
    STATUS (*decodeExtCSD)(VXB_DEV_ID pInst);   
    } VXB_DECODE_EXT_CSD;

struct vxbDExtECSDHandle_t
    {
    VXB_DECODE_EXT_CSD	*pDecodeEcsd;
    VXB_DEV_ID			pInst;
    };

IMPORT void 	registerDecodeEcsd(VXB_DEV_ID pDev, VXB_DECODE_EXT_CSD *pDecodeEcsd);
IMPORT STATUS	vxbDecodeExtCSD (void);


STATUS emmcDevCreate (VXB_DEV_HANDLE, void *);
STATUS emmcCmdGoIdleState (VXB_DEV_HANDLE);
STATUS emmcCmdSendOpCond (VXB_DEV_HANDLE, UINT32);
STATUS emmcCmdAllSendCid (VXB_DEV_HANDLE, void *);
STATUS emmcCmdSendRelativeAddr (VXB_DEV_HANDLE);
STATUS emmcCmdSetDsr (VXB_DEV_HANDLE, UINT32);
STATUS emmcCmdIoSendOpCond (VXB_DEV_HANDLE, UINT32);
STATUS emmcCmdSelectCard (VXB_DEV_HANDLE);
STATUS emmcCmdDeselectCard (VXB_DEV_HANDLE);
STATUS emmcCmdSendIfCond (VXB_DEV_HANDLE, UINT32);
STATUS emmcSwitch (VXB_DEV_HANDLE, UINT8, UINT8, UINT8);
STATUS emmcCmdSeEraseGrpStart (VXB_DEV_HANDLE, UINT32);
STATUS emmcCmdSeEraseGrpEnd (VXB_DEV_HANDLE, UINT32);
STATUS emmcCmdSetEraseGrp (VXB_DEV_HANDLE, UINT);
STATUS emmcCmdReadExtCsd (VXB_DEV_HANDLE, UINT8 *);
STATUS emmcCmdSetBlockNum (VXB_DEV_HANDLE, UINT32);
STATUS emmcSendHpi (VXB_DEV_HANDLE, UINT32, UINT32 *);
STATUS emmcACmdSwitchFunc (VXB_DEV_HANDLE, void *, UINT32, int, int, int);
STATUS emmcACmdSendWriteBlkNum (VXB_DEV_HANDLE, UINT32 *);
STATUS emmcACmdSendSsr (VXB_DEV_HANDLE, UINT8 *);
STATUS emmcCmdSwitchVoltage (VXB_DEV_HANDLE);
STATUS eemmcSendTuning (VXB_DEV_HANDLE);
STATUS emmcCmdSendCsd (VXB_DEV_HANDLE, SDMMC_CSD *);
STATUS emmcCmdSendCid (VXB_DEV_HANDLE, void *);
STATUS emmcCmdStopTransmission (VXB_DEV_HANDLE);
STATUS emmcCmdSendStatus (VXB_DEV_HANDLE, UINT32 *);
STATUS emmcCmdGoInactiveState (VXB_DEV_HANDLE);
STATUS emmcCmdSetBlockLen (VXB_DEV_HANDLE, UINT32);
STATUS emmcCmdReadSingleBlock (VXB_DEV_HANDLE, void *, UINT32, BOOL);
STATUS emmcCmdReadMultipleBlock (VXB_DEV_HANDLE, void *, UINT32, UINT32, BOOL);
STATUS emmcCmdReadBlock (VXB_DEV_HANDLE, void *, UINT64, UINT32, BOOL);
STATUS emmcCmdWriteSingleBlock (VXB_DEV_HANDLE, void *, UINT32, BOOL);
STATUS emmcCmdWriteMultipleBlock (VXB_DEV_HANDLE, void *, UINT32, UINT32, BOOL);
STATUS emmcCmdWriteBlock (VXB_DEV_HANDLE, void *, UINT64, UINT32, BOOL);
STATUS emmcCmdAppCmd (VXB_DEV_HANDLE);
STATUS emmcACmdSetBusWidth (VXB_DEV_HANDLE, UINT32);
STATUS emmcACmdSendOpCond (VXB_DEV_HANDLE, UINT32, UINT32);
STATUS emmcACmdClrCardDetect (VXB_DEV_HANDLE, UINT32);
STATUS emmcACmdSendScr (VXB_DEV_HANDLE, SDMMC_SCR *);
STATUS emmcCmdSetRelativeAddr (VXB_DEV_HANDLE);
STATUS emmcCmdIoRwDirect (VXB_DEV_HANDLE, UINT32, UINT32, UINT32, UINT8 *);
STATUS emmcCmdIoRwExtend (VXB_DEV_HANDLE, UINT32, UINT32, UINT32, SDDATA *);
STATUS emmcCmdIssue (VXB_DEV_HANDLE, SD_CMD *);
STATUS vxbeMmcReadCis(VXB_DEV_HANDLE);
STATUS vxbeMmcSetFunc(VXB_DEV_HANDLE, UINT8, BOOL);
