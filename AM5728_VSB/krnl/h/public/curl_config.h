/*  curl_config.h - header for curl config */
...
/*
DESCRIPTION
copy from curl/src/3pp/curl/lib/config-vxworks.h and make modifications.
HAVE_CONFIG_H is defined in the /curl/src/Makefile
*/

#ifndef __CURL_CONFIG_H_HEADER__
#define __CURL_CONFIG_H_HEADER__
...
#endif /* __CURL_CONFIG_H_HEADER__ */
