...
#define VXB_FLAG_DYNAMIC     0x00000001 /* VXB_DEV_ID was malloc()ed */
#define VXB_FLAG_PROBED      0x00000002 /* Successfully probed, but not
                              yet attached (set by vxbDevProbe(),
                              cleared by vxbDevAttach()) */
#define VXB_FLAG_ATTACHING   0x00000004 /* The device is attaching */
#define VXB_FLAG_ATTACHED    0x00000008 /* Successfully attached (set by
                              vxbDevAttach(), cleared by
                              vxbDevDetach()) */
#define VXB_FLAG_NAMEALLOCED 0x00000010 /* the name is allocated */

#define VXB_FLAG_LOANED      0x00000020 /* Loaned to guest */
#define VXB_FLAG_RESETTING   0x00000040 /* Reset in progress */
#define VXB_FLAG_RECLAIMING  0x00000080 /* Reclaim in progress */
#define VXB_FLAG_NAMEADDRALLOCED 0x00000100 /* the unit/address is allocated */

/* VxBus driver flag */

#define VXB_DRVFLAG_RESET    0x00000001 /* Driver supports reset */
#define VXB_DRVFLAG_PARAM    0x00000002 /* Driver has default parameter */
