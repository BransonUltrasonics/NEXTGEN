...
/*
 * Copyright 2003-2004, 2008-2010, 2012, 2014-2015 Wind River Systems, Inc.
 *
...
#if defined(_WRS_CONFIG_WIBU_BASIC_SECURITY) || defined(_WRS_CONFIG_WIBU_CODEMETER_SECURITY)
#include <exengine.h>
#endif
