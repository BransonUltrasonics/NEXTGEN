...
#define WIND_TCB_pTlsDesc_OFFSET          	0x22c
...
#define WIND_RTP_pPathName_OFFSET        	0x64
#define WIND_RTP_pArgv_OFFSET            	0x68
#define WIND_RTP_pEnv_OFFSET             	0x6c
#define WIND_RTP_status_OFFSET           	0x70
#define WIND_RTP_options_OFFSET          	0x74
#define WIND_RTP_entrAddr_OFFSET         	0x78
#define WIND_RTP_initTaskId_OFFSET       	0x7c
#define WIND_RTP_symTabId_OFFSET         	0x80
#define WIND_RTP_binaryInfo_OFFSET       	0x84
#define WIND_RTP_taskCnt_OFFSET          	0xb4
#define WIND_RTP_fdTable_OFFSET          	0xcc
#define WIND_RTP_fdTableSize_OFFSET      	0xd0
#define WIND_RTP_defPath_OFFSET          	0xd4
#define WIND_RTP_defPathLen_OFFSET       	0xd8
#define WIND_RTP_taskExitRtn_OFFSET      	0xdc
#define WIND_RTP_sigReturnRtn_OFFSET     	0xe0
#define WIND_RTP_signalInfo_OFFSET       	0xe8
#define WIND_RTP_pSigQFreeHead_OFFSET    	0x920
#define WIND_RTP_sigwaitQ_OFFSET         	0x924
#define WIND_RTP_parentRtpId_OFFSET      	0x934
#define WIND_RTP_lockTaskId_OFFSET       	0xd54
#define WIND_RTP_cpuTimeInfo_OFFSET      	0xd68
#define WIND_RTP_pSchedInfo_OFFSET       	0xd78
...
#define WIND_TCB_fpStatus_OFFSET    	0x1cc
#define WIND_TCB_regs_OFFSET        	0x1d8
...
#define SYSCALL_ENTRY_STATE_pc_OFFSET         	0x28
#define SYSCALL_ENTRY_STATE_pUStack_OFFSET    	0x2c
#define SYSCALL_ENTRY_STATE_size_OFFSET       	0x3c
...
#define REG_SET_sp_OFFSET      	0x34
#define REG_SET_pc_OFFSET      	0x3c
#define REG_SET_size_OFFSET    	0x4c

/* Structure size and member offsets for VFP_CONTEXT structure */

#define VFP_CONTEXT_fpsid_OFFSET      	0x0
#define VFP_CONTEXT_fpexc_OFFSET      	0x8
#define VFP_CONTEXT_fpinst_OFFSET     	0xc
#define VFP_CONTEXT_fpinst2_OFFSET    	0x10
#define VFP_CONTEXT_mfvfr0_OFFSET     	0x14
#define VFP_CONTEXT_mfvfr1_OFFSET     	0x18

/* Structure size and member offsets for N structure */

#define vfpNumSgpr_OFFSET    	0x40

/* Structure size and member offsets for VFP_CONTEXT structure */

#define VFP_CONTEXT_fpscr_OFFSET      	0x4
#define VFP_CONTEXT_vfp_gpr_OFFSET    	0x20

/* Structure size and member offsets for ESFARM structure */

#define ESFARM_pc_OFFSET         	0x0
#define ESFARM_cpsr_OFFSET       	0x4
#define ESFARM_vecAddr_OFFSET    	0x10

/* Offset for syscall entry */

#define syscallEntryBaseOffset_OFFSET    	0xc

/* Structure size and member offsets for SYSCALL_ENTRY_STATE structure */

#define SYSCALL_ENTRY_STATE_statusReg_OFFSET     	0x24
#define SYSCALL_ENTRY_STATE_retAddrReg_OFFSET    	0x30
#define SYSCALL_ENTRY_STATE_tlsBase_OFFSET       	0x34
#define SYSCALL_ENTRY_STATE_fp_OFFSET            	0x38
...
/* Structure size and member offsets for WRS_CONFIG_ARM_LPAE structure */

#define _WRS_CONFIG_ARM_LPAE_OFFSET    	0x1
