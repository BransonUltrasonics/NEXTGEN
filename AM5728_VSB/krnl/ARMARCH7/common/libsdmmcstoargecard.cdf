...
ObjectFile libsdmmcstoargecard.a::blkXbd.o {
	...
	IMPORTS __udiv32 errnoGet bio_done semTake semGive printf taskPrioritySet xbdEventCategory xbdEventInstantiated erfHandlerUnregister strncpy strncat semMCreate semBCreate taskSpawn erfHandlerRegister xbdAttach xbdEventPrimaryInsert erfEventRaise semDelete taskDelete vxAbsTicksGet taskCpuLock taskIsPended taskCpuUnlock taskDelay sysClkRateGet xbdEventRemove xbdDetach devUnmap __mul64 __div64 xbdEventSoftInsert devName
	DECLARES 
	USES 
}
Module blkXbd.o {
