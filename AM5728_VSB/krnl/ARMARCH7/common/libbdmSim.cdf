...
ObjectFile libbdmSim.a::fsimChip.o {
	...
	IMPORTS __udiv32 lseek taskIdSelf write printf errnoSet ioctl semTake memset semGive errnoGet read tickGet srand rand __urem32 open close malloc semMCreate memcpy semDelete free sysClkRateGet __rem32 __div32 taskDelay
	DECLARES 
	USES 
}
Module fsimChip.o {
...
ObjectFile libbdmSim.a::fsimMtd.o {
	...
	IMPORTS malloc printf memset free memcpy fsimInjectError __udiv32 taskIdSelf fsimIsBadBlock strcmp
	DECLARES 
	USES 
}
Module fsimMtd.o {
