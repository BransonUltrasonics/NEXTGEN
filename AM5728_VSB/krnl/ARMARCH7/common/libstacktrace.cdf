...
ObjectFile libstacktrace.a::context_memtest.o {
	...
	IMPORTS vxAtomicInc memory_map_init vxAtomicDec vmLibInfo memPoolEndAdrs intContext vxMemProbe taskTcb vxAtomicGet ST_debug_level logMsg taskClassId objVerify _func_rtpIdVerify vxKernelVars vxCpuIndexGet map_region_find sysMemDescGet kernelId
	DECLARES 
	USES 
}
...
ObjectFile libstacktrace.a::arm_os.o {
	...
	IMPORTS taskTcb vxTaskEntry intEnt intExit vxKernelVars vxCpuIndexGet
	DECLARES 
	USES 
}
Module arm_os.o {
