...
ObjectFile libDHCPC.a::ipdhcpc.o {
	...
	IMPORTS strlen ipcom_sysvar_get_as_int memset strncpy ipcom_if_nametoindex ipcom_sysctl malloc ipcom_syslog ipcom_errno_get ipnet_cmd_init_addrs ipcom_socketioctl_usr free ipcom_mutex_create ipcom_sleep time ipcom_socket_usr ipcom_bind_usr ipcom_getsockopt_usr ipcom_setsockopt_usr ipcom_mutex_lock ipcom_socketclose_usr ipcom_mutex_unlock ipcom_mutex_delete ipdhcpc_cmd_dhcpc ipcom_shell_remove_cmd ipcom_random __urem32 memcpy ipcom_in_checksum ipcom_sendto_usr ipcom_sendmsg_usr ipcom_millisleep ipcom_if_indextoname ipcom_tmo_cancel ipcom_tmo_request ipcom_tmo_get strerror ipdhcpc_option_callback ipcom_inet_ntop ipcom_sysvar_set memcmp strtok_r isxdigit strtol snprintf ipcom_sysvar_get ipcom_strcasecmp strcmp sprintf ipcom_sysvar_get_descriptive_int0 ipcom_inet_pton strchr atoi sscanf __rem32 ipcom_socketselect_usr ipcom_ipd_input ipcom_recv_usr ipcom_recvfrom_usr ipcom_if_nameindex ipcom_if_freenameindex ipcom_proc_init ipcom_ipd_init ipcom_ipd_exit ipcom_proc_exit ipdhcpc_reply_callback ipcom_proc_attr_init ipcom_priority_map ipcom_proc_acreate_v1 ipcom_shell_add_cmd
	DECLARES ipdhcpc
	USES 
}
Module ipdhcpc.o {
...
ObjectFile libDHCPC.a::ipdhcpc_cmd_dhcpc.o {
	...
	IMPORTS malloc vsnprintf printf free ipdhcpc_renew_get ipdhcpc_inform_get strcmp ipdhcpc ipcom_mutex_lock ipcom_mutex_unlock ipcom_inet_ntoa
	DECLARES 
	USES 
}
