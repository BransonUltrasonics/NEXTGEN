...
ObjectFile libRADIUS.a::ipradius.o {
	...
	IMPORTS memcmp ipcom_inet_ntop strcpy ipcom_list_first ipcom_list_next ipcom_list_remove free memcpy time secHashMd5TemplateGet secHashInit secHashUpdate secHashFinal secHashCleanup memset ipcom_syslog ipcom_random ipcom_tmo_request ipcom_sendto_usr ipcom_errno_get strerror ipcom_getsockopt_usr malloc ipcom_list_insert_last ipcom_mutex_lock __urem32 ipcom_mutex_unlock ipcom_list_init ipcom_mutex_create ipcom_tmo_cancel ipcom_mutex_delete ipcom_sleep ipcom_sysvar_get strlen
	DECLARES ipradius
	USES 
}
Module ipradius.o {
...
ObjectFile libRADIUS.a::ipradius_cmd_radiusc.o {
	...
	IMPORTS ipcom_err_string snprintf sprintf ipradius_attr_get_next printf ipcom_getpid ipradius_attr_get_u32 ipradius_attr_find strlen ipradius_attr_add_array ipradius_attr_add_u32 strcmp memset memcpy strcpy ipradius_server_add ipradius_addr_to_str ipradius_server_remove __rem32 ipcom_socketselect_usr ipcom_errno_get ipcom_recvfrom_usr ipradius_read ipradius_access_request_pkt_malloc ipradius_access_request_pkt_free ipradius_access_request ipradius_accounting_session_start ipcom_sleep ipradius_accounting_session_stop ipradius_ctrl ipradius_server_ctrl ipcom_inet_ntop ipradius_close ipradius_open malloc ipcom_getline_init ipcom_socket_usr ipcom_bind_usr ipcom_socketclose_usr free ipcom_getline_exit ipcom_stdout ipcom_fflush ipcom_getline ipcom_parse_argstr ipcom_getopt_clear_r ipcom_getopt_r ipcom_inet_pton atoi
	DECLARES 
	USES 
}
