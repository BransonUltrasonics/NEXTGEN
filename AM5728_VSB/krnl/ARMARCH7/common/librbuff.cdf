...
ObjectFile librbuff.a::rBuffLib.o {
	...
	IMPORTS malloc spinLockIsrInit memPartAlloc handleTerminate memPartFree semTerminate semBInit handleInit taskSpawn wvEvtBufferFullNotify memcpy spinLockIsrTake spinLockIsrGive semGive taskDelay logMsg taskPrioritySet semTake write
	DECLARES 
	USES 
}
Module rBuffLib.o {
