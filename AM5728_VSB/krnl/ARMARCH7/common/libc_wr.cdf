...
ObjectFile libc_wr.a::longjmp.o {
	...
	IMPORTS taskIdSelf kernelId _func_rtpSigprocmask taskSuspend __rta_longjmp _func_sigprocmask _sigCtxRtnValSet _sigCtxLoad
	DECLARES 
	USES 
}
Module longjmp.o {
...
ObjectFile libc_wr.a::stdioLib.o {
	...
	IMPORTS fclose _func_fclose malloc taskIdSelf handleInit handleTerminate free _func_taskDeleteHookAdd taskCreateHookInit taskDeleteHookAdd
	DECLARES 
	USES 
}
Module stdioLib.o {
