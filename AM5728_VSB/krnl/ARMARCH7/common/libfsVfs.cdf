...
ObjectFile libfsVfs.a::bufSubr.o {
	...
	IMPORTS printf vprintf _sigCtxSave edrErrorInjectStub edrKernelFatalPolicyHandler brelvp semDelete free __errno semMCreate semCCreate malloc semBCreate vreassignbuf vn_incr_numoutput semGive __urem32 semTake semExchange bgetvp taskIdSelf vxAtomicGet vn_decr_numoutput
	DECLARES 
	USES 
}
Module bufSubr.o {
...
ObjectFile libfsVfs.a::vnodeLockf.o {
	...
	IMPORTS malloc semBCreate free semDelete printf vn_panic memcpy semGive _func_pthread_testandset_canceltype semTake taskIdSelf
	DECLARES 
	USES 
}
Module vnodeLockf.o {
...
ObjectFile libfsVfs.a::vnodeSubr.o {
	...
	IMPORTS printf vprintf _sigCtxSave edrErrorInjectStub edrKernelFatalPolicyHandler semDelete free __errno semMCreate semBCreate taskSpawn semCCreate malloc bzero semTake __rem32 semGive sysClkRateGet tickGet taskDelay vxAtomicInc vxAtomicDec buf_rebusy brelse vxAtomicGet strncat bwrite bawrite
