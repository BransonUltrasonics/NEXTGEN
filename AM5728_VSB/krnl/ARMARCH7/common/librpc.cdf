...
ObjectFile librpc.a::auth_none.o {
	...
	IMPORTS taskIdSelf _null_auth xdrmem_create xdr_opaque_auth
	DECLARES 
	USES 
}
Module auth_none.o {
...
ObjectFile librpc.a::auth_unix.o {
	...
	IMPORTS xdrmem_create xdr_opaque_auth perror memSysPartId memPartAlloc _null_auth xdr_authunix_parms abort memPartFree printErr bcopy
	DECLARES 
	USES 
}
Module auth_unix.o {
...
ObjectFile librpc.a::authunix_pro.o {
	...
	IMPORTS xdr_u_long xdr_string xdr_int xdr_array
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::clnt_generic.o {
	...
	IMPORTS hostGetByName inet_addr bzero strcmp clntudp_create clnttcp_create taskIdSelf
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::clnt_perror.o {
	...
	IMPORTS taskIdSelf memSysPartId memPartAlloc sprintf strlen strcpy printErr strcat
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::clnt_raw.o {
	...
	IMPORTS taskIdSelf memSysPartId memPartAlloc printErr bzero memPartFree xdrmem_create xdr_callhdr perror authnone_create svc_getreq _null_auth xdr_replymsg _seterr_reply xdr_opaque_auth
	DECLARES 
	USES 
}
Module clnt_raw.o {
...
ObjectFile librpc.a::clnt_simple.o {
	...
	IMPORTS taskIdSelf strcmp close hostGetByName clntudp_create strncpy
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::clnt_tcp.o {
	...
	IMPORTS taskIdSelf memSysPartId memPartAlloc printErr pmap_getport memPartFree socket connect close rpcErrnoGet tickGet xdrmem_create xdr_callhdr xdrrec_create authnone_create xdrrec_endofrecord _null_auth xdr_void xdrrec_skiprecord xdr_replymsg _seterr_reply xdr_opaque_auth bzero select read write
	DECLARES 
	USES 
}
Module clnt_tcp.o {
...
ObjectFile librpc.a::clnt_udp.o {
	...
	IMPORTS taskIdSelf memSysPartId memPartAlloc printErr pmap_getport tickGet xdrmem_create xdr_callhdr socket rpcErrnoGet setsockopt close bindresvport ioctl authnone_create memPartFree sysClkRateGet sendto taskDelay _null_auth bzero select recvfrom __udiv32 xdr_replymsg _seterr_reply xdr_opaque_auth
	DECLARES 
	USES 
}
Module clnt_udp.o {
...
ObjectFile librpc.a::get_myaddr.o {
	...
	IMPORTS socket perror taskSuspend ioctl bcopy close
	DECLARES 
	USES 
}
Module get_myaddr.o {
...
ObjectFile librpc.a::pmap_clnt.o {
	...
	IMPORTS get_myaddress clntudp_bufcreate xdr_bool xdr_pmap clnt_perror pmaplist free
	DECLARES 
	USES 
}
Module pmap_clnt.o {
...
ObjectFile librpc.a::pmap_getmaps.o {
	...
	IMPORTS clnttcp_create xdr_pmaplist xdr_void clnt_perror
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::pmap_getport.o {
	...
	IMPORTS clntudp_bufcreate xdr_u_short xdr_pmap taskIdSelf
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::pmap_prot2.o {
	...
	IMPORTS xdr_bool xdr_pmap xdr_reference
	DECLARES 
	USES 
}
Module pmap_prot2.o {
...
ObjectFile librpc.a::rpc_callmsg.o {
	...
	EXPORTS xdr_callmsg
	IMPORTS bcopy ixdr_get_long memSysPartId memPartAlloc xdr_opaque xdr_enum xdr_u_int xdr_u_long xdr_opaque_auth
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::rpc_prot.o {
	...
	IMPORTS xdr_enum xdr_bytes xdr_opaque xdr_u_long xdr_union
	DECLARES 
	USES 
}
Module rpc_prot.o {
...
ObjectFile librpc.a::svc.o {
	...
	IMPORTS taskIdSelf memSysPartId memPartAlloc pmap_set memPartFree pmap_unset pmapUnset panic bzero _authenticate select rpcErrnoGet perror
	DECLARES 
	USES 
}
Module svc.o {
...
ObjectFile librpc.a::svc_auth.o {
	...
	IMPORTS _null_auth _svcauth_unix _svcauth_short
	DECLARES 
	USES 
}
Module svc_auth.o {
...
ObjectFile librpc.a::svc_auth_uni.o {
	...
	IMPORTS xdrmem_create ixdr_get_long bcopy printf xdr_authunix_parms
	DECLARES 
	USES 
}
...
ObjectFile librpc.a::svc_raw.o {
	...
	IMPORTS taskIdSelf memSysPartId memPartAlloc printErr bzero memPartFree xdrmem_create xdr_callmsg xdr_replymsg
	DECLARES 
	USES 
}
Module svc_raw.o {
...
ObjectFile librpc.a::svc_simple.o {
	...
	IMPORTS taskIdSelf printErr svcudp_create pmap_unset svc_register memSysPartId memPartAlloc panic xdr_void svc_sendreply memPartFree taskSuspend bzero svcerr_decode
	DECLARES 
	USES 
}
Module svc_simple.o {
...
ObjectFile librpc.a::svc_udp.o {
	...
	IMPORTS socket perror bzero bindresvport bind getsockname close memSysPartId memPartAlloc printErr memPartFree xdrmem_create xprt_register __urem32 free bcopy __udiv32 semTake bcmp semGive recvfrom rpcErrnoGet xdr_callmsg sendto xdr_replymsg xprt_unregister semDelete semMCreate
	DECLARES 
	USES 
}
Module svc_udp.o {
...
ObjectFile librpc.a::xdr.o {
	...
	EXPORTS xdr_free xdr_void xdr_long xdr_int xdr_u_long xdr_u_int xdr_u_longlong_t xdr_longlong_t xdr_short xdr_u_short xdr_char xdr_u_char xdr_bool xdr_enum xdr_opaque xdr_bytes xdr_netobj xdr_union xdr_string xdr_wrapstring ixdr_get_long
	IMPORTS memSysPartId memPartAlloc _func_printErr memPartFree strlen
	DECLARES 
	USES 
}
Module xdr.o {
...
ObjectFile librpc.a::xdr_array.o {
	...
	IMPORTS xdr_u_int _func_printErr memSysPartId memPartAlloc bzero memPartFree
	DECLARES 
	USES 
}
Module xdr_array.o {
...
ObjectFile librpc.a::xdr_mem.o {
	...
	IMPORTS bcopy bcopyWords bcopyLongs
	DECLARES 
	USES 
}
Module xdr_mem.o {
...
ObjectFile librpc.a::xdr_rec.o {
	...
	IMPORTS memSysPartId memPartAlloc memPartFree printErr __rem32 bcopy lseek
	DECLARES 
	USES 
}
Module xdr_rec.o {
...
ObjectFile librpc.a::xdr_ref.o {
	...
	IMPORTS memSysPartId memPartAlloc printErr bzero memPartFree xdr_bool
	DECLARES 
	USES 
}
Module xdr_ref.o {
...
ObjectFile librpc.a::rpcLib.o {
	...
	IMPORTS portmapd taskSpawn clnt_genericInclude clnt_rawInclude clnt_simpleInclude pmap_getmapsInclude svc_rawInclude svc_simpleInclude xdr_floatInclude taskDeleteHookAdd taskIdSelf memSysPartId memPartAlloc bzero close svc_unregisterall memPartFree errnoSet errnoGet
	DECLARES portmapdId
	USES 
}
Module rpcLib.o {
