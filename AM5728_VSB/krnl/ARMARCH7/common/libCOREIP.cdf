...
ObjectFile libCOREIP.a::vxmux_cmd_vxslab.o {
	...
	IMPORTS spinLockIsrTake spinLockIsrGive printf getoptInit getopt_r vxmux_slab_memory_pool_list vxmux_memory_pool_garbage_collect vxAtomicGet vxmux_slab_get_size shellCmdTopicAdd shellCmdAdd
	DECLARES 
	USES 
}
...
ObjectFile libCOREIP.a::l2config.o {
	...
	IMPORTS semMCreate __stderr fprintf printf muxDevAcquire muxL2Ioctl muxDevRelease muxL2VlanShow muxL2Show bzero strcmp semTake strlen malloc strcpy getOptServ getoptInit getopt_r free semGive bcopy endFindByName strtoul atoi
	DECLARES 
	USES 
}
Module l2config.o {
...
ObjectFile libCOREIP.a::muxL2Lib.o {
	...
	IMPORTS errnoSet spinLockIsrInit semMCreate malloc bzero _func_mux_l2 muxL2PortDetachRtn free muxDevAcquire muxDevRelease muxError memSysPartId cacheArchAlignSize memPartAlignedAlloc memalign spinLockIsrTake bcopy spinLockIsrGive endEtherAddressForm end8023AddressForm semTake semGive endFindByName printf m_prepend netMblkOffsetToBufCopy
...
ObjectFile libCOREIP.a::vxmux_end2.o {
	...
	IMPORTS muxEndStyles ipcom_pkt_free ipcom_conf_pkt_pool_buffer_alignment ipcom_conf_pkt_pool_buffer_extra_space
...
ObjectFile libCOREIP.a::vxmux_mux_mblk.o {
	...
	IMPORTS ipcom_pkt_free ipcom_pkt_stack_malloc vxAtomicInc netMblkClChainFree ipcom_pkt_stack_free vxmux_null_pool ipcom_atomic_get ipcom_pkt_malloc ipnet_vlan_set_tag ipcom_pkt_get_info_safe netMblkClFree
...
ObjectFile libCOREIP.a::vxmux_mux_over_end2.o {
	...
	IMPORTS muxEndStyles muxBindStyles muxIpcomPktToMblkTx ipcom_pkt_free ipcom_pkt_get_info_safe muxMblkToIpcomPktTx netMblkToBufCopy ipcom_pkt_create
	DECLARES 
	USES 
}
...
ObjectFile libCOREIP.a::vxmux_mux2_over_end.o {
	...
	IMPORTS muxEndStyles muxBindStyles muxMblkToIpcomPktTx ipcom_pkt_free ipcom_stack_index muxMblkToIpcomPktRx ipnet_vlan_set_tag muxRestoreMblkFromIpcomPkt muxIpcomPktToMblkTx muxRestoreIpcomPktFromMblkTx
...
ObjectFile libCOREIP.a::vxmux_muxtk_over_end2.o {
	...
	IMPORTS muxEndStyles muxBindStyles muxIpcomPktToMblkTx ipcom_pkt_free ipcom_pkt_get_info_safe muxMblkToIpcomPktTx netMblkClFree netMblkToBufCopy ipcom_pkt_create
	DECLARES 
	USES 
}
...
ObjectFile libCOREIP.a::vxmux_null_buf.o {
	...
	IMPORTS spinLockIsrInit errnoSet bzero malloc spinLockIsrTake spinLockIsrGive memalign memset strcpy netPoolCreate ipcom_port free ipcom_null_pool_create
...
ObjectFile libCOREIP.a::vxmux_slab.o {
	...
	IMPORTS free vxAtomicAdd vxAtomicSub malloc logMsg taskSuspend vxAtomicGet vxAtomicCas bzero __udiv32 spinLockIsrTake spinLockIsrGive strlen calloc strcpy vxAtomicSet memset
