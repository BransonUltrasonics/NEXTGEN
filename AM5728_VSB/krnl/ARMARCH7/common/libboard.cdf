...
ObjectFile libboard.a::boardLib.o {
	...
	IMPORTS datasetIterate intContext kernelLockOwnedByMe taskCpuLock vxCpuIndexGet vxCpuEnabledGet cpcInvoke sysProcNum sysMemDescGet
...
ObjectFile libboard.a::warmBootLib.o {
	...
	IMPORTS sysWarmBootFunc sysWarmBootSlaveDisable sysWarmBootSlaveEnable warmBootDataAlign wrs_kernel_bss_end wrs_kernel_data_start wrs_kernel_data_end bcopy wrs_kernel_text_start wrs_kernel_text_end vmTranslate vxCpuIndexGet vxFdtDtbAddressGet vxCpuIdGet
	DECLARES 
	USES 
}
