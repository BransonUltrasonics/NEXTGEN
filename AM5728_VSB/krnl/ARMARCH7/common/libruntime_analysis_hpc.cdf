...
ObjectFile libruntime_analysis_hpc.a::hpc_utils.o {
	...
	IMPORTS taskDelay vxCpuEnabledGet taskCpuAffinitySet __errno printf taskName strcmp taskSpawn taskSuspend semGive semBCreate sysClkRateGet __div32 taskResume semTake semDelete logMsg
	DECLARES 
	USES 
}
Module hpc_utils.o {
