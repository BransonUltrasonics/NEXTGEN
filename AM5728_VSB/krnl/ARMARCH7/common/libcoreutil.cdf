...
ObjectFile libcoreutil.a::bLib.o {
	...
	EXPORTS bcmp binvert bswap swab uswab bzero index rindex
	IMPORTS bfill strlen
	DECLARES 
	USES 
}
Module bLib.o {
...
ObjectFile libcoreutil.a::dllLib.o {
	...
	EXPORTS dllInit dllTerminate dllCount dllEach
	IMPORTS 
	DECLARES 
	USES 
}
...
ObjectFile libcoreutil.a::ffsLib.o {
	...
	EXPORTS ffs64Msb ffs64Lsb
	IMPORTS ffs32Msb ffs32Lsb
	DECLARES 
	USES 
}
Module ffsLib.o {
...
ObjectFile libcoreutil.a::hookLib.o {
	...
	IMPORTS taskIdSelf kernelLockTake windExit errnoSet
	DECLARES 
	USES 
}
Module hookLib.o {
...
ObjectFile libcoreutil.a::hookTblLib.o {
	...
	IMPORTS qFifoClassId qFifoInit semMInitialize intContext __errno taskIdSelf semMTake semMGive errnoSet vxAtomicCas kernelLockTake windPendQPut windExit kernelLockTry windPendQFlush workQAdd1 vxAtomicOr vxAtomic32Inc vxAtomicAnd vxAtomic32Dec
	DECLARES 
	USES 
}
Module hookTblLib.o {
...
ObjectFile libcoreutil.a::dataset.o {
	...
	IMPORTS wrs_kernel_data_set_start wrs_kernel_data_set_end strncmp
	DECLARES 
	USES 
}
Module dataset.o {
...
ObjectFile libcoreutil.a::applUtilLib.o {
	...
	IMPORTS __errno printf snprintf strerror_r strncmp semTake write vfdprintf semGive
...
ObjectFile libcoreutil.a::memmem.o {
	...
	IMPORTS __ctype_tolower __ctype_toupper
	DECLARES 
	USES 
}
Module memmem.o {
...
ObjectFile libcoreutil.a::hookShow.o {
	...
	EXPORTS hookShow
	IMPORTS _func_symFindSymbol sysSymTbl _func_symNameGet _func_symValueGet cplusDemangle printf
	DECLARES 
	USES 
}
Module hookShow.o {
...
ObjectFile libcoreutil.a::hookTblShow.o {
	...
	EXPORTS hookTblShow
	IMPORTS vxAtomicOr vxAtomic32Inc objRoutineNameGet printf vxAtomicAnd vxAtomic32Dec vxAtomicCas hookTblUpdatersUnpend
	DECLARES 
	USES 
}
...
ObjectFile libcoreutil.a::getopt.o {
	...
	IMPORTS strchr __stderr fprintf strtok_r
...
ObjectFile libcoreutil.a::hashLib.o {
	...
	IMPORTS sllInit handleInit malloc handleTerminate free sllPutAtHead sllPrevious sllRemove sllEach __div32 ffsMsb strcmp
	DECLARES 
	USES 
}
Module hashLib.o {
