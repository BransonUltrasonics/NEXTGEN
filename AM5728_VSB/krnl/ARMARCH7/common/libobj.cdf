...
ObjectFile libobj.a::handleLib.o {
	...
	IMPORTS vxAtomic32Cas vxAtomic32Set
	DECLARES 
	USES 
}
Module handleLib.o {
...
ObjectFile libobj.a::objLib.o {
	...
	IMPORTS objArchLibInit errnoSet intContext __errno handleInit dllInit taskIdSelf kernelId _func_classListAdd handleTerminate _func_classListRemove strlen strncpy classIdTable handleContextGet handleContextSet vxAtomic32Dec
...
ObjectFile libobj.a::classListLib.o {
	...
	IMPORTS _func_classListLock _func_classListUnlock _func_classListInit _func_classListAdd _func_classListRemove dllInit errnoGet semClassId objVerify errnoSet semMInit dllAdd dllRemove semMTakeScalable taskIdSelf semMGiveScalable
	DECLARES 
	USES 
}
...
ObjectFile libobj.a::objInfo.o {
	...
	IMPORTS _func_objNameVerifiedSet objClassIdGet errnoSet _func_classListLock dllCount _func_classListUnlock strcmp taskIdSelf kernelId
	DECLARES 
	USES 
}
Module objInfo.o {
...
ObjectFile libobj.a::objOpen.o {
	...
	IMPORTS spinLockTaskGive __errno vxAtomic32Dec taskClassId taskIdSelf evtAction vxAtomic32Add objMemFree vxAtomic32Or taskUnsafe eventPointSwHandle intContext spinLockTaskTake objVerify _func_objCoreRelease _func_classListLock objNameToId _func_classListUnlock dllRemove dllAdd strlen objMemAlloc strncpy vxAtomic32Inc
	DECLARES 
	USES 
}
Module objOpen.o {
