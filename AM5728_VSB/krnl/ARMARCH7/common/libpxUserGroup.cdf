...
ObjectFile libpxUserGroup.a::pxUserGroupLib.o {
	...
	IMPORTS taskIdSelf kernelId semTake semGive __errno
	DECLARES 
	USES 
}
...
ObjectFile libpxUserGroup.a::getlogin.o {
	...
	IMPORTS taskIdSelf taskCredentialsGet taskCredentialsSet
	DECLARES 
	USES 
}
Module getlogin.o {
...
ObjectFile libpxUserGroup.a::pxUserGroupScLib.o {
	...
	IMPORTS taskIdSelf semTake semGive __errno scMemValidate getlogin_r
	DECLARES 
	USES 
}
