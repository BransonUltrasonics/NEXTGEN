...
ObjectFile libedr.a::edrLib.o {
	...
	IMPORTS edrPmRegion edrPmArena pmRegionAddr errnoSet pmRegionSize edrErrLogCreate edrErrLogAttach edrErrLogHeaderUnprotect vxAtomic32Get edrErrLogHeaderProtect kernelIdGet printToEDRbuf oprintf taskIdSelf vxKernelVars vxCpuIndexGet trcLibFuncs trcStackCtxTrace _dbgDsmInstRtn __div32 kernelLockOwnedByMe vxMemProbe _func_kernelModuleListIdGet wrs_kernel_text_end wrs_kernel_text_start intContext semTake dllEach semGive _func_excInfoShow __urem32 taskCpuUnlock vxAtomic32Add evtAction eventPointSwHandle taskRegsShowOutput vxAtomic32Inc edrErrLogNodeAlloc edrErrLogNodeCommit edrErrLogNodeUnprotect memset vxWorksVersionMajor vxWorksVersionMinor vxWorksVersionMaint vxAbsTicksGet time sysSymTbl ctime snprintf strlen strlcpy taskName vxAtomic32Dec edrErrLogNodeProtect edrErrLogClear edrErrLogNodeCount hookAddToTail errnoGet hookDelete _func_symFindSymbol cplusDemangle _func_moduleSegInfoGet
	DECLARES 
	USES 
}
Module edrLib.o {
...
ObjectFile libedr.a::edrErrLogLib.o {
	...
	IMPORTS checksum vmLibInfo edrBufLock edrBufUnlock __udiv32 memset malloc vxWorksVersionMinor vxWorksVersionMajor vxWorksVersionMaint __div32 __rem32
	DECLARES 
	USES 
}
...
ObjectFile libedr.a::edrLock.o {
	...
	IMPORTS spinLockIsrHeld spinLockIsrTake spinLockIsrGive
	DECLARES 
	USES 
}
Module edrLock.o {
