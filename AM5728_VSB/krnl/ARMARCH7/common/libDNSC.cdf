...
ObjectFile libDNSC.a::ipdnsc_api.o {
	...
	IMPORTS strlen free malloc strcpy realloc memcpy memset ipcom_strcasecmp ipdnsc_get_soa ipdnsc_satisfy ipdnsc_get_ns ipdnsc_get_glue ipdnsc_free_nsrrset ipcom_inet_pton ipcom_inet_ntop ipdnsc ipdnsc_default ipdnsc_resolve_name ipdnsc_resolve_addr ip_in6addr_any memcmp printf ipdnsc_samename strdup ipdnsc_mkupdate ipdnsc_send_update_signed ipdnsc_send_update
	DECLARES 
	USES 
}
Module ipdnsc_api.o {
...
ObjectFile libDNSC.a::ipdnsc_cmd_nslookup.o {
	...
	IMPORTS printf ipdnsc_default memset ipcom_getopt_clear ipcom_getopt_data ipcom_getopt ipdnsc_cache_flush atoi ipcom_inet_pton ipdnsc_get_ipv6_addrconfig ipdnsc_resolve_addr ipcom_inet_ntop ipdnsc_resolve_name ipdnsc_hostent_free
	DECLARES 
	USES 
}
...
ObjectFile libDNSC.a::ipdnsc_update.o {
	...
	IMPORTS strlen strcpy __div32 isspace strchr isdigit isxdigit strtol sprintf ipcom_strncasecmp ipcom_ntohs isupper tolower __rem32 memcpy malloc ipdnsc_create_query ipdnsc_send_wait free ipcom_strcasecmp memset ipcom_sysvar_get_as_int strdup ipdnsc_get_time ipcom_htons secHashMd5TemplateGet secHashInit secHashUpdate secHashCleanup secHashFinal memcmp printf ipcom_inet_pton ipdnsc_default ipdnsc_update_rmsg
	DECLARES 
	USES 
}
