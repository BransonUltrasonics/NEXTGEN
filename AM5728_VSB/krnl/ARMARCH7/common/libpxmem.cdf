...
ObjectFile libpxmem.a::mmanLib.o {
	...
	IMPORTS poolCreate vmPageSizeGet kernelId poolItemReturn vmStateSet __udiv32 pgMgrPageFree poolItemGet taskIdSelf _func_rtpVerifiedLock semTake __errno semGive vmIsSRWXURWXSupported pgMgrPageAllocAt errnoSet globalRtpMemFill bfill taskPriorityGet taskSpawn vmTranslate
...
ObjectFile libpxmem.a::mmanScLib.o {
	...
	IMPORTS mmap64 munmap mprotect scMemValidate taskIdSelf kernelId scMemPrivValidate cacheFlush cacheInvalidate cacheClear cacheTextUpdate msync vmTranslate __errno
	DECLARES 
	USES 
}
Module mmanScLib.o {
