...
Symbol objid_tcp1213_root_node {
}
Symbol null_test_async {
}
Symbol tcpGet {
}
Symbol null_set_async {
}
Symbol std_next_async {
}
Symbol tcpConnEntryTest {
}
Symbol tcpConnEntryGet {
}
Symbol tcpConnEntrySet {
}
Symbol tcpConnEntryNext {
}
Symbol tcp1213_root_node {
}
Symbol objid_icmp1213_root_node {
}
Symbol icmpGet {
}
Symbol icmp1213_root_node {
}
Symbol objid_if1213_root_node {
}
Symbol interfacesGet {
}
Symbol ifEntryGet {
}
Symbol ifEntryNext {
...
Symbol if1213_root_node {
}
Symbol objid_ip1213_root_node {
}
Symbol ipTest {
}
Symbol ipGet {
...
Symbol ipAddrEntryGet {
}
Symbol ipAddrEntryNext {
}
Symbol ipRouteEntryTest {
}
Symbol ipRouteEntryGet {
}
Symbol ipRouteEntrySet {
}
Symbol ipRouteEntryNext {
}
Symbol ipNetToMediaEntryTest {
}
Symbol ipNetToMediaEntryGet {
}
Symbol ipNetToMediaEntrySet {
}
Symbol ipNetToMediaEntryNext {
}
Symbol ip1213_root_node {
}
Symbol objid_if2233_root_node {
}
Symbol ifXEntryGet {
}
Symbol ifXEntryNext {
}
Symbol if2233_root_node {
}
Symbol objid_udp1213_root_node {
}
Symbol udpGet {
}
Symbol udpEntryGet {
...
Symbol udp1213_root_node {
}
ObjectFile libmib2.a::m2Lib.o {
	NAME Object file m2Lib.o from archive libmib2.a
	EXPORTS m2LibInit m2Delete m2Init
	IMPORTS m2SysDelete m2IfDelete m2IpDelete m2TcpDelete m2IcmpDelete m2UdpDelete m2SysInit m2IfInit m2IfMgtLibInit m2IpInit m2TcpInit m2IcmpInit m2TestInit m2UdpInit
	DECLARES 
	USES 
}
Module m2Lib.o {
...
ObjectFile libmib2.a::m2IfLib.o {
	...
	EXPORTS m2IfInit m2VariableUpdate m2IfFree m2CounterUpdate m2IfTblInit mibIfAlloc m2InterfaceSem m2If8023PacketCount m2IfAlloc m2IfCentiSecsGet m2IfPktCountRtnInstall m2IfCtrUpdateRtnInstall m2IfVarUpdateRtnInstall rcvEtherAddrAdd m2IfDelete m2PollStatsIfPoll m2IfUsrCountersInstall m2IfUsrCountersRemove m2IfCount ifsInList
	IMPORTS endMibIfInit semMCreate errnoSet semTake pM2TrapRtn pM2TrapRtnArg semGive tick64Get bzero memcpy sprintf __udiv32 malloc free m2If64BitCounters __mul64 sysClkRateGet __udiv64 strlen strcpy bcopy memcmp muxIoctl
...
ObjectFile libmib2.a::m2IcmpLib.o {
	...
	IMPORTS ipcom_mib2_get_icmp_group errnoSet
	DECLARES 
	USES 
}
Module m2IcmpLib.o {
...
ObjectFile libmib2.a::m2SysLib.o {
	...
	IMPORTS sysClkRateGet tick64Get __mul64 __udiv64 malloc memset strncpy bcopy memcmp free strlen strcpy gethostname semMCreate errnoSet ipcom_mib2_get_ip_general_group semDelete
	DECLARES sysOrTable
	USES 
}
Module m2SysLib.o {
...
ObjectFile libmib2.a::m2TcpLib.o {
	...
	IMPORTS errnoSet ipcom_mib2_get_tcp_group malloc memcpy memset ipnet_suspend_stack ipnet_conf_max_sockets ipnet_shared_data ipnet_resume_stack free ipcom_mib2_set_tcpConnectionState
	DECLARES 
	USES 
}
Module m2TcpLib.o {
...
ObjectFile libmib2.a::m2UdpLib.o {
	...
	IMPORTS ipcom_mib2_get_udp_group errnoSet malloc memcpy ipcom_mib2_iterate_udpEndpointTable free
	DECLARES 
	USES 
}
Module m2UdpLib.o {
...
ObjectFile libmib2.a::m2LibTest.o {
	...
	IMPORTS m2IcmpGroupInfoGet printf
	DECLARES 
	USES 
}
Module m2LibTest.o {
...
ObjectFile libmib2.a::tcp1213.o {
	NAME Object file tcp1213.o from archive libmib2.a
	EXPORTS objid_tcp1213_root_node tcp1213_root_node
	IMPORTS null_test_async tcpGet null_set_async std_next_async tcpConnEntryTest tcpConnEntryGet tcpConnEntrySet tcpConnEntryNext
	DECLARES 
	USES 
}
Module tcp1213.o {
	OBJECT += libmib2.a::tcp1213.o
}
ObjectFile libmib2.a::icmp1213.o {
	NAME Object file icmp1213.o from archive libmib2.a
	EXPORTS objid_icmp1213_root_node icmp1213_root_node
	IMPORTS null_test_async icmpGet null_set_async std_next_async
	DECLARES 
	USES 
}
Module icmp1213.o {
	OBJECT += libmib2.a::icmp1213.o
}
ObjectFile libmib2.a::if1213.o {
	NAME Object file if1213.o from archive libmib2.a
	EXPORTS objid_if1213_root_node if1213_root_node
	IMPORTS null_test_async interfacesGet null_set_async std_next_async ifEntryGet ifEntryNext ifEntryTest ifEntrySet
	DECLARES 
	USES 
}
Module if1213.o {
	OBJECT += libmib2.a::if1213.o
}
ObjectFile libmib2.a::ip1213.o {
	NAME Object file ip1213.o from archive libmib2.a
	EXPORTS objid_ip1213_root_node ip1213_root_node
	IMPORTS ipTest ipGet ipSet std_next_async null_test_async null_set_async ipAddrEntryGet ipAddrEntryNext ipRouteEntryTest ipRouteEntryGet ipRouteEntrySet ipRouteEntryNext ipNetToMediaEntryTest ipNetToMediaEntryGet ipNetToMediaEntrySet ipNetToMediaEntryNext
	DECLARES 
	USES 
}
Module ip1213.o {
	OBJECT += libmib2.a::ip1213.o
}
ObjectFile libmib2.a::if2233.o {
	NAME Object file if2233.o from archive libmib2.a
	EXPORTS objid_if2233_root_node if2233_root_node
	IMPORTS null_test_async ifXEntryGet null_set_async ifXEntryNext ifEntryTest ifEntrySet interfacesGet std_next_async
	DECLARES 
	USES 
}
Module if2233.o {
	OBJECT += libmib2.a::if2233.o
}
ObjectFile libmib2.a::udp1213.o {
	NAME Object file udp1213.o from archive libmib2.a
	EXPORTS objid_udp1213_root_node udp1213_root_node
	IMPORTS null_test_async udpGet null_set_async std_next_async udpEntryGet udpEntryNext
	DECLARES 
	USES 
}
Module udp1213.o {
	OBJECT += libmib2.a::udp1213.o
}
Library libmib2.a {
	MODULES libmib2.a::m2Lib.o libmib2.a::m2IfLib.o libmib2.a::m2IcmpLib.o libmib2.a::m2IfMgtLib.o libmib2.a::m2IpLib.o libmib2.a::m2SysLib.o libmib2.a::m2TcpLib.o libmib2.a::m2UdpLib.o libmib2.a::m2LibTest.o libmib2.a::tcp1213.o libmib2.a::icmp1213.o libmib2.a::if1213.o libmib2.a::ip1213.o libmib2.a::if2233.o libmib2.a::udp1213.o
}
