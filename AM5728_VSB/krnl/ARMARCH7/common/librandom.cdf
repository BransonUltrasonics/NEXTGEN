...
ObjectFile librandom.a::randomSWNumGenLib.o {
	...
	IMPORTS semMCreate spinLockIsrInit spinLockIsrTake spinLockIsrGive _func_clkTimerCountGet tickGet randAdd semTake secHashSha256TemplateGet secHash memcpy semGive
...
ObjectFile librandom.a::randomScLib.o {
	...
	IMPORTS scMemValidate randBytes randPseudoBytes randAdd randStatus
	DECLARES 
	USES 
}
