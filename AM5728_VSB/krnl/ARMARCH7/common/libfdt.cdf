...
ObjectFile libfdt.a::fdt_ro.o {
	...
	IMPORTS fdt_offset_ptr memcmp memchr strlen fdt_check_header fdt_next_tag fdt_next_node _fdt_check_node_offset _fdt_check_prop_offset strchr memcpy
	DECLARES 
	USES 
}
Module fdt_ro.o {
...
ObjectFile libfdt.a::fdt_rw.o {
	...
	IMPORTS fdt_check_header memmove strlen _fdt_find_string memcpy fdt_num_mem_rsv fdt_get_property _fdt_check_node_offset fdt_get_name fdt_subnode_offset_namelen fdt_next_tag memset _fdt_node_end_offset fdt_move
	DECLARES 
	USES 
}
Module fdt_rw.o {
...
ObjectFile libfdt.a::fdt_wip.o {
	...
	IMPORTS fdt_getprop memcpy fdt_get_property fdt_next_node fdt_offset_ptr
	DECLARES 
	USES 
}
Module fdt_wip.o {
...
ObjectFile libfdt.a::fdt_empty_tree.o {
	...
	IMPORTS fdt_create fdt_finish_reservemap fdt_begin_node fdt_end_node fdt_finish fdt_open_into
	DECLARES 
	USES 
}
...
ObjectFile libfdt.a::fdt_sw.o {
	...
	IMPORTS memset strlen memcpy _fdt_find_string memmove fdt_next_tag
	DECLARES 
	USES 
}
Module fdt_sw.o {
...
ObjectFile libfdt.a::fdt_show.o {
	...
	EXPORTS fdt_dump
	IMPORTS isprint printf fdt_check_header fdt_path_offset fdt_next_tag fdt_get_name fdt_offset_ptr fdt_string fdt_strerror
	DECLARES 
	USES 
}
Module fdt_show.o {
...
ObjectFile libfdt.a::vxFdtLib.o {
	...
	IMPORTS fdt_open_into fdt_path_offset fdt_next_node fdt_parent_offset fdt_first_subnode fdt_next_subnode fdt_getprop fdt_first_property_offset fdt_getprop_by_offset fdt_next_property_offset fdt_get_name strncmp fdt_nop_node fdt_node_offset_by_phandle fdt_node_offset_by_compatible fdt_node_check_compatible __rem32 __div32 strncpy
	DECLARES 
	USES 
}
Module vxFdtLib.o {
...
ObjectFile libfdt.a::vxFdtCpu.o {
	...
	IMPORTS vxFdtPathOffset vxFdtNextNode vxFdtPropGet strcmp
	DECLARES 
	USES 
}
Module vxFdtCpu.o {
...
ObjectFile libfdt.a::vxFdtRwLib.o {
	...
	IMPORTS vxFdtDtbAddressGet fdt_del_node fdt_setprop
	DECLARES 
	USES 
}
Module vxFdtRwLib.o {
...
ObjectFile libfdt.a::vxFdtShow.o {
	...
	IMPORTS vxFdtDtbAddressGet fdt_dump
	DECLARES 
	USES 
}
Module vxFdtShow.o {
