...
ObjectFile libpxtrace.a::pxTraceStreamBufferLib.o {
	...
	IMPORTS semTake semGive malloc free semMCreate semBCreate semDelete memcpy pxTraceStreamFlush pxTraceStreamLoggingStop errnoGet pxTraceStreamLoggingStart
	DECLARES 
	USES 
}
...
ObjectFile libpxtrace.a::pxTraceStreamLogLib.o {
	...
	IMPORTS memcpy write errnoGet sysModel strlen lseek malloc memset semMCreate free semDelete semTake ftruncate semGive pxTraceHashTblIterKeyCreate pxTraceHashTblIterNextGet pxTraceHashTblEventIdFind pxTraceHashTblIterKeyDelete close read errnoSet pxTraceHashTblLiteralInsert
	DECLARES 
	USES 
}
...
ObjectFile libpxtrace.a::pxTraceStreamLib.o {
	...
	IMPORTS classInit rtpDeleteHookAdd traceTmrMuxEnable strlen pxTraceHashTblLiteralInsert memset memcpy clock_gettime traceTmrResolutionGet malloc dllInit pxTraceHashTblCreate pxTraceStreamBufferCreate pxTraceStreamLogCreate pxTraceStreamLogOpen pxTraceStreamBufferDelete pxTraceStreamLogDelete pxTraceHashTblDelete dllCount free objAlloc objCoreInit objCoreTerminate objFree pxTraceHashTblIterKeyCreate pxTraceHashTblIterNextGet pxTraceHashTblIterKeyDelete pxTraceHashTblEventIdFind objCoreInvalidate dllRemove pxTraceStreamLogFinish traceTimestampGet taskIdSelf kernelId pxTraceEventSetTest pxTraceStreamBufferWrite pxTraceStreamBufferRead pxTraceStreamLogWrite objHandleAlloc pxTraceHashTblInsert objCoreRelease pxTraceStreamLogEventRead sysClkRateGet __udiv32 __urem64 __udiv64 pxTraceEventSetUpdate pxTraceEventSetGet vxAtomic32Add evtAction taskCpuUnlock eventPointSwHandle pxTraceStreamBufferClear pxTraceStreamLogClear objHandleAndClassToObjId pxTraceStreamLogRewind
...
ObjectFile libpxtrace.a::pxTraceHashTblLib.o {
	...
	IMPORTS memSysPartId memPartAlloc wvHashTblCreate memPartFree wvHashTblDestroy wvHashTblIterInit wvHashTblIterNext strcmp strcpy wvHashTblInsert wvHashTblIterDone strncpy
	DECLARES 
	USES 
}
...
ObjectFile libpxtrace.a::pxTraceEventSetLib.o {
	...
	IMPORTS __div32 __rem32 memcpy
	DECLARES 
	USES 
}
