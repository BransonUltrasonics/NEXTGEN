...
Symbol mqPxObjUnsafe {
}
Symbol taskUnsafeInternal {
}
Symbol kernelLockTry {
}
Symbol windPendQCheckGet {
}
Symbol workQAdd1 {
}
Symbol mq_receive {
...
Symbol _func_pxCpuTimerCancelVerify {
}
Symbol wdCancelVerify {
}
...
ObjectFile libpxrt.a::clockLib.o {
	...
	EXPORTS clockLibInit clock_getres clock_gettime clockLock clock_gettime_wd clock_settime clock_nanosleep gettimeofday settimeofday clock_adjtime
	IMPORTS sysClkRateGet bzero vxAbsTicksGet vxbTimerEval __udiv32 __udiv64 _func_clockTimerCountGet kernelLockTake taskIdSelf kernelId taskClassId objVerify windExit errnoSet __div32 tickClkCnt spinLockIsrGive spinLockIsrTake __mul64 __lsr64 __urem64 vxAbsTicks _func_pthread_testandset_canceltype vxAtomic32Add evtAction taskDelay taskCpuUnlock eventPointSwHandle strcmp
...
ObjectFile libpxrt.a::mqPxLib.o {
	...
	EXPORTS mqPxLibInit mqClassId mqPxClassLock mq_create mq_open _mq_receive mqPxNodeLock mqPxObjSafe mqPxObjUnsafe mq_receive _mq_send mq_send mq_close mq_unlink _mq_notify mq_notify mq_setattr mq_getattr mqPxDescObjIdGet
	IMPORTS classInit taskDeleteHookAdd kernelLockTake evtAction windPendQTerminate vxAtomic32Dec windPendQPut windExit taskIdSelf kernelId sigPendDestroy _func_rtpTaskSigPendKill _func_rtpSigPendDestroy eventPointSwHandle vxAtomic32Add spinLockIsrTake objVerify spinLockIsrGive taskUnsafe __errno objCoreInvalidate objCoreTerminate objFree taskClassId bzero qPriListClassId qPriListInit objCoreInit intContext malloc objAllocExtra free objOpen clock_gettime sysClkRateGet __udiv32 __urem64 __udiv64 errnoGet ffsMsb bcopy windPendQGet vxAtomic32Inc taskUnsafeInternal kernelLockTry windPendQCheckGet workQAdd1 _func_pthread_testandset_canceltype vxKernelVars vxCpuIndexGet sigPendKill workQAdd2 workQDoWork _func_rtpSigPendKill objClose objUnlink _func_sigeventInit sigPendInit _func_rtpSigPendInit
	DECLARES 
	USES 
}
Module mqPxLib.o {
...
ObjectFile libpxrt.a::semPxLib.o {
	...
	EXPORTS semPxLibInit semPxClassId sem_init semPxIsrSpinLock _sem_destroy sem_destroy sem_open sem_close sem_unlink _sem_wait sem_wait _sem_trywait sem_trywait _sem_timedwait sem_timedwait _sem_post sem_post _sem_getvalue sem_getvalue
	IMPORTS classInit __errno objOpen objAlloc semCCreate objFree objCoreInit objOwnerSetBase qPriListClassId qPriListInit spinLockIsrTake objVerify spinLockIsrGive objCoreInvalidate vxAtomicGet kernelLockTake windPendQPut windExit taskIdSelf evtAction vxAtomic32Add semDelete objCoreTerminate taskClassId eventPointSwHandle taskUnsafe objClose objUnlink semTake errnoGet vxAtomicInc _func_pthread_testandset_canceltype vxAtomicDec windPendQGet vxAtomicCas sysClkRateGet __udiv32 __urem64 __udiv64 clock_gettime semGive semInfo
	DECLARES 
	USES 
}
Module semPxLib.o {
...
ObjectFile libpxrt.a::timerLib.o {
	...
	IMPORTS classInit objVerify __errno clock_gettime wdCancel sysClkRateGet __udiv32 __urem32 __mul64 __urem64 __udiv64 wdStart bzero logMsg intContext sigemptyset sigaction taskIdSelf kernelId objAlloc objCoreInit objOwnerSetBase wdCreate sigeventCreate wdDelete objCoreTerminate objFree wdCancelVerify objCoreInvalidate evtAction vxAtomic32Add windExit sigeventDelete taskClassId eventPointSwHandle taskUnsafe kernelLockTake sigeventSigOverrunGet vxAtomicGet vxAtomicCas excJobAdd vxAtomic32Inc clock_gettime_wd vxAtomicSet vxAtomic32Set sigeventNotify _func_pthread_testandset_canceltype taskDelay sigeventInit
	DECLARES _func_pxCpuTimerCancel _func_pxCpuTimerStart _func_pxCpuTimerCreate _func_pxCpuTimerDelete _func_pxCpuTimerCancelVerify timerClass
	USES 
}
Module timerLib.o {
...
ObjectFile libpxrt.a::clockScLib.o {
	...
	IMPORTS kern_node pSysctlCtxList sysctl_add_oid_internal taskIdSelf taskClassId objHandleAndClassToObjId kernelId objCoreRelease clock_gettime clock_settime clock_getres scMemValidate __errno objHandleToObjId errnoSet clock_nanosleep
	DECLARES 
	USES 
}
Module clockScLib.o {
...
ObjectFile libpxrt.a::mqSemPxScLib.o {
	...
	IMPORTS scMemValidateStr semPxClassId objOpen objHandleAlloc __errno objClose scMemValidate mqClassId objHandleToObjId objCoreRelease objHandleClose taskIdSelf evtAction vxAtomic32Add _sem_destroy vxAtomic32Or taskUnsafe taskClassId eventPointSwHandle sem_unlink mq_unlink objHandleAndClassToObjId _mq_receive _mq_send _sem_post _sem_trywait _sem_wait _sem_timedwait _sem_getvalue _mq_notify kernelId
	DECLARES 
	USES 
}
...
ObjectFile libpxrt.a::timerScLib.o {
	...
	IMPORTS scMemValidateStr scMemValidate __errno taskClassId objHandleAndClassToObjId taskIdSelf kernelId objCoreRelease timerClassId objOpen objHandleAlloc timer_gettime timer_settime timer_getoverrun timer_modify
	DECLARES 
	USES 
}
Module timerScLib.o {
