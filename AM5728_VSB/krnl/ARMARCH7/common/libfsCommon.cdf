...
ObjectFile libfsCommon.a::fsMonitor.o {
	...
	IMPORTS semMCreate xbdEventCategory xbdEventPrimaryInsert erfHandlerRegister xbdEventSecondaryInsert xbdEventSoftInsert _func_fsmUnmountHookAddRtn semTake semGive strncpy strncmp devName xbdPartitionDevCreate _func_rawFsDevInitRtn printf memSysPartId memPartAlloc memPartFree __errno strlen errnoSet strstr partitionExist hookAddToTail hookDelete
	DECLARES 
	USES 
}
Module fsMonitor.o {
...
ObjectFile libfsCommon.a::fsEventUtilLib.o {
	...
	IMPORTS erfCategoryAllocate erfTypeAllocate strcmp semGive erfHandlerUnregister semBCreate erfHandlerRegister semDelete erfEventRaise semTake
	DECLARES 
	USES 
}
...
ObjectFile libfsCommon.a::partLib.o {
	...
	IMPORTS ioctl __errno printf __udiv32 __rem32 __div32 malloc printErr bzero __mul64 write lseek read free open fsmNameMap fsPathAddedEventSetup fsWaitForPath close snprintf __div64
	DECLARES 
	USES 
}
Module partLib.o {
...
ObjectFile libfsCommon.a::xbdBlkDev.o {
	...
	EXPORTS xbdBlkDevLibInit xbdBlkDevServTskPri xbdBlkDevServTskStkSz xbdBlkDevCreate xbdBlkDevDelete xbdBlkDevCreateSync
	IMPORTS strlen __errno malloc semMCreate semBCreate strncpy xbdEventCategory xbdEventInstantiated erfHandlerRegister taskSpawn xbdAttach xbdEventPrimaryInsert erfEventRaise semDelete free __udiv32 bio_done semTake taskPrioritySet semGive xbdEventMediaChanged xbdDetach devUnmap xbdEventRemove xbdEventSoftInsert devName devMap sysClkRateGet taskDelay strncmp erfHandlerUnregister
	DECLARES 
	USES 
}
Module xbdBlkDev.o {
...
ObjectFile libfsCommon.a::xbdPartition.o {
	...
	IMPORTS strncpy snprintf strlen strncat xbdMapGet lstFirst xbdAttach xbdEventCategory xbdEventSecondaryInsert erfEventRaise lstNext xbdBlockSize xbdNBlocks devMap devUnmap devName malloc memset semMCreate semTake semBCreate xbdEventRemove erfHandlerRegister xbdEventMediaChanged bio_alloc semGive xbdDetach bio_free erfHandlerUnregister semDelete free map_uninit map_init gptMbrParse gptParse logMsg gptRemove xbdStrategy bcopy __udiv32 bio_done funcXbdBlkCacheStrategy xbdEventSoftInsert xbdIoctl xbdDump
	DECLARES 
	USES 
}
...
ObjectFile libfsCommon.a::xbdRamDisk.o {
	...
	IMPORTS strlen __errno malloc bzero semMCreate __udiv32 xbdEventPrimaryInsert xbdEventSecondaryInsert xbdAttach semDelete free snprintf fsmNameMap fsPathAddedEventSetup xbdEventCategory erfEventRaise fsWaitForPath xbdEventRemove xbdEventSoftInsert devName xbdEventInstantiated semTake bio_done bcopy semGive devMap xbdDetach devUnmap
	DECLARES 
	USES 
}
Module xbdRamDisk.o {
...
ObjectFile libfsCommon.a::gptUuid.o {
	...
	IMPORTS clock_gettime __mul64 rand memcpy memset memcmp bzero strlen sscanf sprintf
	DECLARES 
	USES 
}
Module gptUuid.o {
...
ObjectFile libfsCommon.a::gptMap.o {
	...
	IMPORTS malloc bio_free memset free lstFirst lstNext lstPrevious lstInsert lstDelete lstLast lstCount lstInit lstAdd printf __stdout __swbuf
	DECLARES 
	USES 
}
Module gptMap.o {
...
ObjectFile libfsCommon.a::gpt.o {
	...
	IMPORTS uuid_equal memset uuid_to_string devGetByName xbdMapGet map_find printf lstCount logMsg map_show semGive xbdBlockSize bio_alloc semBCreate xbdStrategy semTake semDelete bio_free lstFirst lstNext memcmp __udiv32 map_add uuid_is_nil xbdNBlocks map_alloc xbdIoctl bzero map_first map_uninit map_free __mul64 map_last memcpy uuid_create uuid_create_nil lstPrevious map_remove fsmNameMap fsPathAddedEventSetup fsWaitForPath map_init xbdGptPartDevCreate snprintf
	DECLARES 
	USES 
}
Module gpt.o {
...
ObjectFile libfsCommon.a::gptShow.o {
	...
	IMPORTS uuid_equal memset uuid_to_string devGetByName xbdMapGet map_find printf lstCount logMsg map_show
	DECLARES 
	USES 
}
Module gptShow.o {
...
ObjectFile libfsCommon.a::fsUtilityFuncs.o {
	...
	IMPORTS sysClkRateGet strdup __div32 __udiv32 taskDelay iosDevFind open close printf free fsmNameInstall ioctl
	DECLARES 
	USES 
}
...
Library libfsCommon.a {
	MODULES libfsCommon.a::fsMonitor.o libfsCommon.a::fsEventUtilLib.o libfsCommon.a::partLib.o libfsCommon.a::xbdBlkDev.o libfsCommon.a::xbdPartition.o libfsCommon.a::xbdRamDisk.o libfsCommon.a::gptUuid.o libfsCommon.a::gptMap.o libfsCommon.a::gpt.o libfsCommon.a::gptShow.o libfsCommon.a::fsBind.o libfsCommon.a::fsUtilityFuncs.o
}
