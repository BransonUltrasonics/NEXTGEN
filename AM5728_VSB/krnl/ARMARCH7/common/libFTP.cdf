...
ObjectFile libFTP.a::ipftpc.o {
	...
	IMPORTS ipcom_inet_ntop strcpy memset __rem32 ipcom_socketselect_usr ipcom_socketwrite_usr ipcom_errno_get strerror ipcom_syslog ipcom_socketread_usr strspn strtol vsnprintf strcat ipcom_strncasecmp __div32 strchr strcspn ipcom_socketclose_usr memcpy ipcom_socket_usr ipcom_random __urem32 ipcom_bind_usr ipcom_getsockname_usr ipcom_connect_usr ipcom_listen_usr ipcom_accept_usr memcmp ipcom_filewrite ipcom_mutex_lock ipcom_mutex_unlock ipcom_mutex_delete malloc ipcom_sysvar_get ipcom_inet_pton free ipcom_unlink ipcom_fileopen ipcom_fstat ipcom_fileclose ipcom_fileread ipcom_mutex_create
	DECLARES 
	USES 
}
Module ipftpc.o {
...
ObjectFile libFTP.a::ipftpc_cmd_ftp.o {
	...
	IMPORTS printf strtol ipftpc_lastreply ipftpc_strerror ipftpc_strclass __rem32 ipftpc_close free ipftpc_setattr ipftpc_put __div32 ipftpc_cmd ipftpc_list ipftpc_get strlen strncmp malloc ipcom_getcwd ipcom_chdir memset ipcom_getsockaddrbyaddr ipcom_getaddrinfo memcpy ipcom_freeaddrinfo ipftpc_open strdup ipcom_stdout ipcom_fflush ipcom_getline ipftpc_login memset_s strspn strcspn ipcom_getline_init ipcom_getopt_clear_r ipcom_getopt_r ipcom_getline_exit
	DECLARES 
	USES 
}
