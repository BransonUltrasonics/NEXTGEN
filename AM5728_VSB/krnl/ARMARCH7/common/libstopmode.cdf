...
ObjectFile libstopmode.a::smaLib.o {
	...
	IMPORTS calloc _func_wdbTrap vxdbgCpuResumeHookAdd smaVmLibInit vmLibInfo __udiv32 __div32 vxMemProbe memcpy cacheTextLocalUpdate vmCurrentGet vmCurrentSet smaHwBpInstall smaHwBpUninstall vxdbgCpuAllSuspend vxCpuConfiguredGet vxCpuIndexGet vxdbgCpuRegsGet vxdbgCpuAllResume smaHwBpAdd smaHwBpRemove smaHwBpRemoveAll smaProtocolGetPacket smaProtocolParse wdbDbgGetNpc intRegsLock intRegsUnlock wdbDbgRegsClear smaHwBpFind _sigCtxLoad _sigCtxSave _sigCtxRtnValSet _sigCtxSetup vxCpuEnabledGet
	DECLARES smaCpuStopSignal smaCpuPendingSig smaCpuStopBpType smaCpuStopHwBpAddr smaCpuIsEnabled _func_smaVmCtxVerify stopModeRegs _func_smaCharGet _func_smaPollModeSet _func_smaIntModeSet _func_smaCharPut _func_smaPacketPut _func_smaDisconnect
	USES 
}
Module smaLib.o {
...
ObjectFile libstopmode.a::smaProtocolLib.o {
	...
	IMPORTS strlen smaEventIsPending smaCpuIsEnabled smaCpuStopSignal smaRuncontrolCpu snprintf smaCpuStopBpType smaCpuStopHwBpAddr stopModeRegs smaArchRegsGet smaArchRegInfoGet _func_smaCharGet _func_smaPacketPut _func_smaCharPut vxCpuIndexGet smaCpuAllStop strncat strncpy xml_arch_defs smaBpsRemove smaIsConnected _func_smaDisconnect smaDebugStatus vxdbgEnable smaCpuAllResume vxCpuConfiguredGet strncmp strcmp smaArchRegsSet smaVmAddrMapGet vmCurrentGet vmCurrentSet smaMemProbe smaCpuPendingSig smaBpDelete memset smaBpAdd smaCpuEnabledRefresh intCpuLock _func_smaPollModeSet smaSystemStopHandle _func_smaIntModeSet intCpuUnlock
	DECLARES 
	USES 
}
