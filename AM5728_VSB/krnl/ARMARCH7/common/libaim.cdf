...
ObjectFile libaim.a::cacheLib.o {
	...
	IMPORTS _func_cacheFuncsSet cacheArchLibInit cacheLib vmCurrentGet vmLibInfo vxKernelVars taskCpuLock cpcInvoke taskCpuUnlock cacheArchAlignSize memSysPartId memPartAlignedAlloc memPartFree free cacheNullFuncs cacheUserFuncs cacheMmuAvailable cacheDmaFuncs
	DECLARES 
	USES 
}
Module cacheLib.o {
