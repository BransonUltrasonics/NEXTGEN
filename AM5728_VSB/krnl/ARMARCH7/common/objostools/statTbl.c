 ...
 *       FROM C:/ScriptGSX2_4/GSX2_4Stream/AM5728_VSB/krnl/h/public
 *         ON Mon May  9 21:38:12 Eastern Daylight Time 2022
 */
...
SYMBOL statTbl [] =
    ...
    {{NULL},"S_errno_ERSVD39", (char *) (M_errno | ERSVD39),0,0,0},
    ...
    {{NULL},"S_vmLib_NO_FREE_REGIONS", (char *) S_vmLib_NO_FREE_REGIONS,0,0,0},
    {{NULL},"S_vmLib_ADDRS_NOT_EQUAL", (char *) S_vmLib_ADDRS_NOT_EQUAL,0,0,0},
    ...
    {{NULL},"S_emLib_REMOTE_ENGINE_PROCESS_ERROR", (char *) S_emLib_REMOTE_ENGINE_PROCESS_ERROR,0,0,0},
    {{NULL},"S_emLib_DUPLICATE_REGISTRATION", (char *) S_emLib_DUPLICATE_REGISTRATION,0,0,0},
    {{NULL},"S_emLib_ENTITY_LIST_OVERFLOW", (char *) S_emLib_ENTITY_LIST_OVERFLOW,0,0,0},
    {{NULL},"S_emLib_ENTITY_NOT_FOUND", (char *) S_emLib_ENTITY_NOT_FOUND,0,0,0},
    {{NULL},"S_emLib_INVALID_REQUEST_TYPE", (char *) S_emLib_INVALID_REQUEST_TYPE,0,0,0},
    {{NULL},"S_emLib_ENGINE_NOT_INSTALLED", (char *) S_emLib_ENGINE_NOT_INSTALLED,0,0,0},
    ...
    {{NULL},"S_ossLib_BAD_HANDLE", (char *) S_ossLib_BAD_HANDLE,0,0,0},
    {{NULL},"S_ossLib_BAD_PARAMETER", (char *) S_ossLib_BAD_PARAMETER,0,0,0},
    {{NULL},"S_ossLib_OUT_OF_MEMORY", (char *) S_ossLib_OUT_OF_MEMORY,0,0,0},
    {{NULL},"S_ossLib_OUT_OF_RESOURCES", (char *) S_ossLib_OUT_OF_RESOURCES,0,0,0},
    {{NULL},"S_ossLib_INTERNAL_FAULT", (char *) S_ossLib_INTERNAL_FAULT,0,0,0},
    {{NULL},"S_ossLib_TIMEOUT", (char *) S_ossLib_TIMEOUT,0,0,0},
    {{NULL},"S_ossLib_GENERAL_FAULT", (char *) S_ossLib_GENERAL_FAULT,0,0,0},
    {{NULL},"S_ossLib_DESTROY_FAILED", (char *) S_ossLib_DESTROY_FAILED,0,0,0},
    {{NULL},"S_ossLib_QUEUE_FULL", (char *) S_ossLib_QUEUE_FULL,0,0,0},
    {{NULL},"S_ossLib_QUEUE_EMPTY", (char *) S_ossLib_QUEUE_EMPTY,0,0,0},
    {{NULL},"S_ossLib_NO_SIGNAL", (char *) S_ossLib_NO_SIGNAL,0,0,0},
    {{NULL},"S_ossLib_TAKE_MUTEX", (char *) S_ossLib_TAKE_MUTEX,0,0,0},
    {{NULL},"S_ossLib_RELEASE_MUTEX", (char *) S_ossLib_RELEASE_MUTEX,0,0,0},
    {{NULL},"S_ossLib_NOT_IMPLEMENTED", (char *) S_ossLib_NOT_IMPLEMENTED,0,0,0},
    ...
    {{NULL},"S_snmpdLib_VIEW_CREATE_FAILURE", (char *) S_snmpdLib_VIEW_CREATE_FAILURE,0,0,0},
    {{NULL},"S_snmpdLib_VIEW_INSTALL_FAILURE", (char *) S_snmpdLib_VIEW_INSTALL_FAILURE,0,0,0},
    {{NULL},"S_snmpdLib_VIEW_MASK_FAILURE", (char *) S_snmpdLib_VIEW_MASK_FAILURE,0,0,0},
    {{NULL},"S_snmpdLib_VIEW_DEINSTALL_FAILURE", (char *) S_snmpdLib_VIEW_DEINSTALL_FAILURE,0,0,0},
    {{NULL},"S_snmpdLib_VIEW_LOOKUP_FAILURE", (char *) S_snmpdLib_VIEW_LOOKUP_FAILURE,0,0,0},
    {{NULL},"S_snmpdLib_MIB_ADDITION_FAILURE", (char *) S_snmpdLib_MIB_ADDITION_FAILURE,0,0,0},
    {{NULL},"S_snmpdLib_NODE_NOT_FOUND", (char *) S_snmpdLib_NODE_NOT_FOUND,0,0,0},
    {{NULL},"S_snmpdLib_INVALID_SNMP_VERSION", (char *) S_snmpdLib_INVALID_SNMP_VERSION,0,0,0},
    {{NULL},"S_snmpdLib_TRAP_CREATE_FAILURE", (char *) S_snmpdLib_TRAP_CREATE_FAILURE,0,0,0},
    {{NULL},"S_snmpdLib_TRAP_BIND_FAILURE", (char *) S_snmpdLib_TRAP_BIND_FAILURE,0,0,0},
    {{NULL},"S_snmpdLib_TRAP_ENCODE_FAILURE", (char *) S_snmpdLib_TRAP_ENCODE_FAILURE,0,0,0},
    {{NULL},"S_snmpdLib_INVALID_OID_SYNTAX", (char *) S_snmpdLib_INVALID_OID_SYNTAX,0,0,0},
    ...
    {{NULL},"S_usbdLib_BAD_CLIENT", (char *) S_usbdLib_BAD_CLIENT,0,0,0},
    {{NULL},"S_usbdLib_BAD_PARAM", (char *) S_usbdLib_BAD_PARAM,0,0,0},
    {{NULL},"S_usbdLib_BAD_HANDLE", (char *) S_usbdLib_BAD_HANDLE,0,0,0},
    {{NULL},"S_usbdLib_OUT_OF_MEMORY", (char *) S_usbdLib_OUT_OF_MEMORY,0,0,0},
    {{NULL},"S_usbdLib_OUT_OF_RESOURCES", (char *) S_usbdLib_OUT_OF_RESOURCES,0,0,0},
    {{NULL},"S_usbdLib_NOT_IMPLEMENTED", (char *) S_usbdLib_NOT_IMPLEMENTED,0,0,0},
    {{NULL},"S_usbdLib_GENERAL_FAULT", (char *) S_usbdLib_GENERAL_FAULT,0,0,0},
    {{NULL},"S_usbdLib_NOT_INITIALIZED", (char *) S_usbdLib_NOT_INITIALIZED,0,0,0},
    {{NULL},"S_usbdLib_INTERNAL_FAULT", (char *) S_usbdLib_INTERNAL_FAULT,0,0,0},
    {{NULL},"S_usbdLib_TIMEOUT", (char *) S_usbdLib_TIMEOUT,0,0,0},
    {{NULL},"S_usbdLib_HCD_FAULT", (char *) S_usbdLib_HCD_FAULT,0,0,0},
    {{NULL},"S_usbdLib_IO_FAULT", (char *) S_usbdLib_IO_FAULT,0,0,0},
    {{NULL},"S_usbdLib_NOT_HUB", (char *) S_usbdLib_NOT_HUB,0,0,0},
    {{NULL},"S_usbdLib_CANNOT_CANCEL", (char *) S_usbdLib_CANNOT_CANCEL,0,0,0},
    {{NULL},"S_usbdLib_BANDWIDTH_FAULT", (char *) S_usbdLib_BANDWIDTH_FAULT,0,0,0},
    {{NULL},"S_usbdLib_POWER_FAULT", (char *) S_usbdLib_POWER_FAULT,0,0,0},
    {{NULL},"S_usbdLib_SOF_MASTER_FAULT", (char *) S_usbdLib_SOF_MASTER_FAULT,0,0,0},
    {{NULL},"S_usbHandleLib_OUT_OF_MEMORY", (char *) S_usbHandleLib_OUT_OF_MEMORY,0,0,0},
    {{NULL},"S_usbHandleLib_OUT_OF_RESOURCES", (char *) S_usbHandleLib_OUT_OF_RESOURCES,0,0,0},
    {{NULL},"S_usbHandleLib_OUT_OF_HANDLES", (char *) S_usbHandleLib_OUT_OF_HANDLES,0,0,0},
    {{NULL},"S_usbHandleLib_BAD_PARAM", (char *) S_usbHandleLib_BAD_PARAM,0,0,0},
    {{NULL},"S_usbHandleLib_BAD_HANDLE", (char *) S_usbHandleLib_BAD_HANDLE,0,0,0},
    {{NULL},"S_usbHandleLib_NOT_INITIALIZED", (char *) S_usbHandleLib_NOT_INITIALIZED,0,0,0},
    {{NULL},"S_usbHandleLib_GENERAL_FAULT", (char *) S_usbHandleLib_GENERAL_FAULT,0,0,0},
    {{NULL},"S_usbHcdLib_BAD_CLIENT", (char *) S_usbHcdLib_BAD_CLIENT,0,0,0},
    {{NULL},"S_usbHcdLib_BAD_PARAM", (char *) S_usbHcdLib_BAD_PARAM,0,0,0},
    {{NULL},"S_usbHcdLib_BAD_HANDLE", (char *) S_usbHcdLib_BAD_HANDLE,0,0,0},
    {{NULL},"S_usbHcdLib_OUT_OF_MEMORY", (char *) S_usbHcdLib_OUT_OF_MEMORY,0,0,0},
    {{NULL},"S_usbHcdLib_OUT_OF_RESOURCES", (char *) S_usbHcdLib_OUT_OF_RESOURCES,0,0,0},
    {{NULL},"S_usbHcdLib_NOT_IMPLEMENTED", (char *) S_usbHcdLib_NOT_IMPLEMENTED,0,0,0},
    {{NULL},"S_usbHcdLib_GENERAL_FAULT", (char *) S_usbHcdLib_GENERAL_FAULT,0,0,0},
    {{NULL},"S_usbHcdLib_NOT_INITIALIZED", (char *) S_usbHcdLib_NOT_INITIALIZED,0,0,0},
    {{NULL},"S_usbHcdLib_INT_HOOK_FAILED", (char *) S_usbHcdLib_INT_HOOK_FAILED,0,0,0},
    {{NULL},"S_usbHcdLib_STRUCT_SIZE_FAULT", (char *) S_usbHcdLib_STRUCT_SIZE_FAULT,0,0,0},
    {{NULL},"S_usbHcdLib_HW_NOT_READY", (char *) S_usbHcdLib_HW_NOT_READY,0,0,0},
    {{NULL},"S_usbHcdLib_NOT_SUPPORTED", (char *) S_usbHcdLib_NOT_SUPPORTED,0,0,0},
    {{NULL},"S_usbHcdLib_SHUTDOWN", (char *) S_usbHcdLib_SHUTDOWN,0,0,0},
    {{NULL},"S_usbHcdLib_IRP_CANCELED", (char *) S_usbHcdLib_IRP_CANCELED,0,0,0},
    {{NULL},"S_usbHcdLib_STALLED", (char *) S_usbHcdLib_STALLED,0,0,0},
    {{NULL},"S_usbHcdLib_DATA_BFR_FAULT", (char *) S_usbHcdLib_DATA_BFR_FAULT,0,0,0},
    {{NULL},"S_usbHcdLib_BABBLE", (char *) S_usbHcdLib_BABBLE,0,0,0},
    {{NULL},"S_usbHcdLib_CRC_TIMEOUT", (char *) S_usbHcdLib_CRC_TIMEOUT,0,0,0},
    {{NULL},"S_usbHcdLib_TIMEOUT", (char *) S_usbHcdLib_TIMEOUT,0,0,0},
    {{NULL},"S_usbHcdLib_BITSTUFF_FAULT", (char *) S_usbHcdLib_BITSTUFF_FAULT,0,0,0},
    {{NULL},"S_usbHcdLib_SHORT_PACKET", (char *) S_usbHcdLib_SHORT_PACKET,0,0,0},
    {{NULL},"S_usbHcdLib_CANNOT_CANCEL", (char *) S_usbHcdLib_CANNOT_CANCEL,0,0,0},
    {{NULL},"S_usbHcdLib_BANDWIDTH_FAULT", (char *) S_usbHcdLib_BANDWIDTH_FAULT,0,0,0},
    {{NULL},"S_usbHcdLib_SOF_INTERVAL_FAULT", (char *) S_usbHcdLib_SOF_INTERVAL_FAULT,0,0,0},
    {{NULL},"S_usbHcdLib_DATA_TOGGLE_FAULT", (char *) S_usbHcdLib_DATA_TOGGLE_FAULT,0,0,0},
    {{NULL},"S_usbHcdLib_PID_FAULT", (char *) S_usbHcdLib_PID_FAULT,0,0,0},
    {{NULL},"S_usbHcdLib_ISOCH_FAULT", (char *) S_usbHcdLib_ISOCH_FAULT,0,0,0},
    {{NULL},"S_usbQueueLib_BAD_HANDLE", (char *) S_usbQueueLib_BAD_HANDLE,0,0,0},
    {{NULL},"S_usbQueueLib_BAD_PARAMETER", (char *) S_usbQueueLib_BAD_PARAMETER,0,0,0},
    {{NULL},"S_usbQueueLib_OUT_OF_MEMORY", (char *) S_usbQueueLib_OUT_OF_MEMORY,0,0,0},
    {{NULL},"S_usbQueueLib_OUT_OF_RESOURCES", (char *) S_usbQueueLib_OUT_OF_RESOURCES,0,0,0},
    {{NULL},"S_usbQueueLib_Q_NOT_AVAILABLE", (char *) S_usbQueueLib_Q_NOT_AVAILABLE,0,0,0},
