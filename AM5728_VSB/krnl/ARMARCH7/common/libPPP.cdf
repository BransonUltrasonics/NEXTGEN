...
ObjectFile libPPP.a::ipppp.o {
	...
	EXPORTS ipppp_example_action_work_default ipppp_pkt_malloc ipppp_log ipppp_output ipppp_fcstab ipppp_action_irc ipppp_termreq_output ipppp_sysvar_get_conf_string ipppp_drv_wincompat ipppp_ioctl ipppp_event_close ipppp_event_open ipppp_action_lcp_close ipppp_ioevent ipppp_ip4_output ipppp_ip6_output ipppp_prot_input ipppp_pap_input ipppp_chap_input ipppp_input ipppp_if_attach ipppp_if_create ipppp_lock ipppp_unlock ipppp_if_init ipppp_create ipppp_start ipppp_version ipppp_work_lock ipppp_work_sem
	IMPORTS ipcom_if_indextoname ipcom_syslog ipcom_socket_usr memcpy ipcom_socketioctl_usr ipcom_errno_get strerror ipcom_socketclose_usr free strncpy ipnet_if_indextonetif snprintf ipcom_sysvar_get memset ipcom_auth_ctx_login ipcom_auth_chap_login ipcom_pkt_malloc ipcom_conf_max_link_hdr_size ipnet_this time vsnprintf ipcom_ppp_ioevent ipcom_pkt_free ipnet_timeout_cancel ipnet_inst ipnet_timeout_schedule strlen ipcom_random secHashMd5TemplateGet secHashInit secHashUpdate secHashFinal secHashCleanup strncmp strtoul strstr atoi ipcom_getpid ipcom_inet_pton ipcom_inet_ntop ipcom_sysvar_set ipnet_shared_data memcmp strchr malloc ipcom_pkt_trim_tail ipcom_pkt_make_linear ipcom_atomic_set ipppp_if_init2 ipppp_pppoe_create ipppp_pppoe_input ipcom_once ipcom_drv_ppp_if_init ipcom_atomic_add_and_return ipppp_example_action_cb ipnet_conf_max_instances ipcom_drv_ppp_create
...
ObjectFile libPPP.a::ipppp_cmd_pppconfig.o {
	...
	IMPORTS printf strstr strcat ipcom_if_indextoname ipstack_ifconfig_print_info ipcom_socketioctl_usr ipcom_cmd_if_flags_to_str ipcom_sysvar_get_conf_as_int sprintf ipcom_sysvar_for_each strncpy ipcom_if_nametoindex memcpy strcpy ipcom_errno_get strerror ipcom_if_nameindex strncmp ipcom_if_freenameindex malloc memset ipcom_socket_usr strcmp ipcom_inet_pton isdigit atoi ipcom_sysvar_set_conf ipcom_sysvar_set strlen ipnet_if_indextonetif strtoul ipcom_err_string ipcom_stderr fprintf ipcom_socketclose_usr free
	DECLARES 
	USES 
}
