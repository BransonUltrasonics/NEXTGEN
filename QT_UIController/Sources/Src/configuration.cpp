...
/**
 * @brief Configuration::convertNtolbs : Converts newtons to lbs
 * @param dbNewtons
 * @return
 */
double Configuration::convertNtolbs(double dbNewtons)
{
    double dbLecibals;
...
/**
 * @brief Configuration::convertlbstoN : Converts lbs to newtons
 * @param dbLecibals
 * @return
 */
double Configuration::convertlbstoN(double dbLecibals)
{
    double dbNeutons;
