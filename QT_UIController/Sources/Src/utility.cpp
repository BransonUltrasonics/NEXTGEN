...
/**
 * @brief convertNtolbs : Convert Newtons to lesibals
 * @param dbNewtons
 * @return
 */
...
/**
 * @brief convertlbstoN : Convert lesibals to newton
 * @param dbLecibals
 * @return
 */
...
/**
 * @brief convertNtolbs : Round Convert Newtons to lesibals
 * @param newton
 * @return
 */
QString convertNtolbs(const QString& newton)
{
    return QString::number(round(convertNtolbs(newton.toDouble())));
}
