...
SuspectRejectParameter::SuspectRejectParameter(QString name,
                                               QString localeName,
                                               /*unit variable dclared to update system unit on limit suspect reject screen*/
                                               const QString unit,
                                               bool suspectStatus,
...
/**
 * @brief SuspectRejectParameter::getParameterUnit
 * @return
 */
QString SuspectRejectParameter::getParameterUnit() const
{
    return m_ParameterUnit;
}

/**
 * @brief SuspectRejectParameter::setParameterUnit
 * @param unit
 */
void SuspectRejectParameter::setParameterUnit(const QString unit)
{
