...
/**
 * @brief DigitalOutputs::setDefaultValuesForDigitalOutputParams
 */
void DigitalOutputs::setDefaultValuesForDigitalOutputParams()
{
    for(int index=0;index<m_IOPinsInformationList.size();index++)
    {
        ...
        updateDigitalOutputsModelList(index,NOT_USED,temp_UserIODigitalParamsModel->getIsChecked(),temp_UserIODigitalParamsModel->getActiveStatus());
    }
    for(int index=0;index<m_IOPinsInformationList.size();index++)
    {
        UserIODigitalParamsModel *temp_UserIODigitalParamsModel=dynamic_cast<UserIODigitalParamsModel*>(m_IOPinsInformationList.at(index));
...
//            if(m_IOPinsInformationList.size() == 10 && m_DefaultPinsFunctionsList.at(index) == HOLD_DELAY)
//                bIsChecked = !IS_CHECKBOX_CHECKED;
//            if(m_IOPinsInformationList.size() == 5 && m_DefaultPinsFunctionsList.at(index) == PARTPRESENT)
//                bIsChecked = !IS_CHECKBOX_CHECKED;

            updateDigitalOutputsModelList(index,indexToSelect,bIsChecked,temp_UserIODigitalParamsModel->getActiveStatus());
        }
    }
...
/**
 * @brief DigitalOutputs::updatePinsInformationFromDBData : Update the pin information
 * @param a_DataList
 */
void DigitalOutputs::updatePinsInformationFromDBData(QList<PinData> a_DataList)
{
	for(int index=0;index<a_DataList.size();index++)
	{
		UserIODigitalParamsModel *temp_UserIODigitalParamsModel=dynamic_cast<UserIODigitalParamsModel*>(m_IOPinsInformationList.at(index));
		updateDigitalOutputsModelList(index,0,temp_UserIODigitalParamsModel->getIsChecked(),temp_UserIODigitalParamsModel->getActiveStatus());
	}
    for(int index=0;index<a_DataList.size();index++)
    {
        UserIODigitalParamsModel *temp_UserIODigitalParamsModel=dynamic_cast<UserIODigitalParamsModel*>(m_IOPinsInformationList.at(index));
        ...
        if(indexToSelect != -1)
        {
			updateDigitalOutputsModelList(index, indexToSelect,a_DataList.at(index).getCheckStatus(),a_DataList.at(index).getActiveStatus());        
		}    
	}
    refreshModel();
}
...
/**
 * @brief DigitalOutputs::updateDigitalOutputParamsModelComboBoxListIfNoneNotSelected
 * @param temp_UserIODigitalParamsModelIfNoneNotSelected
 * @param qobjectListIfNoneNotSelected
 * @param indexToRemove
 * @return
 */
int DigitalOutputs::updateDigitalOutputParamsModelComboBoxListIfNoneNotSelected(UserIODigitalParamsModel *temp_UserIODigitalParamsModelIfNoneNotSelected, QList<QObject*> &qobjectListIfNoneNotSelected, int indexToRemove)
{
    Q_UNUSED(indexToRemove);
    int actualIndex=0;
...
/**
 * @brief DigitalOutputs::updateDigitalOutputParamsComboboxList
 * @param qobjectListIfNoneSelected
 * @param previousSelectedActualIndex
 * @param previousSelectedIndex
 */
void DigitalOutputs::updateDigitalOutputParamsComboboxList(QList<QObject*> &qobjectListIfNoneSelected, int previousSelectedActualIndex, int previousSelectedIndex)
{
...
/**
 * @brief DigitalOutputs::updateDigitalOutputsModelList : Update the digital output information
 * @param a_ListViewIndex
 * @param a_ComboboxIndex
 * @param a_CheckBoxState
 * @param a_ActiveStatus
 */
void DigitalOutputs::updateDigitalOutputsModelList(int a_ListViewIndex, int a_ComboboxIndex, bool a_CheckBoxState, bool a_ActiveStatus)
{
    ...
    for(int index=0;index<m_IOPinsInformationList.size();index++)
    {
        ...
        if(index!=a_ListViewIndex&&indexToRemove!=0)
        {
            ...
            int actualIndex=0;
            actualIndex=updateDigitalOutputParamsModelComboBoxListIfNoneNotSelected(temp_UserIODigitalParamsModelIfNoneNotSelected, qobjectListIfNoneNotSelected,indexToRemove);
            ...
            if(searchIndexInComboboxlist(qobjectListIfNoneNotSelected,previousSelectedActualIndex)==-1){
                ...
                {
                    updateDigitalOutputParamsComboboxList(qobjectListIfNoneNotSelected, previousSelectedActualIndex, previousSelectedIndex);
                }
            }
        ...
        else if(index!=a_ListViewIndex&&indexToRemove==0)
        {
            ...
            if(searchIndexInComboboxlist(qobjectListIfNoneSelected,previousSelectedActualIndex)==-1)
            {
                ...
                {
                    updateDigitalOutputParamsComboboxList(qobjectListIfNoneSelected, previousSelectedActualIndex, previousSelectedIndex);
                }
            }
            //sort QList of combobox according to actual index
...
/**
 * @brief DigitalOutputs::onUnchecked
 * @param a_ListViewIndex
 * @param a_ComboboxIndex
 * @param a_CheckBoxState
 * @param a_ActiveStatus
 */
void DigitalOutputs::onUnchecked(int a_ListViewIndex,int a_ComboboxIndex,bool a_CheckBoxState,bool a_ActiveStatus)
{
    UserIODigitalParamsModel *temp_UserIODigitalParamsModelSelected=dynamic_cast<UserIODigitalParamsModel*>(m_IOPinsInformationList.at(a_ListViewIndex));
    //converting qvariant type to QList<QObject*>
    QList<QObject*> qobjectListSelected;
...
/**
 * @brief DigitalOutputs::onChecking
 * @param a_ListViewIndex
 * @param a_ComboboxIndex
 * @param a_CheckBoxState
 * @param a_ActiveStatus
 */
void DigitalOutputs::onChecking(int a_ListViewIndex,int a_ComboboxIndex,bool a_CheckBoxState,bool a_ActiveStatus)
{
    UserIODigitalParamsModel *temp_UserIODigitalParamsModelSelected=dynamic_cast<UserIODigitalParamsModel*>(m_IOPinsInformationList.at(a_ListViewIndex));
    //converting qvariant type to QList<QObject*>
    QList<QObject*> qobjectListSelected;
    ...
    if(actualIndexToRemove!=0)
    {
        if(isOptionAvailableInOtherComboBoxes(a_ListViewIndex,temp_UserIOComboboxModelSelected->getActualIndex()))
        {
            ...
            updateDigitalOutputsModelList(a_ListViewIndex, 0,a_CheckBoxState,a_ActiveStatus);
        ...
        {
            updateDigitalOutputsModelList(a_ListViewIndex, a_ComboboxIndex,a_CheckBoxState,a_ActiveStatus);
        }
    }
    else
    {
...
/**
 * @brief DigitalOutputs::isOptionAvailableInOtherComboBoxes
 * @param a_CurrentIndex
 * @param a_actualIndex
 * @param a_CheckboxStatus
 * @return
 */
bool DigitalOutputs::isOptionAvailableInOtherComboBoxes(int a_CurrentIndex, int a_actualIndex)
{
    for(int index=0;index<m_IOPinsInformationList.size();index++)
    {
...
/**
 * @brief DigitalOutputs::isOptionAvailableInComboBox
 * @param temp_UserIODigitalParamsModelSelected
 * @param a_actualIndex
 * @return
 */
bool DigitalOutputs::isOptionAvailableInComboBox(UserIODigitalParamsModel *temp_UserIODigitalParamsModelSelected,int a_actualIndex)
{
    //converting qvariant type to QList<QObject*>
    QList<QObject*> qobjectListSelected;
    int temp_currentIndex=temp_UserIODigitalParamsModelSelected->getCurrentIndexCombobox();
