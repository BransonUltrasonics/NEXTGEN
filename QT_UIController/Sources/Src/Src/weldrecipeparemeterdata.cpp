...
QString WeldRecipeParameter::getStructureValueByName(QString paramEditText)
{
    ...
    {
        double dval = Utility::convertNtolbs(qstrRetValue.toDouble());
        qstrRetValue.setNum(dval,'f',1);
    }
...
{
    /*dwCurrentUnit variable to update system unit*/
    int dwCurrentUnit = Configuration::getInstance()->m_systemData.UnitIs;
    QString qstrRetValue="";
    double localForceValue = 0;
    switch(a_Index)
    {
    ...
    case SC_TRIGGER_FORCE:
        /*To fetch recipe screen TriggerForce value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_SC.TriggerForce)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_SC.TriggerForce)/10.0);
            qstrRetValue = QString::number(round(localValue));
        }
        break;
    ...
    case SC_SUSPECT_END_FORCE_LOW:
        /*To fetch EndForce suspect low value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_SC.SuspectLimit.EndWeldForce.Low)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case SC_SUSPECT_END_FORCE_HIGH:
        /*To fetch EndForce suspect high value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_SC.SuspectLimit.EndWeldForce.High)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case SC_REJECT_END_FORCE_LOW:
        /*To fetch EndForce reject low value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_SC.RejectLimit.EndWeldForce.Low)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case SC_REJECT_END_FORCE_HIGH:
        /*To fetch EndForce reject high value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_SC.RejectLimit.EndWeldForce.High)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case PC_START_FREQUENCY:
        ...
        //AC
    case AC_WELD_FORCE:
        /*To fetch recipe screen WELD_FORCE value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.WeldForce)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case AC_TOTAL_COLLAPSE_TARGET:
        ...
        break;
    case AC_HOLD_FORCE:
        /*To fetch recipe screen Hold Force value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.HoldForce)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case AC_DOWN_ACCELERATION:
        /* To get four decimal when unit is imperial and for correct conversion from metric to imperial and vice versa */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.DownAcceleration)/10000.0);
            qstrRetValue = QString::number(localValue);
        }
        /* When system unit is metric value should be integer */
        else
        {
            int localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.DownAcceleration)/10000);
            qstrRetValue = QString::number(localValue);
        }
    ...
    case AC_DOWN_MAX_VELOCITY:
        ...
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.DownMaxVelocity)/10000.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
            int localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.DownMaxVelocity)/10000);
            qstrRetValue = QString::number(localValue);
        }
        break;
    case AC_DOWN_DECELERATION:
        ...
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.DownDeceleration)/10000.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
            int localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.DownDeceleration)/10000);
            qstrRetValue = QString::number(localValue);
        }
        break;
    case AC_RETURN_ACCELERATION:
        ...
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ReturnAcceleration)/10000.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
            int localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ReturnAcceleration)/10000);
            qstrRetValue = QString::number(localValue);
        }
        break;
    case AC_RETURN_MAX_VELOCITY:
        ...
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ReturnMaxVelocity)/10000.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
            int localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ReturnMaxVelocity)/10000);
            qstrRetValue = QString::number(localValue);
        }
        break;
    case AC_RETURN_DECELERATION:
        ...
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ReturnDeceleration)/10000.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
            int localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ReturnDeceleration)/10000);
            qstrRetValue = QString::number(localValue);
        }
        break;
    ...
    case AC_FORCE_STEP_RAMP_VALUE10:
        ...
        break;
    case AC_FORCE_STEP1:
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.WeldForce)/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
        else
        {
            qstrRetValue = QString::number(round(localForceValue));
        }
        break;
    case AC_FORCE_STEP2:
        /* To convert the weld force stepping values present on Recipe Screen when stepping toggle switch is ON,
         * on the basis of system Unit */
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ForceStep[1])/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
        ...
        break;
    case AC_FORCE_STEP3:
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ForceStep[2])/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
        ...
        break;
    case AC_FORCE_STEP4:
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ForceStep[3])/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
        ...
        break;
    case AC_FORCE_STEP5:
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ForceStep[4])/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
        ...
        break;
    case AC_FORCE_STEP6:
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ForceStep[5])/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
        ...
        break;
    case AC_FORCE_STEP7:
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ForceStep[6])/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
        ...
        break;
    case AC_FORCE_STEP8:
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ForceStep[7])/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
        ...
        break;
    case AC_FORCE_STEP9:
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ForceStep[8])/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
    ...
    case AC_FORCE_STEP10:
        localForceValue = ((m_weldRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.ForceStep[9])/10.0);
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            qstrRetValue = QString::number(localForceValue);
        }
    ...
    case UI_WELD_FORCE_LOW:
        /*To fetch limit setup screen Weld Force low value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_UI.SetupLimitsst.dwWeldForceLow)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case UI_WELD_FORCE_HIGH:
        /*To fetch limit setup screen Weld Force high value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_UI.SetupLimitsst.dwWeldForceHigh)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case UI_TRIGGER_FORCE_LOW:
        /*To fetch limit setup screen Trigger Force low value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_UI.SetupLimitsst.dwTriggerForceLow)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case UI_TRIGGER_FORCE_HIGH:
        /*To fetch limit setup screen Trigger Force high value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_UI.SetupLimitsst.dwTriggerForceHigh)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case UI_HOLD_FORCE_LOW:
        /*To fetch limit setup screen hold Force low value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_UI.SetupLimitsst.dwHoldForceLow)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
    ...
    case UI_HOLD_FORCE_HIGH:
        /*To fetch limit setup screen hold Force high value stored in SC on the basis of system unit */
        if(dwCurrentUnit == UNIT_IMPERIAL)
        {
            double localValue;
            localValue = ((m_weldRecipe.m_weldRecipe_UI.SetupLimitsst.dwHoldForceHigh)/10.0);
            qstrRetValue = QString::number(localValue);
        }
        else
        {
...
void WeldRecipeParameter::setStructureVariableByName(QString paramEditText ,QString qstrIndexValue)
{
    ...
    /*To get one decimal value when system unit is lbs*/
    else if(qstrunit == CUST_NAME_UNIT_NEWTON)
    {
        double dval = qstrIndexValue.toDouble();
        dval = dval * 10;
        indexValue = QString::number(dval);
    }
    else if(qstrunit == CUST_NAME_UINTLBS)
    {
        double dval = Utility::convertlbstoN(qstrIndexValue.toDouble());
        dval = dval * 10;
        indexValue = QString::number(dval);
    }
    else if(qstrunit == CUST_NAME_UINTINCHES)
    ...
    else if(qstrunit == CUST_NAME_UINIINSEC || qstrunit == CUST_NAME_UINIINSECSQU)
    {
        ...
        /* To get four decimal for imperial unit conversion */
        dval = dval * 10000.0;
        indexValue = QString::number(dval);
    }
    else if(qstrunit == CUST_NAME_MMPERSECOND || qstrunit == CUST_NAME_MMPERSECONDSQU)
    {
        double dval = qstrIndexValue.toDouble();
        /* To get correct conversion from imperail to metric and vice versa */
        dval = dval * 10000.0;
        indexValue = QString::number(dval);
    }
...
QString WeldRecipeParameter::getDefaultValue(QString qstrParamName)
{
    ...
    if(m_MapRecipeParams.contains(qstrParamName.toLower()))
    {
        ...
        {
            qstrDefValue = Utility::convertNtolbs(qstrDefValue);
            /*To display one decimal value for imperial unit*/
            qstrDefValue.setNum(qstrDefValue.toDouble(), 'f', 1);
        }
...
QString WeldRecipeParameter::getMinValue(QString qstrParamName)
{
    ...
    if(m_MapRecipeParams.contains(qstrParamName.toLower()))
    {
        ...
        {
            qstrMinValue = Utility::convertNtolbs(qstrMinValue);
            /*To display one decimal value for imperial unit*/
            qstrMinValue.setNum(qstrMinValue.toDouble(),'f',1);
        }
...
QString WeldRecipeParameter::getMaxValue(QString qstrParamName)
{
    ...
    if(m_MapRecipeParams.contains(qstrParamName.toLower()))
    {
        ...
        /*To calculate max value of Absolute Distance parameter for Metric Unit only*/
        ...
        /*To calculate max value of ready offset parameter for Metric Unit only */
        ...
        /* To calculate max value for Imperial Unit and makes control to go through unit
         * conversion logic */
        if(qstrUnit == "in" || qstrUnit == "in/s" || qstrUnit == "in/s2")
        {
        ...
        {
            qstrMaxValue = Utility::convertNtolbs(qstrMaxValue);
            /*To display one decimal value for imperial unit*/
            qstrMaxValue.setNum(qstrMaxValue.toDouble(),'f',1);
        }
 ...
 * @param qstrParamValue
 */
void WeldRecipeParameter::forceSettingIndependent(int qstrParamValue)
{
    memcpy(&m_weldActuatorForceRecipe,&m_weldRecipe,sizeof(m_weldRecipe));
    m_weldActuatorForceRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.WeldForce = qstrParamValue;
...
QString WeldRecipeParameter::getActuatorRecipeStructureValue()
{
    /*dwCurrentUnit variable to update system unit*/
    int dwCurrentUnit = Configuration::getInstance()->m_systemData.UnitIs;
    /*segregate WeldForce value stored in AC on the basis of unit */
    if(dwCurrentUnit == UNIT_IMPERIAL)
    {
        double localValue;
        localValue = ((m_weldActuatorForceRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.WeldForce)/10.0);
        QString lbsValue = QString::number(Utility::convertNtolbs(localValue));
        return lbsValue.setNum(lbsValue.toDouble(),'f',1);
    }
    else
    {
        double localValue;
        localValue = ((m_weldActuatorForceRecipe.m_weldRecipe_PC_AC.m_weldRecipe_AC.WeldForce)/10.0);
        return QString::number(round(localValue));
    }
}
