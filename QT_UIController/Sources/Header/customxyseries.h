...
class CustomXYSeries : public QQuickItem
{
    Q_OBJECT

    Q_PROPERTY(QList<QPointF> listData READ listData WRITE setListData NOTIFY listDataChanged)
    Q_PROPERTY(QString name READ name WRITE setName NOTIFY nameChanged)
    Q_PROPERTY(double width READ width WRITE setWidth NOTIFY mwidthChanged)
    ...
    Q_PROPERTY(bool visible READ visible WRITE setVisible NOTIFY mvisibleChanged)
...
public:
    explicit CustomXYSeries(QQuickItem *parent = Q_NULLPTR);
