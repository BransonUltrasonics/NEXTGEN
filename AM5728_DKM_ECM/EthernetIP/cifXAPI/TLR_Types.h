...
***************************************************************************************
  ...
  $Id: TLR_Types.h 6971 2015-07-13 08:51:16Z Robert $:
...
#if !defined (_DIAB_TOOL) &&!defined (__GNUC__) && !defined (__MSVC__) && !defined (__ADS__) && !defined (__REALVIEW__) && !defined (__CC_ARM) && !defined (__ICCARM__) && !defined(__TLR_USE_CUSTOM_COMPILER__)
