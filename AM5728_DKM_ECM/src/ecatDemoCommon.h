...
/*-DEFINES-------------------------------------------------------------------*/
#define ETHERCAT_STATE_CHANGE_TIMEOUT   20000   /* master state change timeout in ms */
#define ETHERCAT_SCANBUS_TIMEOUT        7000    /* scanbus timeout in ms */
#define FOE_TRANSFER_TIMEOUT            1000000  /* FoE file transfer timeout in ms */
...
extern volatile EC_T_BOOL bEcatDown;        /* global helper variable to indicate a slave has disconnected */
