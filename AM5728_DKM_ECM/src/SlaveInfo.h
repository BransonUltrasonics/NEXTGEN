...
typedef enum _T_eEtherCAT_Vendor
{
    ...
    ecvendor_texas_instruments                  = 0x0000059d,
...
typedef enum _T_eEtherCAT_ProductCode
{
	...
	/* TI */
	ecprodcode_ti_437							= 0x54490002,
	
	/* PRUESC POWER CONTROLLER */
	ecprodcode_pc_437							= 0x54490003,
	
	/* PRUESC ACTUATION CONTROLLER */
	ecprodcode_ac_437							= 0x54490004,
