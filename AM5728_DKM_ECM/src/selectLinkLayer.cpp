...
#endif
#endif /* VXWORKS */
#if (defined EC_VERSION_WINDOWS) || (defined LINUX) || (defined UNDER_CE) || (defined VXWORKS) || (defined RTOS_32) || (defined QNX6) || (defined UNDER_RTSS) || (defined __INTIME__) || (defined __TKERNEL) || (defined EC_VERSION_RTEMS) || (defined EC_VERSION_ECOS)
...
EC_T_DWORD dwPhyConnection = 0;
    ...
    else
    {
        ...
        { 
            ...
            pLinkParmsAdapter->ePhyInterface = (dwPhyConnection == 1) ? ePHY_GMII : ePHY_RGMII;
    ...
    EC_T_LINK_PARMS** ppLinkParms)
{
    ...
    {
        OsDbgMsg("Unknown master/slave flag specified\n");
        dwRetVal = EC_E_INVALIDPARM;
        goto Exit;
    }
    ...
    {
        OsDbgMsg("Unknown board name specified\n");
        dwRetVal = EC_E_INVALIDPARM;
        goto Exit;
    }
    ...
    {
        OsDbgMsg("Port number must be between 1 and 4\n");
        dwRetVal = EC_E_INVALIDPARM;
        goto Exit;
    }
...
#endif
#if (defined INCLUDE_ICSS)
    " [-icss Instance Mode MasterFlag RefBoard]"
#endif
#if (defined INCLUDE_L9218I)
    " [-l9218i Mode]"
#endif
...
#endif
#if (defined INCLUDE_ICSS)
    OsDbgMsg("   -icss             Link layer = Texas Instruments PRUICSS\n");
    OsDbgMsg("     Instance        ICSS Port (100 Mbit) 1 .. 4\n");
    OsDbgMsg("     Mode            Interrupt (0) or Polling (1) mode\n");
    OsDbgMsg("     MasterFlag      (m) Master (Initialize whole PRUSS), (s) Slave\n");
    OsDbgMsg("     RefBoard        am572x-idk | am571x-idk\n");
#endif
#if (defined INCLUDE_L9218I)
