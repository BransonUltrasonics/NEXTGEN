...
REM python "bin2header_modified.py" u-boot.bin u-boot.h
...
C:\ti\ccsv7\ccs_base\scripting\bin\dss.bat LoadProgram.js & TIMEOUT /T 325 /NOBREAK & echo "Flashed Successfully"
pause