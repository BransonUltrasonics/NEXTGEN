...
# GENERATED: Thu May 19 14:27:50 EDT 2022
...
PRJ_FULL_PATH  = C:/ScriptGSX2-5/GSX2_5Stream/AM5728_VIP
PRJ_TYPE       = vxWorks
PRJ_OBJS       = usrAppInit.o usrRtpAppInit.o prjConfig.o linkSyms.o loadInvokeModule.o loggerModule.o netcve_rev1_2.o
USER_OBJS      = 
PRJ_MAKEFILE   = $(PRJ_DIR)/Makefile.mk
BOOT_OBJS      =  $(BOOT_EXTRA)
BUILD_SPEC     = default
BSP_DIR        = C:/ScriptGSX2-5/GSX2_5Stream/AM5728_VIP/ti_sitara_ctxa15_branson_1_0_0_0
VSB_DIR        = C:/ScriptGSX2-5/GSX2_5Stream/AM5728_VSB
VXBUILD        = SMP
OPT            = -inet6
...
netcve_rev1_2.o:  $(PRJ_DIR)/netcve_rev1_2.c 
	$(RM) netcve_rev1_2.o
	$(CC) $(CFLAGS) $(CC_SDA_FLAGS) $(CFLAGS_OPTIONS_ALL) -c $(PRJ_DIR)/netcve_rev1_2.c
endif
