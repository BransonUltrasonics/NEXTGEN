...
Selection BOARD_SELECTION {
    ...
    COUNT       1-1
    CHILDREN    BOARD_TI_AM5728_IDK       \
    			BOARD_TI_AM5728_BRANSON
    DEFAULTS    BOARD_TI_AM5728_IDK
    _CHILDREN   FOLDER_BSP_CONFIG
}

Component BOARD_TI_AM5728_IDK {
    NAME        TI AM572x IDK
    SYNOPSIS    TI AM572x IDK support.
}

Component BOARD_TI_AM5728_BRANSON {
    NAME        TI AM572x Custom Board
    SYNOPSIS    TI AM572x Custom Board support.
    CFG_PARAMS  CONFIG_CUSTOM_SC_AM5728 
}

Parameter DTS_FILE {
    NAME        dts file name to be used
    DEFAULT     (BOARD_TI_AM5728_IDK)::(am572x_idk_ca15.dts)   		\
                (BOARD_TI_AM5728_BRANSON)::(am572x_branson_ca15.dts)
}

Parameter CONFIG_CUSTOM_SC_AM5728 {
    NAME        Board based compilation flag
    DEFAULT     (BOARD_TI_AM5728_BRANSON)::(1)
}
